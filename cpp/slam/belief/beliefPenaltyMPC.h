...
{
    /* diagonal matrix of size [62 x 62] (only the diagonal is stored) */
    beliefPenaltyMPC_FLOAT H1[62];
    ...
    /* diagonal matrix of size [20 x 20] (only the diagonal is stored) */
    beliefPenaltyMPC_FLOAT H15[20];
