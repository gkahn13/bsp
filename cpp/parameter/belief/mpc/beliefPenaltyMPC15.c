...
/*
 * Initializes a vector of length 2624 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_2624(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<2624; i++ )
	{
 ...
 * This function is for vectors of length 2624.
 */
void beliefPenaltyMPC_LA_DOTACC_2624(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<2624; i++ ){
		*z += x[i]*y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_AFFINE(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (beliefPenaltyMPC_FLOAT)2624;
    return lsIt;
}
...
*  and x,u,v are vectors of length 2624.
 */
void beliefPenaltyMPC_LA_VSUB5_2624(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT a, beliefPenaltyMPC_FLOAT *x)
{
	int i;
	for( i=0; i<2624; i++){
		x[i] = u[i]*v[i] - a;
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 2624.
 */
void beliefPenaltyMPC_LA_VSUB7_2624(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *r, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<2624; i++){
...
/*
 * Vector addition x = x + y for vectors of length 2624.
 */
void beliefPenaltyMPC_LA_VADD_2624(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<2624; i++){
		x[i] += y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_COMBINED(beliefPenaltyMPC_FLOAT *z, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dz, beliefPenaltyMPC_FLOAT *dv, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu)
{
    ...
    *a = a_gamma;
    *mu /= (beliefPenaltyMPC_FLOAT)2624;
    return lsIt;
}
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_l[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_s[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_lbys[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_aff[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_aff[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_cc[1920];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_cc[660];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_cc[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_cc[2624];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ccrhs[2624];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_A14[704] = {1.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, -1.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 
...
0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 
0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_sp14 = beliefPenaltyMPC_s + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lp14 = beliefPenaltyMPC_l + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lpbysp14 = beliefPenaltyMPC_lbys + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlp_aff14 = beliefPenaltyMPC_dl_aff + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsp_aff14 = beliefPenaltyMPC_ds_aff + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlp_cc14 = beliefPenaltyMPC_dl_cc + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsp_cc14 = beliefPenaltyMPC_ds_cc + 2608;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_ccrhsp14 = beliefPenaltyMPC_ccrhs + 2608;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_rip14[16];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Phi14[990];
...
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_W14[1936];
...
beliefPenaltyMPC_LA_INITIALIZEVECTOR_2624(beliefPenaltyMPC_l, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_2624(beliefPenaltyMPC_s, 1);
info->mu = 0;
beliefPenaltyMPC_LA_DOTACC_2624(beliefPenaltyMPC_l, beliefPenaltyMPC_s, &info->mu);
info->mu /= 2624;
...
beliefPenaltyMPC_LA_DIAG_QUADFCN_44(params->Q15, params->f15, beliefPenaltyMPC_z14, beliefPenaltyMPC_grad_cost14, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
beliefPenaltyMPC_LA_MVSUBADD_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_z14, params->b15, beliefPenaltyMPC_sp14, beliefPenaltyMPC_lp14, beliefPenaltyMPC_rip14, &info->dgap, &info->res_ineq);
...
beliefPenaltyMPC_LA_INEQ_P_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_lp14, beliefPenaltyMPC_sp14, beliefPenaltyMPC_rip14, beliefPenaltyMPC_grad_ineq14, beliefPenaltyMPC_lpbysp14);
...
beliefPenaltyMPC_LA_INEQ_DENSE_DIAG_HESS_44_44_44(params->Q15, beliefPenaltyMPC_llbbyslb14, beliefPenaltyMPC_lbIdx14, beliefPenaltyMPC_lubbysub14, beliefPenaltyMPC_ubIdx14, beliefPenaltyMPC_Phi14);
beliefPenaltyMPC_LA_DENSE_ADDMTDM_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_lpbysp14, beliefPenaltyMPC_Phi14);
beliefPenaltyMPC_LA_DENSE_CHOL2_44(beliefPenaltyMPC_Phi14);
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MATRIXFORWARDSUB_44_44(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_D14, beliefPenaltyMPC_W14);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_44(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_rd14, beliefPenaltyMPC_Lbyrd14);
...
beliefPenaltyMPC_LA_DENSE_MMT2_44_134_44(beliefPenaltyMPC_V13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Yd14);
beliefPenaltyMPC_LA_DENSE_MVMSUB2_44_134_44(beliefPenaltyMPC_V13, beliefPenaltyMPC_Lbyrd13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Lbyrd14, beliefPenaltyMPC_re14, beliefPenaltyMPC_beta14);
...
beliefPenaltyMPC_LA_DENSE_FORWARDBACKWARDSUB_44(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_rd14, beliefPenaltyMPC_dzaff14);
...
beliefPenaltyMPC_LA_DENSE_MVMSUB4_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_dzaff14, beliefPenaltyMPC_rip14, beliefPenaltyMPC_dsp_aff14);
beliefPenaltyMPC_LA_VSUB3_16(beliefPenaltyMPC_lpbysp14, beliefPenaltyMPC_dsp_aff14, beliefPenaltyMPC_lp14, beliefPenaltyMPC_dlp_aff14);
...
beliefPenaltyMPC_LA_VSUB5_2624(beliefPenaltyMPC_ds_aff, beliefPenaltyMPC_dl_aff, musigma, beliefPenaltyMPC_ccrhs);
...
beliefPenaltyMPC_LA_DENSE_MTVMADD2_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_ccrhsp14, beliefPenaltyMPC_sp14, beliefPenaltyMPC_rd14);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_44(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_rd14, beliefPenaltyMPC_Lbyrd14);
beliefPenaltyMPC_LA_DENSE_2MVMADD_44_134_44(beliefPenaltyMPC_V13, beliefPenaltyMPC_Lbyrd13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Lbyrd14, beliefPenaltyMPC_beta14);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_44_44(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_yy13, beliefPenaltyMPC_beta14, beliefPenaltyMPC_bmy14);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_44(beliefPenaltyMPC_Ld14, beliefPenaltyMPC_bmy14, beliefPenaltyMPC_yy14);
...
beliefPenaltyMPC_LA_DENSE_FORWARDBACKWARDSUB_44(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_rd14, beliefPenaltyMPC_dzcc14);
...
beliefPenaltyMPC_LA_DENSE_MVMSUB5_16_44(beliefPenaltyMPC_A14, beliefPenaltyMPC_dzcc14, beliefPenaltyMPC_ccrhsp14, beliefPenaltyMPC_sp14, beliefPenaltyMPC_lp14, beliefPenaltyMPC_dlp_cc14);
beliefPenaltyMPC_LA_VSUB7_2624(beliefPenaltyMPC_l, beliefPenaltyMPC_ccrhs, beliefPenaltyMPC_s, beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_ds_cc);
...
beliefPenaltyMPC_LA_VADD_2624(beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_dl_aff);
beliefPenaltyMPC_LA_VADD_2624(beliefPenaltyMPC_ds_cc, beliefPenaltyMPC_ds_aff);
