...
/*
 * Initializes a vector of length 498 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_498(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<498; i++ )
	{
 ...
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_150(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<150; i++ )
	{
...
/*
 * Initializes a vector of length 706 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_706(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<706; i++ )
	{
 ...
 * This function is for vectors of length 706.
 */
void beliefPenaltyMPC_LA_DOTACC_706(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<706; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 498.
 */
void beliefPenaltyMPC_LA_VVADD3_498(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT *w, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<498; i++ ){
		z[i] = u[i] + v[i] + w[i];
...
/*
 * Vector subtraction z = -x - y for vectors of length 498.
 */
void beliefPenaltyMPC_LA_VSUB2_498(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<498; i++){
		z[i] = -x[i] - y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_AFFINE(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (beliefPenaltyMPC_FLOAT)706;
    return lsIt;
}
...
*  and x,u,v are vectors of length 706.
 */
void beliefPenaltyMPC_LA_VSUB5_706(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT a, beliefPenaltyMPC_FLOAT *x)
{
	int i;
	for( i=0; i<706; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 498.
 */
void beliefPenaltyMPC_LA_VSUB_498(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<498; i++){
		z[i] = x[i] - y[i];
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 706.
 */
void beliefPenaltyMPC_LA_VSUB7_706(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *r, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<706; i++){
...
/*
 * Vector addition x = x + y for vectors of length 498.
 */
void beliefPenaltyMPC_LA_VADD_498(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<498; i++){
		x[i] += y[i];
 ...
 */
void beliefPenaltyMPC_LA_VADD_150(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<150; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 706.
 */
void beliefPenaltyMPC_LA_VADD_706(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<706; i++){
		x[i] += y[i];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_z[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_v[150];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_aff[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_aff[150];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_cost[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_eq[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_rd[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_l[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_s[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_lbys[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_aff[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_aff[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_cc[498];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_cc[150];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_cc[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_cc[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ccrhs[706];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_ineq[498];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_H29[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 2.0000000000000000E+001, 2.0000000000000000E+001, 2.0000000000000000E+001};
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_f29[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Lbyrd29[5];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ctv29[5];
int beliefPenaltyMPC_lbIdx29[5] = {0, 1, 2, 3, 4};
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_rilb29[5];
...
int beliefPenaltyMPC_ubIdx29[5] = {0, 1, 2, 3, 4};
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lub29 = beliefPenaltyMPC_l + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_sub29 = beliefPenaltyMPC_s + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lubbysub29 = beliefPenaltyMPC_lbys + 701;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_riub29[5];
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlubaff29 = beliefPenaltyMPC_dl_aff + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsubaff29 = beliefPenaltyMPC_ds_aff + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlubcc29 = beliefPenaltyMPC_dl_cc + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsubcc29 = beliefPenaltyMPC_ds_cc + 701;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_ccrhsub29 = beliefPenaltyMPC_ccrhs + 701;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Phi29[5];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_D29[5] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_W29[5];
...
info->it = 0;
beliefPenaltyMPC_LA_INITIALIZEVECTOR_498(beliefPenaltyMPC_z, 0);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_150(beliefPenaltyMPC_v, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_706(beliefPenaltyMPC_l, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_706(beliefPenaltyMPC_s, 1);
info->mu = 0;
beliefPenaltyMPC_LA_DOTACC_706(beliefPenaltyMPC_l, beliefPenaltyMPC_s, &info->mu);
info->mu /= 706;
while( 1 ){
info->pobj = 0;
...
beliefPenaltyMPC_LA_DIAG_QUADFCN_5(beliefPenaltyMPC_H29, beliefPenaltyMPC_f29, beliefPenaltyMPC_z29, beliefPenaltyMPC_grad_cost29, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_17_5(params->C29, beliefPenaltyMPC_z28, beliefPenaltyMPC_D29, beliefPenaltyMPC_z29, params->e29, beliefPenaltyMPC_v28, beliefPenaltyMPC_re28, &info->dgap, &info->res_eq);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D29, beliefPenaltyMPC_v28, beliefPenaltyMPC_grad_eq29);
info->res_ineq = 0;
...
beliefPenaltyMPC_LA_VSUBADD3_5(params->lb30, beliefPenaltyMPC_z29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_llb29, beliefPenaltyMPC_slb29, beliefPenaltyMPC_rilb29, &info->dgap, &info->res_ineq);
beliefPenaltyMPC_LA_VSUBADD2_5(beliefPenaltyMPC_z29, beliefPenaltyMPC_ubIdx29, params->ub30, beliefPenaltyMPC_lub29, beliefPenaltyMPC_sub29, beliefPenaltyMPC_riub29, &info->dgap, &info->res_ineq);
...
beliefPenaltyMPC_LA_INEQ_B_GRAD_5_5_5(beliefPenaltyMPC_lub29, beliefPenaltyMPC_sub29, beliefPenaltyMPC_riub29, beliefPenaltyMPC_llb29, beliefPenaltyMPC_slb29, beliefPenaltyMPC_rilb29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_ubIdx29, beliefPenaltyMPC_grad_ineq29, beliefPenaltyMPC_lubbysub29, beliefPenaltyMPC_llbbyslb29);
...
beliefPenaltyMPC_LA_VVADD3_498(beliefPenaltyMPC_grad_cost, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_grad_ineq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_CHOL_ONELOOP_LBUB_5_5_5(beliefPenaltyMPC_H29, beliefPenaltyMPC_llbbyslb29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_lubbysub29, beliefPenaltyMPC_ubIdx29, beliefPenaltyMPC_Phi29);
beliefPenaltyMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_5(beliefPenaltyMPC_Phi29, beliefPenaltyMPC_D29, beliefPenaltyMPC_W29);
beliefPenaltyMPC_LA_DIAG_FORWARDSUB_5(beliefPenaltyMPC_Phi29, beliefPenaltyMPC_rd29, beliefPenaltyMPC_Lbyrd29);
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MMT2_5_17_5(beliefPenaltyMPC_V28, beliefPenaltyMPC_W29, beliefPenaltyMPC_Yd28);
beliefPenaltyMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_17_5(beliefPenaltyMPC_V28, beliefPenaltyMPC_Lbyrd28, beliefPenaltyMPC_W29, beliefPenaltyMPC_Lbyrd29, beliefPenaltyMPC_re28, beliefPenaltyMPC_beta28);
...
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_5(beliefPenaltyMPC_Ld28, beliefPenaltyMPC_yy28, beliefPenaltyMPC_dvaff28);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D29, beliefPenaltyMPC_dvaff28, beliefPenaltyMPC_grad_eq29);
beliefPenaltyMPC_LA_VSUB2_498(beliefPenaltyMPC_rd, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefPenaltyMPC_Phi29, beliefPenaltyMPC_rd29, beliefPenaltyMPC_dzaff29);
...
beliefPenaltyMPC_LA_VSUB_INDEXED_5(beliefPenaltyMPC_dzaff29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_rilb29, beliefPenaltyMPC_dslbaff29);
beliefPenaltyMPC_LA_VSUB3_5(beliefPenaltyMPC_llbbyslb29, beliefPenaltyMPC_dslbaff29, beliefPenaltyMPC_llb29, beliefPenaltyMPC_dllbaff29);
beliefPenaltyMPC_LA_VSUB2_INDEXED_5(beliefPenaltyMPC_riub29, beliefPenaltyMPC_dzaff29, beliefPenaltyMPC_ubIdx29, beliefPenaltyMPC_dsubaff29);
beliefPenaltyMPC_LA_VSUB3_5(beliefPenaltyMPC_lubbysub29, beliefPenaltyMPC_dsubaff29, beliefPenaltyMPC_lub29, beliefPenaltyMPC_dlubaff29);
...
beliefPenaltyMPC_LA_VSUB5_706(beliefPenaltyMPC_ds_aff, beliefPenaltyMPC_dl_aff, musigma, beliefPenaltyMPC_ccrhs);
...
beliefPenaltyMPC_LA_DENSE_MVMSUB1_5_5(beliefPenaltyMPC_Lsd27, beliefPenaltyMPC_yy26, beliefPenaltyMPC_beta27, beliefPenaltyMPC_bmy27);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_5(beliefPenaltyMPC_Ld27, beliefPenaltyMPC_bmy27, beliefPenaltyMPC_yy27);
beliefPenaltyMPC_LA_VSUB6_INDEXED_5_5_5(beliefPenaltyMPC_ccrhsub29, beliefPenaltyMPC_sub29, beliefPenaltyMPC_ubIdx29, beliefPenaltyMPC_ccrhsl29, beliefPenaltyMPC_slb29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_rd29);
beliefPenaltyMPC_LA_DIAG_FORWARDSUB_5(beliefPenaltyMPC_Phi29, beliefPenaltyMPC_rd29, beliefPenaltyMPC_Lbyrd29);
beliefPenaltyMPC_LA_DENSE_DIAGZERO_2MVMADD_5_17_5(beliefPenaltyMPC_V28, beliefPenaltyMPC_Lbyrd28, beliefPenaltyMPC_W29, beliefPenaltyMPC_Lbyrd29, beliefPenaltyMPC_beta28);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_5_5(beliefPenaltyMPC_Lsd28, beliefPenaltyMPC_yy27, beliefPenaltyMPC_beta28, beliefPenaltyMPC_bmy28);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_5(beliefPenaltyMPC_Ld28, beliefPenaltyMPC_bmy28, beliefPenaltyMPC_yy28);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_5(beliefPenaltyMPC_Ld28, beliefPenaltyMPC_yy28, beliefPenaltyMPC_dvcc28);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D29, beliefPenaltyMPC_dvcc28, beliefPenaltyMPC_grad_eq29);
beliefPenaltyMPC_LA_VSUB_498(beliefPenaltyMPC_rd, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefPenaltyMPC_Phi29, beliefPenaltyMPC_rd29, beliefPenaltyMPC_dzcc29);
...
beliefPenaltyMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_5(beliefPenaltyMPC_ccrhsl29, beliefPenaltyMPC_slb29, beliefPenaltyMPC_llbbyslb29, beliefPenaltyMPC_dzcc29, beliefPenaltyMPC_lbIdx29, beliefPenaltyMPC_dllbcc29);
beliefPenaltyMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_5(beliefPenaltyMPC_ccrhsub29, beliefPenaltyMPC_sub29, beliefPenaltyMPC_lubbysub29, beliefPenaltyMPC_dzcc29, beliefPenaltyMPC_ubIdx29, beliefPenaltyMPC_dlubcc29);
beliefPenaltyMPC_LA_VSUB7_706(beliefPenaltyMPC_l, beliefPenaltyMPC_ccrhs, beliefPenaltyMPC_s, beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_ds_cc);
beliefPenaltyMPC_LA_VADD_498(beliefPenaltyMPC_dz_cc, beliefPenaltyMPC_dz_aff);
beliefPenaltyMPC_LA_VADD_150(beliefPenaltyMPC_dv_cc, beliefPenaltyMPC_dv_aff);
beliefPenaltyMPC_LA_VADD_706(beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_dl_aff);
beliefPenaltyMPC_LA_VADD_706(beliefPenaltyMPC_ds_cc, beliefPenaltyMPC_ds_aff);
