...
typedef struct controlMPC_params
{
    ...
    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H25[2];

    /* vector of size 2 */
    controlMPC_FLOAT f25[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb25[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub25[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H26[2];

    /* vector of size 2 */
    controlMPC_FLOAT f26[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb26[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub26[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H27[2];

    /* vector of size 2 */
    controlMPC_FLOAT f27[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb27[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub27[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H28[2];

    /* vector of size 2 */
    controlMPC_FLOAT f28[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb28[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub28[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H29[2];

    /* vector of size 2 */
    controlMPC_FLOAT f29[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb29[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub29[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H30[2];

    /* vector of size 2 */
    controlMPC_FLOAT f30[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb30[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub30[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H31[2];

    /* vector of size 2 */
    controlMPC_FLOAT f31[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb31[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub31[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H32[2];

    /* vector of size 2 */
    controlMPC_FLOAT f32[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb32[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub32[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H33[2];

    /* vector of size 2 */
    controlMPC_FLOAT f33[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb33[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub33[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H34[2];

    /* vector of size 2 */
    controlMPC_FLOAT f34[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb34[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub34[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H35[2];

    /* vector of size 2 */
    controlMPC_FLOAT f35[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb35[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub35[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H36[2];

    /* vector of size 2 */
    controlMPC_FLOAT f36[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb36[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub36[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H37[2];

    /* vector of size 2 */
    controlMPC_FLOAT f37[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb37[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub37[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H38[2];

    /* vector of size 2 */
    controlMPC_FLOAT f38[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb38[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub38[2];

    /* diagonal matrix of size [2 x 2] (only the diagonal is stored) */
    controlMPC_FLOAT H39[2];

    /* vector of size 2 */
    controlMPC_FLOAT f39[2];

    /* vector of size 2 */
    controlMPC_FLOAT lb39[2];

    /* vector of size 2 */
    controlMPC_FLOAT ub39[2];
...
typedef struct controlMPC_output
{
    ...
    /* vector of size 2 */
    controlMPC_FLOAT z25[2];

    /* vector of size 2 */
    controlMPC_FLOAT z26[2];

    /* vector of size 2 */
    controlMPC_FLOAT z27[2];

    /* vector of size 2 */
    controlMPC_FLOAT z28[2];

    /* vector of size 2 */
    controlMPC_FLOAT z29[2];

    /* vector of size 2 */
    controlMPC_FLOAT z30[2];

    /* vector of size 2 */
    controlMPC_FLOAT z31[2];

    /* vector of size 2 */
    controlMPC_FLOAT z32[2];

    /* vector of size 2 */
    controlMPC_FLOAT z33[2];

    /* vector of size 2 */
    controlMPC_FLOAT z34[2];

    /* vector of size 2 */
    controlMPC_FLOAT z35[2];

    /* vector of size 2 */
    controlMPC_FLOAT z36[2];

    /* vector of size 2 */
    controlMPC_FLOAT z37[2];

    /* vector of size 2 */
    controlMPC_FLOAT z38[2];

    /* vector of size 2 */
    controlMPC_FLOAT z39[2];
