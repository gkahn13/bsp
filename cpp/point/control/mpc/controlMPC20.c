 ...
 */
void controlMPC_LA_INITIALIZEVECTOR_38(controlMPC_FLOAT* vec, controlMPC_FLOAT value)
{
	int i;
	for( i=0; i<38; i++ )
	{
 ...
 */
void controlMPC_LA_DOTACC_76(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<76; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 38.
 */
void controlMPC_LA_VVADD3_38(controlMPC_FLOAT *u, controlMPC_FLOAT *v, controlMPC_FLOAT *w, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<38; i++ ){
		z[i] = u[i] + v[i] + w[i];
 ...
 */
void controlMPC_LA_VSUB2_38(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<38; i++){
		z[i] = -x[i] - y[i];
...
int controlMPC_LINESEARCH_BACKTRACKING_AFFINE(controlMPC_FLOAT *l, controlMPC_FLOAT *s, controlMPC_FLOAT *dl, controlMPC_FLOAT *ds, controlMPC_FLOAT *a, controlMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (controlMPC_FLOAT)76;
    return lsIt;
}
 ...
 */
void controlMPC_LA_VSUB5_76(controlMPC_FLOAT *u, controlMPC_FLOAT *v, controlMPC_FLOAT a, controlMPC_FLOAT *x)
{
	int i;
	for( i=0; i<76; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 38.
 */
void controlMPC_LA_VSUB_38(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<38; i++){
		z[i] = x[i] - y[i];
 ...
 */
void controlMPC_LA_VSUB7_76(controlMPC_FLOAT *l, controlMPC_FLOAT *r, controlMPC_FLOAT *s, controlMPC_FLOAT *dl, controlMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<76; i++){
 ...
 */
void controlMPC_LA_VADD_38(controlMPC_FLOAT *x, controlMPC_FLOAT *y)
{
	int i;
	for( i=0; i<38; i++){
		x[i] += y[i];
...
controlMPC_FLOAT controlMPC_z[38];
controlMPC_FLOAT controlMPC_v[36];
controlMPC_FLOAT controlMPC_dz_aff[38];
controlMPC_FLOAT controlMPC_dv_aff[36];
controlMPC_FLOAT controlMPC_grad_cost[38];
controlMPC_FLOAT controlMPC_grad_eq[38];
controlMPC_FLOAT controlMPC_rd[38];
controlMPC_FLOAT controlMPC_l[76];
controlMPC_FLOAT controlMPC_s[76];
controlMPC_FLOAT controlMPC_lbys[76];
controlMPC_FLOAT controlMPC_dl_aff[76];
controlMPC_FLOAT controlMPC_ds_aff[76];
controlMPC_FLOAT controlMPC_dz_cc[38];
controlMPC_FLOAT controlMPC_dv_cc[36];
controlMPC_FLOAT controlMPC_dl_cc[76];
controlMPC_FLOAT controlMPC_ds_cc[76];
controlMPC_FLOAT controlMPC_ccrhs[76];
controlMPC_FLOAT controlMPC_grad_ineq[38];
...
info->it = 0;
controlMPC_LA_INITIALIZEVECTOR_38(controlMPC_z, 0);
controlMPC_LA_INITIALIZEVECTOR_36(controlMPC_v, 1);
controlMPC_LA_INITIALIZEVECTOR_76(controlMPC_l, 1);
controlMPC_LA_INITIALIZEVECTOR_76(controlMPC_s, 1);
info->mu = 0;
controlMPC_LA_DOTACC_76(controlMPC_l, controlMPC_s, &info->mu);
info->mu /= 76;
while( 1 ){
info->pobj = 0;
...
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_v17, controlMPC_grad_eq18);
info->res_ineq = 0;
...
controlMPC_LA_VVADD3_38(controlMPC_grad_cost, controlMPC_grad_eq, controlMPC_grad_ineq, controlMPC_rd);
...
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld17, controlMPC_yy17, controlMPC_dvaff17);
...
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_dvaff17, controlMPC_grad_eq18);
controlMPC_LA_VSUB2_38(controlMPC_rd, controlMPC_grad_eq, controlMPC_rd);
...
controlMPC_LA_VSUB5_76(controlMPC_ds_aff, controlMPC_dl_aff, musigma, controlMPC_ccrhs);
...
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd17, controlMPC_yy16, controlMPC_beta17, controlMPC_bmy17);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld17, controlMPC_bmy17, controlMPC_yy17);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld17, controlMPC_yy17, controlMPC_dvcc17);
...
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_dvcc17, controlMPC_grad_eq18);
controlMPC_LA_VSUB_38(controlMPC_rd, controlMPC_grad_eq, controlMPC_rd);
...
controlMPC_LA_VSUB7_76(controlMPC_l, controlMPC_ccrhs, controlMPC_s, controlMPC_dl_cc, controlMPC_ds_cc);
controlMPC_LA_VADD_38(controlMPC_dz_cc, controlMPC_dz_aff);
controlMPC_LA_VADD_36(controlMPC_dv_cc, controlMPC_dv_aff);
controlMPC_LA_VADD_76(controlMPC_dl_cc, controlMPC_dl_aff);
controlMPC_LA_VADD_76(controlMPC_ds_cc, controlMPC_ds_aff);
