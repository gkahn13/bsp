...
typedef struct beliefPenaltyMPC_params
{
    ...
    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f20[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb20[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub20[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C20[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e20[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f21[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb21[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub21[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C21[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e21[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f22[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb22[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub22[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C22[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e22[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f23[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb23[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub23[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C23[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e23[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f24[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb24[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub24[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C24[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e24[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f25[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb25[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub25[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C25[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e25[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f26[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb26[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub26[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C26[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e26[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f27[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb27[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub27[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C27[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e27[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f28[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb28[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub28[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C28[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e28[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f29[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb29[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub29[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C29[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e29[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f30[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb30[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub30[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C30[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e30[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f31[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb31[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub31[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C31[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e31[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f32[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb32[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub32[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C32[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e32[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f33[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb33[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub33[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C33[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e33[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f34[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb34[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub34[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C34[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e34[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f35[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb35[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub35[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C35[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e35[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f36[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb36[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub36[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C36[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e36[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f37[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb37[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub37[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C37[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e37[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f38[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb38[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub38[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C38[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e38[5];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT f39[17];

    /* vector of size 17 */
    beliefPenaltyMPC_FLOAT lb39[17];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT ub39[7];

    /* matrix of size [5 x 17] (column major format) */
    beliefPenaltyMPC_FLOAT C39[85];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT e39[5];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT lb40[5];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT ub40[5];
...
typedef struct beliefPenaltyMPC_output
{
    ...
    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z20[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z21[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z22[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z23[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z24[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z25[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z26[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z27[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z28[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z29[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z30[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z31[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z32[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z33[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z34[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z35[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z36[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z37[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z38[7];

    /* vector of size 7 */
    beliefPenaltyMPC_FLOAT z39[7];

    /* vector of size 5 */
    beliefPenaltyMPC_FLOAT z40[5];
