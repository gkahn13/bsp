...
typedef struct planarMPC_params
{
    ...
    planarMPC_FLOAT H1[14];

    /* vector of size 14 */
    planarMPC_FLOAT f1[14];

    /* vector of size 14 */
    planarMPC_FLOAT lb1[14];

    /* vector of size 14 */
    planarMPC_FLOAT ub1[14];

    /* vector of size 7 */
    planarMPC_FLOAT c1[7];

    /* diagonal matrix of size [14 x 14] (only the diagonal is stored) */
    planarMPC_FLOAT H2[14];

    /* vector of size 14 */
    planarMPC_FLOAT f2[14];

    /* vector of size 14 */
    planarMPC_FLOAT lb2[14];

    /* vector of size 14 */
    planarMPC_FLOAT ub2[14];

    /* diagonal matrix of size [14 x 14] (only the diagonal is stored) */
    planarMPC_FLOAT H3[14];

    /* vector of size 14 */
    planarMPC_FLOAT f3[14];

    /* vector of size 14 */
    planarMPC_FLOAT lb3[14];

    /* vector of size 14 */
    planarMPC_FLOAT ub3[14];

    /* diagonal matrix of size [14 x 14] (only the diagonal is stored) */
    planarMPC_FLOAT H4[14];

    /* vector of size 14 */
    planarMPC_FLOAT f4[14];

    /* vector of size 14 */
    planarMPC_FLOAT lb4[14];

    /* vector of size 14 */
    planarMPC_FLOAT ub4[14];

    /* diagonal matrix of size [7 x 7] (only the diagonal is stored) */
    planarMPC_FLOAT H5[7];

    /* vector of size 7 */
    planarMPC_FLOAT f5[7];

    /* vector of size 7 */
    planarMPC_FLOAT lb5[7];

    /* vector of size 7 */
    planarMPC_FLOAT ub5[7];
...
{
    /* vector of size 14 */
    planarMPC_FLOAT z1[14];

    /* vector of size 14 */
    planarMPC_FLOAT z2[14];

    /* vector of size 14 */
    planarMPC_FLOAT z3[14];

    /* vector of size 14 */
    planarMPC_FLOAT z4[14];

    /* vector of size 7 */
    planarMPC_FLOAT z5[7];
