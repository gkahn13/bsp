 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_118(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<118; i++ )
	{
 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_60(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<60; i++ )
	{
 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_236(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<236; i++ )
	{
 ...
 */
void stateMPC_LA_DOTACC_236(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<236; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 118.
 */
void stateMPC_LA_VVADD3_118(stateMPC_FLOAT *u, stateMPC_FLOAT *v, stateMPC_FLOAT *w, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<118; i++ ){
		z[i] = u[i] + v[i] + w[i];
 ...
 */
void stateMPC_LA_VSUB2_118(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<118; i++){
		z[i] = -x[i] - y[i];
...
int stateMPC_LINESEARCH_BACKTRACKING_AFFINE(stateMPC_FLOAT *l, stateMPC_FLOAT *s, stateMPC_FLOAT *dl, stateMPC_FLOAT *ds, stateMPC_FLOAT *a, stateMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (stateMPC_FLOAT)236;
    return lsIt;
}
 ...
 */
void stateMPC_LA_VSUB5_236(stateMPC_FLOAT *u, stateMPC_FLOAT *v, stateMPC_FLOAT a, stateMPC_FLOAT *x)
{
	int i;
	for( i=0; i<236; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 118.
 */
void stateMPC_LA_VSUB_118(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<118; i++){
		z[i] = x[i] - y[i];
 ...
 */
void stateMPC_LA_VSUB7_236(stateMPC_FLOAT *l, stateMPC_FLOAT *r, stateMPC_FLOAT *s, stateMPC_FLOAT *dl, stateMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<236; i++){
 ...
 */
void stateMPC_LA_VADD_118(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<118; i++){
		x[i] += y[i];
 ...
 */
void stateMPC_LA_VADD_60(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<60; i++){
		x[i] += y[i];
 ...
 */
void stateMPC_LA_VADD_236(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<236; i++){
		x[i] += y[i];
...
stateMPC_FLOAT stateMPC_z[118];
stateMPC_FLOAT stateMPC_v[60];
stateMPC_FLOAT stateMPC_dz_aff[118];
stateMPC_FLOAT stateMPC_dv_aff[60];
stateMPC_FLOAT stateMPC_grad_cost[118];
stateMPC_FLOAT stateMPC_grad_eq[118];
stateMPC_FLOAT stateMPC_rd[118];
stateMPC_FLOAT stateMPC_l[236];
stateMPC_FLOAT stateMPC_s[236];
stateMPC_FLOAT stateMPC_lbys[236];
stateMPC_FLOAT stateMPC_dl_aff[236];
stateMPC_FLOAT stateMPC_ds_aff[236];
stateMPC_FLOAT stateMPC_dz_cc[118];
stateMPC_FLOAT stateMPC_dv_cc[60];
stateMPC_FLOAT stateMPC_dl_cc[236];
stateMPC_FLOAT stateMPC_ds_cc[236];
stateMPC_FLOAT stateMPC_ccrhs[236];
stateMPC_FLOAT stateMPC_grad_ineq[118];
...
stateMPC_FLOAT stateMPC_Lbyrd29[2];
...
stateMPC_FLOAT stateMPC_ctv29[2];
...
stateMPC_FLOAT stateMPC_rilb29[2];
...
int stateMPC_ubIdx29[2] = {0, 1};
stateMPC_FLOAT* stateMPC_lub29 = stateMPC_l + 234;
stateMPC_FLOAT* stateMPC_sub29 = stateMPC_s + 234;
stateMPC_FLOAT* stateMPC_lubbysub29 = stateMPC_lbys + 234;
stateMPC_FLOAT stateMPC_riub29[2];
stateMPC_FLOAT* stateMPC_dlubaff29 = stateMPC_dl_aff + 234;
stateMPC_FLOAT* stateMPC_dsubaff29 = stateMPC_ds_aff + 234;
stateMPC_FLOAT* stateMPC_dlubcc29 = stateMPC_dl_cc + 234;
stateMPC_FLOAT* stateMPC_dsubcc29 = stateMPC_ds_cc + 234;
stateMPC_FLOAT* stateMPC_ccrhsub29 = stateMPC_ccrhs + 234;
stateMPC_FLOAT stateMPC_Phi29[2];
stateMPC_FLOAT stateMPC_D29[2] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000};
stateMPC_FLOAT stateMPC_W29[2];
...
info->it = 0;
stateMPC_LA_INITIALIZEVECTOR_118(stateMPC_z, 0);
stateMPC_LA_INITIALIZEVECTOR_60(stateMPC_v, 1);
stateMPC_LA_INITIALIZEVECTOR_236(stateMPC_l, 1);
stateMPC_LA_INITIALIZEVECTOR_236(stateMPC_s, 1);
info->mu = 0;
stateMPC_LA_DOTACC_236(stateMPC_l, stateMPC_s, &info->mu);
info->mu /= 236;
while( 1 ){
info->pobj = 0;
...
stateMPC_LA_DIAG_QUADFCN_2(params->H30, params->f30, stateMPC_z29, stateMPC_grad_cost29, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
stateMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_2(params->C29, stateMPC_z28, stateMPC_D29, stateMPC_z29, params->e30, stateMPC_v29, stateMPC_re29, &info->dgap, &info->res_eq);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D29, stateMPC_v29, stateMPC_grad_eq29);
info->res_ineq = 0;
...
stateMPC_LA_VSUBADD3_2(params->lb30, stateMPC_z29, stateMPC_lbIdx29, stateMPC_llb29, stateMPC_slb29, stateMPC_rilb29, &info->dgap, &info->res_ineq);
stateMPC_LA_VSUBADD2_2(stateMPC_z29, stateMPC_ubIdx29, params->ub30, stateMPC_lub29, stateMPC_sub29, stateMPC_riub29, &info->dgap, &info->res_ineq);
...
stateMPC_LA_INEQ_B_GRAD_2_2_2(stateMPC_lub29, stateMPC_sub29, stateMPC_riub29, stateMPC_llb29, stateMPC_slb29, stateMPC_rilb29, stateMPC_lbIdx29, stateMPC_ubIdx29, stateMPC_grad_ineq29, stateMPC_lubbysub29, stateMPC_llbbyslb29);
...
stateMPC_LA_VVADD3_118(stateMPC_grad_cost, stateMPC_grad_eq, stateMPC_grad_ineq, stateMPC_rd);
...
stateMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H30, stateMPC_llbbyslb29, stateMPC_lbIdx29, stateMPC_lubbysub29, stateMPC_ubIdx29, stateMPC_Phi29);
stateMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(stateMPC_Phi29, stateMPC_D29, stateMPC_W29);
stateMPC_LA_DIAG_FORWARDSUB_2(stateMPC_Phi29, stateMPC_rd29, stateMPC_Lbyrd29);
...
stateMPC_LA_DENSE_DIAGZERO_MMT2_2_4_2(stateMPC_V28, stateMPC_W29, stateMPC_Yd29);
stateMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_4_2(stateMPC_V28, stateMPC_Lbyrd28, stateMPC_W29, stateMPC_Lbyrd29, stateMPC_re29, stateMPC_beta29);
...
stateMPC_LA_DENSE_BACKWARDSUB_2(stateMPC_Ld29, stateMPC_yy29, stateMPC_dvaff29);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D29, stateMPC_dvaff29, stateMPC_grad_eq29);
stateMPC_LA_VSUB2_118(stateMPC_rd, stateMPC_grad_eq, stateMPC_rd);
...
stateMPC_LA_DIAG_FORWARDBACKWARDSUB_2(stateMPC_Phi29, stateMPC_rd29, stateMPC_dzaff29);
...
stateMPC_LA_VSUB_INDEXED_2(stateMPC_dzaff29, stateMPC_lbIdx29, stateMPC_rilb29, stateMPC_dslbaff29);
stateMPC_LA_VSUB3_2(stateMPC_llbbyslb29, stateMPC_dslbaff29, stateMPC_llb29, stateMPC_dllbaff29);
stateMPC_LA_VSUB2_INDEXED_2(stateMPC_riub29, stateMPC_dzaff29, stateMPC_ubIdx29, stateMPC_dsubaff29);
stateMPC_LA_VSUB3_2(stateMPC_lubbysub29, stateMPC_dsubaff29, stateMPC_lub29, stateMPC_dlubaff29);
...
stateMPC_LA_VSUB5_236(stateMPC_ds_aff, stateMPC_dl_aff, musigma, stateMPC_ccrhs);
...
stateMPC_LA_DENSE_MVMSUB1_2_2(stateMPC_Lsd28, stateMPC_yy27, stateMPC_beta28, stateMPC_bmy28);
stateMPC_LA_DENSE_FORWARDSUB_2(stateMPC_Ld28, stateMPC_bmy28, stateMPC_yy28);
stateMPC_LA_VSUB6_INDEXED_2_2_2(stateMPC_ccrhsub29, stateMPC_sub29, stateMPC_ubIdx29, stateMPC_ccrhsl29, stateMPC_slb29, stateMPC_lbIdx29, stateMPC_rd29);
stateMPC_LA_DIAG_FORWARDSUB_2(stateMPC_Phi29, stateMPC_rd29, stateMPC_Lbyrd29);
stateMPC_LA_DENSE_DIAGZERO_2MVMADD_2_4_2(stateMPC_V28, stateMPC_Lbyrd28, stateMPC_W29, stateMPC_Lbyrd29, stateMPC_beta29);
stateMPC_LA_DENSE_MVMSUB1_2_2(stateMPC_Lsd29, stateMPC_yy28, stateMPC_beta29, stateMPC_bmy29);
stateMPC_LA_DENSE_FORWARDSUB_2(stateMPC_Ld29, stateMPC_bmy29, stateMPC_yy29);
stateMPC_LA_DENSE_BACKWARDSUB_2(stateMPC_Ld29, stateMPC_yy29, stateMPC_dvcc29);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D29, stateMPC_dvcc29, stateMPC_grad_eq29);
stateMPC_LA_VSUB_118(stateMPC_rd, stateMPC_grad_eq, stateMPC_rd);
...
stateMPC_LA_DIAG_FORWARDBACKWARDSUB_2(stateMPC_Phi29, stateMPC_rd29, stateMPC_dzcc29);
...
stateMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(stateMPC_ccrhsl29, stateMPC_slb29, stateMPC_llbbyslb29, stateMPC_dzcc29, stateMPC_lbIdx29, stateMPC_dllbcc29);
stateMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(stateMPC_ccrhsub29, stateMPC_sub29, stateMPC_lubbysub29, stateMPC_dzcc29, stateMPC_ubIdx29, stateMPC_dlubcc29);
stateMPC_LA_VSUB7_236(stateMPC_l, stateMPC_ccrhs, stateMPC_s, stateMPC_dl_cc, stateMPC_ds_cc);
stateMPC_LA_VADD_118(stateMPC_dz_cc, stateMPC_dz_aff);
stateMPC_LA_VADD_60(stateMPC_dv_cc, stateMPC_dv_aff);
stateMPC_LA_VADD_236(stateMPC_dl_cc, stateMPC_dl_aff);
stateMPC_LA_VADD_236(stateMPC_ds_cc, stateMPC_ds_aff);
