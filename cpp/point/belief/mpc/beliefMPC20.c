...
/*
 * Initializes a vector of length 138 with a value.
 */
void beliefMPC_LA_INITIALIZEVECTOR_138(beliefMPC_FLOAT* vec, beliefMPC_FLOAT value)
{
	int i;
	for( i=0; i<138; i++ )
	{
...
/*
 * Initializes a vector of length 100 with a value.
 */
void beliefMPC_LA_INITIALIZEVECTOR_100(beliefMPC_FLOAT* vec, beliefMPC_FLOAT value)
{
	int i;
	for( i=0; i<100; i++ )
	{
 ...
 */
void beliefMPC_LA_INITIALIZEVECTOR_276(beliefMPC_FLOAT* vec, beliefMPC_FLOAT value)
{
	int i;
	for( i=0; i<276; i++ )
	{
 ...
 * This function is for vectors of length 276.
 */
void beliefMPC_LA_DOTACC_276(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y, beliefMPC_FLOAT *z)
{
	int i;
	for( i=0; i<276; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 138.
 */
void beliefMPC_LA_VVADD3_138(beliefMPC_FLOAT *u, beliefMPC_FLOAT *v, beliefMPC_FLOAT *w, beliefMPC_FLOAT *z)
{
	int i;
	for( i=0; i<138; i++ ){
		z[i] = u[i] + v[i] + w[i];
...
/*
 * Vector subtraction z = -x - y for vectors of length 138.
 */
void beliefMPC_LA_VSUB2_138(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y, beliefMPC_FLOAT *z)
{
	int i;
	for( i=0; i<138; i++){
		z[i] = -x[i] - y[i];
...
int beliefMPC_LINESEARCH_BACKTRACKING_AFFINE(beliefMPC_FLOAT *l, beliefMPC_FLOAT *s, beliefMPC_FLOAT *dl, beliefMPC_FLOAT *ds, beliefMPC_FLOAT *a, beliefMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (beliefMPC_FLOAT)276;
    return lsIt;
}
...
*  and x,u,v are vectors of length 276.
 */
void beliefMPC_LA_VSUB5_276(beliefMPC_FLOAT *u, beliefMPC_FLOAT *v, beliefMPC_FLOAT a, beliefMPC_FLOAT *x)
{
	int i;
	for( i=0; i<276; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 138.
 */
void beliefMPC_LA_VSUB_138(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y, beliefMPC_FLOAT *z)
{
	int i;
	for( i=0; i<138; i++){
		z[i] = x[i] - y[i];
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 276.
 */
void beliefMPC_LA_VSUB7_276(beliefMPC_FLOAT *l, beliefMPC_FLOAT *r, beliefMPC_FLOAT *s, beliefMPC_FLOAT *dl, beliefMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<276; i++){
...
/*
 * Vector addition x = x + y for vectors of length 138.
 */
void beliefMPC_LA_VADD_138(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y)
{
	int i;
	for( i=0; i<138; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 100.
 */
void beliefMPC_LA_VADD_100(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y)
{
	int i;
	for( i=0; i<100; i++){
		x[i] += y[i];
 ...
 */
void beliefMPC_LA_VADD_276(beliefMPC_FLOAT *x, beliefMPC_FLOAT *y)
{
	int i;
	for( i=0; i<276; i++){
		x[i] += y[i];
...
beliefMPC_FLOAT beliefMPC_z[138];
beliefMPC_FLOAT beliefMPC_v[100];
beliefMPC_FLOAT beliefMPC_dz_aff[138];
beliefMPC_FLOAT beliefMPC_dv_aff[100];
beliefMPC_FLOAT beliefMPC_grad_cost[138];
beliefMPC_FLOAT beliefMPC_grad_eq[138];
beliefMPC_FLOAT beliefMPC_rd[138];
beliefMPC_FLOAT beliefMPC_l[276];
beliefMPC_FLOAT beliefMPC_s[276];
beliefMPC_FLOAT beliefMPC_lbys[276];
beliefMPC_FLOAT beliefMPC_dl_aff[276];
beliefMPC_FLOAT beliefMPC_ds_aff[276];
beliefMPC_FLOAT beliefMPC_dz_cc[138];
beliefMPC_FLOAT beliefMPC_dv_cc[100];
beliefMPC_FLOAT beliefMPC_dl_cc[276];
beliefMPC_FLOAT beliefMPC_ds_cc[276];
beliefMPC_FLOAT beliefMPC_ccrhs[276];
beliefMPC_FLOAT beliefMPC_grad_ineq[138];
...
beliefMPC_FLOAT beliefMPC_f14[7] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
...
beliefMPC_FLOAT beliefMPC_Lbyrd14[7];
...
beliefMPC_FLOAT beliefMPC_ctv14[7];
beliefMPC_FLOAT* beliefMPC_v14 = beliefMPC_v + 75;
beliefMPC_FLOAT beliefMPC_re14[5];
beliefMPC_FLOAT beliefMPC_beta14[5];
beliefMPC_FLOAT beliefMPC_betacc14[5];
beliefMPC_FLOAT* beliefMPC_dvaff14 = beliefMPC_dv_aff + 75;
beliefMPC_FLOAT* beliefMPC_dvcc14 = beliefMPC_dv_cc + 75;
beliefMPC_FLOAT beliefMPC_V14[35];
beliefMPC_FLOAT beliefMPC_Yd14[15];
beliefMPC_FLOAT beliefMPC_Ld14[15];
beliefMPC_FLOAT beliefMPC_yy14[5];
beliefMPC_FLOAT beliefMPC_bmy14[5];
int beliefMPC_lbIdx14[7] = {0, 1, 2, 3, 4, 5, 6};
...
beliefMPC_FLOAT beliefMPC_rilb14[7];
...
int beliefMPC_ubIdx14[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_lub14 = beliefMPC_l + 203;
beliefMPC_FLOAT* beliefMPC_sub14 = beliefMPC_s + 203;
beliefMPC_FLOAT* beliefMPC_lubbysub14 = beliefMPC_lbys + 203;
beliefMPC_FLOAT beliefMPC_riub14[7];
beliefMPC_FLOAT* beliefMPC_dlubaff14 = beliefMPC_dl_aff + 203;
beliefMPC_FLOAT* beliefMPC_dsubaff14 = beliefMPC_ds_aff + 203;
beliefMPC_FLOAT* beliefMPC_dlubcc14 = beliefMPC_dl_cc + 203;
beliefMPC_FLOAT* beliefMPC_dsubcc14 = beliefMPC_ds_cc + 203;
beliefMPC_FLOAT* beliefMPC_ccrhsub14 = beliefMPC_ccrhs + 203;
beliefMPC_FLOAT beliefMPC_Phi14[7];
beliefMPC_FLOAT beliefMPC_W14[7];
beliefMPC_FLOAT beliefMPC_Ysd14[25];
beliefMPC_FLOAT beliefMPC_Lsd14[25];
beliefMPC_FLOAT beliefMPC_f15[7] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefMPC_FLOAT* beliefMPC_z15 = beliefMPC_z + 105;
beliefMPC_FLOAT* beliefMPC_dzaff15 = beliefMPC_dz_aff + 105;
beliefMPC_FLOAT* beliefMPC_dzcc15 = beliefMPC_dz_cc + 105;
beliefMPC_FLOAT* beliefMPC_rd15 = beliefMPC_rd + 105;
beliefMPC_FLOAT beliefMPC_Lbyrd15[7];
beliefMPC_FLOAT* beliefMPC_grad_cost15 = beliefMPC_grad_cost + 105;
beliefMPC_FLOAT* beliefMPC_grad_eq15 = beliefMPC_grad_eq + 105;
beliefMPC_FLOAT* beliefMPC_grad_ineq15 = beliefMPC_grad_ineq + 105;
beliefMPC_FLOAT beliefMPC_ctv15[7];
beliefMPC_FLOAT* beliefMPC_v15 = beliefMPC_v + 80;
beliefMPC_FLOAT beliefMPC_re15[5];
beliefMPC_FLOAT beliefMPC_beta15[5];
beliefMPC_FLOAT beliefMPC_betacc15[5];
beliefMPC_FLOAT* beliefMPC_dvaff15 = beliefMPC_dv_aff + 80;
beliefMPC_FLOAT* beliefMPC_dvcc15 = beliefMPC_dv_cc + 80;
beliefMPC_FLOAT beliefMPC_V15[35];
beliefMPC_FLOAT beliefMPC_Yd15[15];
beliefMPC_FLOAT beliefMPC_Ld15[15];
beliefMPC_FLOAT beliefMPC_yy15[5];
beliefMPC_FLOAT beliefMPC_bmy15[5];
int beliefMPC_lbIdx15[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_llb15 = beliefMPC_l + 210;
beliefMPC_FLOAT* beliefMPC_slb15 = beliefMPC_s + 210;
beliefMPC_FLOAT* beliefMPC_llbbyslb15 = beliefMPC_lbys + 210;
beliefMPC_FLOAT beliefMPC_rilb15[7];
beliefMPC_FLOAT* beliefMPC_dllbaff15 = beliefMPC_dl_aff + 210;
beliefMPC_FLOAT* beliefMPC_dslbaff15 = beliefMPC_ds_aff + 210;
beliefMPC_FLOAT* beliefMPC_dllbcc15 = beliefMPC_dl_cc + 210;
beliefMPC_FLOAT* beliefMPC_dslbcc15 = beliefMPC_ds_cc + 210;
beliefMPC_FLOAT* beliefMPC_ccrhsl15 = beliefMPC_ccrhs + 210;
int beliefMPC_ubIdx15[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_lub15 = beliefMPC_l + 217;
beliefMPC_FLOAT* beliefMPC_sub15 = beliefMPC_s + 217;
beliefMPC_FLOAT* beliefMPC_lubbysub15 = beliefMPC_lbys + 217;
beliefMPC_FLOAT beliefMPC_riub15[7];
beliefMPC_FLOAT* beliefMPC_dlubaff15 = beliefMPC_dl_aff + 217;
beliefMPC_FLOAT* beliefMPC_dsubaff15 = beliefMPC_ds_aff + 217;
beliefMPC_FLOAT* beliefMPC_dlubcc15 = beliefMPC_dl_cc + 217;
beliefMPC_FLOAT* beliefMPC_dsubcc15 = beliefMPC_ds_cc + 217;
beliefMPC_FLOAT* beliefMPC_ccrhsub15 = beliefMPC_ccrhs + 217;
beliefMPC_FLOAT beliefMPC_Phi15[7];
beliefMPC_FLOAT beliefMPC_W15[7];
beliefMPC_FLOAT beliefMPC_Ysd15[25];
beliefMPC_FLOAT beliefMPC_Lsd15[25];
beliefMPC_FLOAT beliefMPC_f16[7] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefMPC_FLOAT* beliefMPC_z16 = beliefMPC_z + 112;
beliefMPC_FLOAT* beliefMPC_dzaff16 = beliefMPC_dz_aff + 112;
beliefMPC_FLOAT* beliefMPC_dzcc16 = beliefMPC_dz_cc + 112;
beliefMPC_FLOAT* beliefMPC_rd16 = beliefMPC_rd + 112;
beliefMPC_FLOAT beliefMPC_Lbyrd16[7];
beliefMPC_FLOAT* beliefMPC_grad_cost16 = beliefMPC_grad_cost + 112;
beliefMPC_FLOAT* beliefMPC_grad_eq16 = beliefMPC_grad_eq + 112;
beliefMPC_FLOAT* beliefMPC_grad_ineq16 = beliefMPC_grad_ineq + 112;
beliefMPC_FLOAT beliefMPC_ctv16[7];
beliefMPC_FLOAT* beliefMPC_v16 = beliefMPC_v + 85;
beliefMPC_FLOAT beliefMPC_re16[5];
beliefMPC_FLOAT beliefMPC_beta16[5];
beliefMPC_FLOAT beliefMPC_betacc16[5];
beliefMPC_FLOAT* beliefMPC_dvaff16 = beliefMPC_dv_aff + 85;
beliefMPC_FLOAT* beliefMPC_dvcc16 = beliefMPC_dv_cc + 85;
beliefMPC_FLOAT beliefMPC_V16[35];
beliefMPC_FLOAT beliefMPC_Yd16[15];
beliefMPC_FLOAT beliefMPC_Ld16[15];
beliefMPC_FLOAT beliefMPC_yy16[5];
beliefMPC_FLOAT beliefMPC_bmy16[5];
int beliefMPC_lbIdx16[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_llb16 = beliefMPC_l + 224;
beliefMPC_FLOAT* beliefMPC_slb16 = beliefMPC_s + 224;
beliefMPC_FLOAT* beliefMPC_llbbyslb16 = beliefMPC_lbys + 224;
beliefMPC_FLOAT beliefMPC_rilb16[7];
beliefMPC_FLOAT* beliefMPC_dllbaff16 = beliefMPC_dl_aff + 224;
beliefMPC_FLOAT* beliefMPC_dslbaff16 = beliefMPC_ds_aff + 224;
beliefMPC_FLOAT* beliefMPC_dllbcc16 = beliefMPC_dl_cc + 224;
beliefMPC_FLOAT* beliefMPC_dslbcc16 = beliefMPC_ds_cc + 224;
beliefMPC_FLOAT* beliefMPC_ccrhsl16 = beliefMPC_ccrhs + 224;
int beliefMPC_ubIdx16[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_lub16 = beliefMPC_l + 231;
beliefMPC_FLOAT* beliefMPC_sub16 = beliefMPC_s + 231;
beliefMPC_FLOAT* beliefMPC_lubbysub16 = beliefMPC_lbys + 231;
beliefMPC_FLOAT beliefMPC_riub16[7];
beliefMPC_FLOAT* beliefMPC_dlubaff16 = beliefMPC_dl_aff + 231;
beliefMPC_FLOAT* beliefMPC_dsubaff16 = beliefMPC_ds_aff + 231;
beliefMPC_FLOAT* beliefMPC_dlubcc16 = beliefMPC_dl_cc + 231;
beliefMPC_FLOAT* beliefMPC_dsubcc16 = beliefMPC_ds_cc + 231;
beliefMPC_FLOAT* beliefMPC_ccrhsub16 = beliefMPC_ccrhs + 231;
beliefMPC_FLOAT beliefMPC_Phi16[7];
beliefMPC_FLOAT beliefMPC_W16[7];
beliefMPC_FLOAT beliefMPC_Ysd16[25];
beliefMPC_FLOAT beliefMPC_Lsd16[25];
beliefMPC_FLOAT beliefMPC_f17[7] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefMPC_FLOAT* beliefMPC_z17 = beliefMPC_z + 119;
beliefMPC_FLOAT* beliefMPC_dzaff17 = beliefMPC_dz_aff + 119;
beliefMPC_FLOAT* beliefMPC_dzcc17 = beliefMPC_dz_cc + 119;
beliefMPC_FLOAT* beliefMPC_rd17 = beliefMPC_rd + 119;
beliefMPC_FLOAT beliefMPC_Lbyrd17[7];
beliefMPC_FLOAT* beliefMPC_grad_cost17 = beliefMPC_grad_cost + 119;
beliefMPC_FLOAT* beliefMPC_grad_eq17 = beliefMPC_grad_eq + 119;
beliefMPC_FLOAT* beliefMPC_grad_ineq17 = beliefMPC_grad_ineq + 119;
beliefMPC_FLOAT beliefMPC_ctv17[7];
beliefMPC_FLOAT* beliefMPC_v17 = beliefMPC_v + 90;
beliefMPC_FLOAT beliefMPC_re17[5];
beliefMPC_FLOAT beliefMPC_beta17[5];
beliefMPC_FLOAT beliefMPC_betacc17[5];
beliefMPC_FLOAT* beliefMPC_dvaff17 = beliefMPC_dv_aff + 90;
beliefMPC_FLOAT* beliefMPC_dvcc17 = beliefMPC_dv_cc + 90;
beliefMPC_FLOAT beliefMPC_V17[35];
beliefMPC_FLOAT beliefMPC_Yd17[15];
beliefMPC_FLOAT beliefMPC_Ld17[15];
beliefMPC_FLOAT beliefMPC_yy17[5];
beliefMPC_FLOAT beliefMPC_bmy17[5];
int beliefMPC_lbIdx17[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_llb17 = beliefMPC_l + 238;
beliefMPC_FLOAT* beliefMPC_slb17 = beliefMPC_s + 238;
beliefMPC_FLOAT* beliefMPC_llbbyslb17 = beliefMPC_lbys + 238;
beliefMPC_FLOAT beliefMPC_rilb17[7];
beliefMPC_FLOAT* beliefMPC_dllbaff17 = beliefMPC_dl_aff + 238;
beliefMPC_FLOAT* beliefMPC_dslbaff17 = beliefMPC_ds_aff + 238;
beliefMPC_FLOAT* beliefMPC_dllbcc17 = beliefMPC_dl_cc + 238;
beliefMPC_FLOAT* beliefMPC_dslbcc17 = beliefMPC_ds_cc + 238;
beliefMPC_FLOAT* beliefMPC_ccrhsl17 = beliefMPC_ccrhs + 238;
int beliefMPC_ubIdx17[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_lub17 = beliefMPC_l + 245;
beliefMPC_FLOAT* beliefMPC_sub17 = beliefMPC_s + 245;
beliefMPC_FLOAT* beliefMPC_lubbysub17 = beliefMPC_lbys + 245;
beliefMPC_FLOAT beliefMPC_riub17[7];
beliefMPC_FLOAT* beliefMPC_dlubaff17 = beliefMPC_dl_aff + 245;
beliefMPC_FLOAT* beliefMPC_dsubaff17 = beliefMPC_ds_aff + 245;
beliefMPC_FLOAT* beliefMPC_dlubcc17 = beliefMPC_dl_cc + 245;
beliefMPC_FLOAT* beliefMPC_dsubcc17 = beliefMPC_ds_cc + 245;
beliefMPC_FLOAT* beliefMPC_ccrhsub17 = beliefMPC_ccrhs + 245;
beliefMPC_FLOAT beliefMPC_Phi17[7];
beliefMPC_FLOAT beliefMPC_W17[7];
beliefMPC_FLOAT beliefMPC_Ysd17[25];
beliefMPC_FLOAT beliefMPC_Lsd17[25];
beliefMPC_FLOAT beliefMPC_f18[7] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefMPC_FLOAT* beliefMPC_z18 = beliefMPC_z + 126;
beliefMPC_FLOAT* beliefMPC_dzaff18 = beliefMPC_dz_aff + 126;
beliefMPC_FLOAT* beliefMPC_dzcc18 = beliefMPC_dz_cc + 126;
beliefMPC_FLOAT* beliefMPC_rd18 = beliefMPC_rd + 126;
beliefMPC_FLOAT beliefMPC_Lbyrd18[7];
beliefMPC_FLOAT* beliefMPC_grad_cost18 = beliefMPC_grad_cost + 126;
beliefMPC_FLOAT* beliefMPC_grad_eq18 = beliefMPC_grad_eq + 126;
beliefMPC_FLOAT* beliefMPC_grad_ineq18 = beliefMPC_grad_ineq + 126;
beliefMPC_FLOAT beliefMPC_ctv18[7];
beliefMPC_FLOAT* beliefMPC_v18 = beliefMPC_v + 95;
beliefMPC_FLOAT beliefMPC_re18[5];
beliefMPC_FLOAT beliefMPC_beta18[5];
beliefMPC_FLOAT beliefMPC_betacc18[5];
beliefMPC_FLOAT* beliefMPC_dvaff18 = beliefMPC_dv_aff + 95;
beliefMPC_FLOAT* beliefMPC_dvcc18 = beliefMPC_dv_cc + 95;
beliefMPC_FLOAT beliefMPC_V18[35];
beliefMPC_FLOAT beliefMPC_Yd18[15];
beliefMPC_FLOAT beliefMPC_Ld18[15];
beliefMPC_FLOAT beliefMPC_yy18[5];
beliefMPC_FLOAT beliefMPC_bmy18[5];
int beliefMPC_lbIdx18[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_llb18 = beliefMPC_l + 252;
beliefMPC_FLOAT* beliefMPC_slb18 = beliefMPC_s + 252;
beliefMPC_FLOAT* beliefMPC_llbbyslb18 = beliefMPC_lbys + 252;
beliefMPC_FLOAT beliefMPC_rilb18[7];
beliefMPC_FLOAT* beliefMPC_dllbaff18 = beliefMPC_dl_aff + 252;
beliefMPC_FLOAT* beliefMPC_dslbaff18 = beliefMPC_ds_aff + 252;
beliefMPC_FLOAT* beliefMPC_dllbcc18 = beliefMPC_dl_cc + 252;
beliefMPC_FLOAT* beliefMPC_dslbcc18 = beliefMPC_ds_cc + 252;
beliefMPC_FLOAT* beliefMPC_ccrhsl18 = beliefMPC_ccrhs + 252;
int beliefMPC_ubIdx18[7] = {0, 1, 2, 3, 4, 5, 6};
beliefMPC_FLOAT* beliefMPC_lub18 = beliefMPC_l + 259;
beliefMPC_FLOAT* beliefMPC_sub18 = beliefMPC_s + 259;
beliefMPC_FLOAT* beliefMPC_lubbysub18 = beliefMPC_lbys + 259;
beliefMPC_FLOAT beliefMPC_riub18[7];
beliefMPC_FLOAT* beliefMPC_dlubaff18 = beliefMPC_dl_aff + 259;
beliefMPC_FLOAT* beliefMPC_dsubaff18 = beliefMPC_ds_aff + 259;
beliefMPC_FLOAT* beliefMPC_dlubcc18 = beliefMPC_dl_cc + 259;
beliefMPC_FLOAT* beliefMPC_dsubcc18 = beliefMPC_ds_cc + 259;
beliefMPC_FLOAT* beliefMPC_ccrhsub18 = beliefMPC_ccrhs + 259;
beliefMPC_FLOAT beliefMPC_Phi18[7];
beliefMPC_FLOAT beliefMPC_W18[7];
beliefMPC_FLOAT beliefMPC_Ysd18[25];
beliefMPC_FLOAT beliefMPC_Lsd18[25];
beliefMPC_FLOAT beliefMPC_H19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 2.0000000000000000E+001, 2.0000000000000000E+001, 2.0000000000000000E+001};
beliefMPC_FLOAT beliefMPC_f19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
beliefMPC_FLOAT* beliefMPC_z19 = beliefMPC_z + 133;
beliefMPC_FLOAT* beliefMPC_dzaff19 = beliefMPC_dz_aff + 133;
beliefMPC_FLOAT* beliefMPC_dzcc19 = beliefMPC_dz_cc + 133;
beliefMPC_FLOAT* beliefMPC_rd19 = beliefMPC_rd + 133;
beliefMPC_FLOAT beliefMPC_Lbyrd19[5];
beliefMPC_FLOAT* beliefMPC_grad_cost19 = beliefMPC_grad_cost + 133;
beliefMPC_FLOAT* beliefMPC_grad_eq19 = beliefMPC_grad_eq + 133;
beliefMPC_FLOAT* beliefMPC_grad_ineq19 = beliefMPC_grad_ineq + 133;
beliefMPC_FLOAT beliefMPC_ctv19[5];
int beliefMPC_lbIdx19[5] = {0, 1, 2, 3, 4};
beliefMPC_FLOAT* beliefMPC_llb19 = beliefMPC_l + 266;
beliefMPC_FLOAT* beliefMPC_slb19 = beliefMPC_s + 266;
beliefMPC_FLOAT* beliefMPC_llbbyslb19 = beliefMPC_lbys + 266;
beliefMPC_FLOAT beliefMPC_rilb19[5];
beliefMPC_FLOAT* beliefMPC_dllbaff19 = beliefMPC_dl_aff + 266;
beliefMPC_FLOAT* beliefMPC_dslbaff19 = beliefMPC_ds_aff + 266;
beliefMPC_FLOAT* beliefMPC_dllbcc19 = beliefMPC_dl_cc + 266;
beliefMPC_FLOAT* beliefMPC_dslbcc19 = beliefMPC_ds_cc + 266;
beliefMPC_FLOAT* beliefMPC_ccrhsl19 = beliefMPC_ccrhs + 266;
int beliefMPC_ubIdx19[5] = {0, 1, 2, 3, 4};
beliefMPC_FLOAT* beliefMPC_lub19 = beliefMPC_l + 271;
beliefMPC_FLOAT* beliefMPC_sub19 = beliefMPC_s + 271;
beliefMPC_FLOAT* beliefMPC_lubbysub19 = beliefMPC_lbys + 271;
beliefMPC_FLOAT beliefMPC_riub19[5];
beliefMPC_FLOAT* beliefMPC_dlubaff19 = beliefMPC_dl_aff + 271;
beliefMPC_FLOAT* beliefMPC_dsubaff19 = beliefMPC_ds_aff + 271;
beliefMPC_FLOAT* beliefMPC_dlubcc19 = beliefMPC_dl_cc + 271;
beliefMPC_FLOAT* beliefMPC_dsubcc19 = beliefMPC_ds_cc + 271;
beliefMPC_FLOAT* beliefMPC_ccrhsub19 = beliefMPC_ccrhs + 271;
beliefMPC_FLOAT beliefMPC_Phi19[5];
beliefMPC_FLOAT beliefMPC_D19[5] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
beliefMPC_FLOAT beliefMPC_W19[5];
...
info->it = 0;
beliefMPC_LA_INITIALIZEVECTOR_138(beliefMPC_z, 0);
beliefMPC_LA_INITIALIZEVECTOR_100(beliefMPC_v, 1);
beliefMPC_LA_INITIALIZEVECTOR_276(beliefMPC_l, 1);
beliefMPC_LA_INITIALIZEVECTOR_276(beliefMPC_s, 1);
info->mu = 0;
beliefMPC_LA_DOTACC_276(beliefMPC_l, beliefMPC_s, &info->mu);
info->mu /= 276;
while( 1 ){
info->pobj = 0;
...
beliefMPC_LA_DIAG_QUADFCN_7(beliefMPC_H00, beliefMPC_f14, beliefMPC_z14, beliefMPC_grad_cost14, &info->pobj);
beliefMPC_LA_DIAG_QUADFCN_7(beliefMPC_H00, beliefMPC_f15, beliefMPC_z15, beliefMPC_grad_cost15, &info->pobj);
beliefMPC_LA_DIAG_QUADFCN_7(beliefMPC_H00, beliefMPC_f16, beliefMPC_z16, beliefMPC_grad_cost16, &info->pobj);
beliefMPC_LA_DIAG_QUADFCN_7(beliefMPC_H00, beliefMPC_f17, beliefMPC_z17, beliefMPC_grad_cost17, &info->pobj);
beliefMPC_LA_DIAG_QUADFCN_7(beliefMPC_H00, beliefMPC_f18, beliefMPC_z18, beliefMPC_grad_cost18, &info->pobj);
beliefMPC_LA_DIAG_QUADFCN_5(beliefMPC_H19, beliefMPC_f19, beliefMPC_z19, beliefMPC_grad_cost19, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_7(params->C14, beliefMPC_z13, beliefMPC_D02, beliefMPC_z14, params->e14, beliefMPC_v13, beliefMPC_re13, &info->dgap, &info->res_eq);
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_7(params->C15, beliefMPC_z14, beliefMPC_D02, beliefMPC_z15, params->e15, beliefMPC_v14, beliefMPC_re14, &info->dgap, &info->res_eq);
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_7(params->C16, beliefMPC_z15, beliefMPC_D02, beliefMPC_z16, params->e16, beliefMPC_v15, beliefMPC_re15, &info->dgap, &info->res_eq);
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_7(params->C17, beliefMPC_z16, beliefMPC_D02, beliefMPC_z17, params->e17, beliefMPC_v16, beliefMPC_re16, &info->dgap, &info->res_eq);
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_7(params->C18, beliefMPC_z17, beliefMPC_D02, beliefMPC_z18, params->e18, beliefMPC_v17, beliefMPC_re17, &info->dgap, &info->res_eq);
beliefMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_7_5(params->C19, beliefMPC_z18, beliefMPC_D19, beliefMPC_z19, params->e19, beliefMPC_v18, beliefMPC_re18, &info->dgap, &info->res_eq);
...
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C15, beliefMPC_v14, beliefMPC_D02, beliefMPC_v13, beliefMPC_grad_eq14);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C16, beliefMPC_v15, beliefMPC_D02, beliefMPC_v14, beliefMPC_grad_eq15);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C17, beliefMPC_v16, beliefMPC_D02, beliefMPC_v15, beliefMPC_grad_eq16);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C18, beliefMPC_v17, beliefMPC_D02, beliefMPC_v16, beliefMPC_grad_eq17);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C19, beliefMPC_v18, beliefMPC_D02, beliefMPC_v17, beliefMPC_grad_eq18);
beliefMPC_LA_DIAGZERO_MTVM_5_5(beliefMPC_D19, beliefMPC_v18, beliefMPC_grad_eq19);
info->res_ineq = 0;
...
beliefMPC_LA_VSUBADD3_7(params->lb15, beliefMPC_z14, beliefMPC_lbIdx14, beliefMPC_llb14, beliefMPC_slb14, beliefMPC_rilb14, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_7(beliefMPC_z14, beliefMPC_ubIdx14, params->ub15, beliefMPC_lub14, beliefMPC_sub14, beliefMPC_riub14, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD3_7(params->lb16, beliefMPC_z15, beliefMPC_lbIdx15, beliefMPC_llb15, beliefMPC_slb15, beliefMPC_rilb15, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_7(beliefMPC_z15, beliefMPC_ubIdx15, params->ub16, beliefMPC_lub15, beliefMPC_sub15, beliefMPC_riub15, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD3_7(params->lb17, beliefMPC_z16, beliefMPC_lbIdx16, beliefMPC_llb16, beliefMPC_slb16, beliefMPC_rilb16, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_7(beliefMPC_z16, beliefMPC_ubIdx16, params->ub17, beliefMPC_lub16, beliefMPC_sub16, beliefMPC_riub16, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD3_7(params->lb18, beliefMPC_z17, beliefMPC_lbIdx17, beliefMPC_llb17, beliefMPC_slb17, beliefMPC_rilb17, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_7(beliefMPC_z17, beliefMPC_ubIdx17, params->ub18, beliefMPC_lub17, beliefMPC_sub17, beliefMPC_riub17, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD3_7(params->lb19, beliefMPC_z18, beliefMPC_lbIdx18, beliefMPC_llb18, beliefMPC_slb18, beliefMPC_rilb18, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_7(beliefMPC_z18, beliefMPC_ubIdx18, params->ub19, beliefMPC_lub18, beliefMPC_sub18, beliefMPC_riub18, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD3_5(params->lb20, beliefMPC_z19, beliefMPC_lbIdx19, beliefMPC_llb19, beliefMPC_slb19, beliefMPC_rilb19, &info->dgap, &info->res_ineq);
beliefMPC_LA_VSUBADD2_5(beliefMPC_z19, beliefMPC_ubIdx19, params->ub20, beliefMPC_lub19, beliefMPC_sub19, beliefMPC_riub19, &info->dgap, &info->res_ineq);
...
beliefMPC_LA_INEQ_B_GRAD_7_7_7(beliefMPC_lub14, beliefMPC_sub14, beliefMPC_riub14, beliefMPC_llb14, beliefMPC_slb14, beliefMPC_rilb14, beliefMPC_lbIdx14, beliefMPC_ubIdx14, beliefMPC_grad_ineq14, beliefMPC_lubbysub14, beliefMPC_llbbyslb14);
beliefMPC_LA_INEQ_B_GRAD_7_7_7(beliefMPC_lub15, beliefMPC_sub15, beliefMPC_riub15, beliefMPC_llb15, beliefMPC_slb15, beliefMPC_rilb15, beliefMPC_lbIdx15, beliefMPC_ubIdx15, beliefMPC_grad_ineq15, beliefMPC_lubbysub15, beliefMPC_llbbyslb15);
beliefMPC_LA_INEQ_B_GRAD_7_7_7(beliefMPC_lub16, beliefMPC_sub16, beliefMPC_riub16, beliefMPC_llb16, beliefMPC_slb16, beliefMPC_rilb16, beliefMPC_lbIdx16, beliefMPC_ubIdx16, beliefMPC_grad_ineq16, beliefMPC_lubbysub16, beliefMPC_llbbyslb16);
beliefMPC_LA_INEQ_B_GRAD_7_7_7(beliefMPC_lub17, beliefMPC_sub17, beliefMPC_riub17, beliefMPC_llb17, beliefMPC_slb17, beliefMPC_rilb17, beliefMPC_lbIdx17, beliefMPC_ubIdx17, beliefMPC_grad_ineq17, beliefMPC_lubbysub17, beliefMPC_llbbyslb17);
beliefMPC_LA_INEQ_B_GRAD_7_7_7(beliefMPC_lub18, beliefMPC_sub18, beliefMPC_riub18, beliefMPC_llb18, beliefMPC_slb18, beliefMPC_rilb18, beliefMPC_lbIdx18, beliefMPC_ubIdx18, beliefMPC_grad_ineq18, beliefMPC_lubbysub18, beliefMPC_llbbyslb18);
beliefMPC_LA_INEQ_B_GRAD_5_5_5(beliefMPC_lub19, beliefMPC_sub19, beliefMPC_riub19, beliefMPC_llb19, beliefMPC_slb19, beliefMPC_rilb19, beliefMPC_lbIdx19, beliefMPC_ubIdx19, beliefMPC_grad_ineq19, beliefMPC_lubbysub19, beliefMPC_llbbyslb19);
...
beliefMPC_LA_VVADD3_138(beliefMPC_grad_cost, beliefMPC_grad_eq, beliefMPC_grad_ineq, beliefMPC_rd);
...
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_7_7_7(beliefMPC_H00, beliefMPC_llbbyslb14, beliefMPC_lbIdx14, beliefMPC_lubbysub14, beliefMPC_ubIdx14, beliefMPC_Phi14);
beliefMPC_LA_DIAG_MATRIXFORWARDSUB_5_7(beliefMPC_Phi14, params->C15, beliefMPC_V14);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_7(beliefMPC_Phi14, beliefMPC_D02, beliefMPC_W14);
beliefMPC_LA_DENSE_DIAGZERO_MMTM_5_7_5(beliefMPC_W14, beliefMPC_V14, beliefMPC_Ysd14);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi14, beliefMPC_rd14, beliefMPC_Lbyrd14);
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_7_7_7(beliefMPC_H00, beliefMPC_llbbyslb15, beliefMPC_lbIdx15, beliefMPC_lubbysub15, beliefMPC_ubIdx15, beliefMPC_Phi15);
beliefMPC_LA_DIAG_MATRIXFORWARDSUB_5_7(beliefMPC_Phi15, params->C16, beliefMPC_V15);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_7(beliefMPC_Phi15, beliefMPC_D02, beliefMPC_W15);
beliefMPC_LA_DENSE_DIAGZERO_MMTM_5_7_5(beliefMPC_W15, beliefMPC_V15, beliefMPC_Ysd15);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi15, beliefMPC_rd15, beliefMPC_Lbyrd15);
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_7_7_7(beliefMPC_H00, beliefMPC_llbbyslb16, beliefMPC_lbIdx16, beliefMPC_lubbysub16, beliefMPC_ubIdx16, beliefMPC_Phi16);
beliefMPC_LA_DIAG_MATRIXFORWARDSUB_5_7(beliefMPC_Phi16, params->C17, beliefMPC_V16);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_7(beliefMPC_Phi16, beliefMPC_D02, beliefMPC_W16);
beliefMPC_LA_DENSE_DIAGZERO_MMTM_5_7_5(beliefMPC_W16, beliefMPC_V16, beliefMPC_Ysd16);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi16, beliefMPC_rd16, beliefMPC_Lbyrd16);
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_7_7_7(beliefMPC_H00, beliefMPC_llbbyslb17, beliefMPC_lbIdx17, beliefMPC_lubbysub17, beliefMPC_ubIdx17, beliefMPC_Phi17);
beliefMPC_LA_DIAG_MATRIXFORWARDSUB_5_7(beliefMPC_Phi17, params->C18, beliefMPC_V17);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_7(beliefMPC_Phi17, beliefMPC_D02, beliefMPC_W17);
beliefMPC_LA_DENSE_DIAGZERO_MMTM_5_7_5(beliefMPC_W17, beliefMPC_V17, beliefMPC_Ysd17);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi17, beliefMPC_rd17, beliefMPC_Lbyrd17);
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_7_7_7(beliefMPC_H00, beliefMPC_llbbyslb18, beliefMPC_lbIdx18, beliefMPC_lubbysub18, beliefMPC_ubIdx18, beliefMPC_Phi18);
beliefMPC_LA_DIAG_MATRIXFORWARDSUB_5_7(beliefMPC_Phi18, params->C19, beliefMPC_V18);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_7(beliefMPC_Phi18, beliefMPC_D02, beliefMPC_W18);
beliefMPC_LA_DENSE_DIAGZERO_MMTM_5_7_5(beliefMPC_W18, beliefMPC_V18, beliefMPC_Ysd18);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi18, beliefMPC_rd18, beliefMPC_Lbyrd18);
beliefMPC_LA_DIAG_CHOL_ONELOOP_LBUB_5_5_5(beliefMPC_H19, beliefMPC_llbbyslb19, beliefMPC_lbIdx19, beliefMPC_lubbysub19, beliefMPC_ubIdx19, beliefMPC_Phi19);
beliefMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_5(beliefMPC_Phi19, beliefMPC_D19, beliefMPC_W19);
beliefMPC_LA_DIAG_FORWARDSUB_5(beliefMPC_Phi19, beliefMPC_rd19, beliefMPC_Lbyrd19);
...
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_7(beliefMPC_V13, beliefMPC_W14, beliefMPC_Yd13);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_7(beliefMPC_V13, beliefMPC_Lbyrd13, beliefMPC_W14, beliefMPC_Lbyrd14, beliefMPC_re13, beliefMPC_beta13);
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_7(beliefMPC_V14, beliefMPC_W15, beliefMPC_Yd14);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_7(beliefMPC_V14, beliefMPC_Lbyrd14, beliefMPC_W15, beliefMPC_Lbyrd15, beliefMPC_re14, beliefMPC_beta14);
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_7(beliefMPC_V15, beliefMPC_W16, beliefMPC_Yd15);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_7(beliefMPC_V15, beliefMPC_Lbyrd15, beliefMPC_W16, beliefMPC_Lbyrd16, beliefMPC_re15, beliefMPC_beta15);
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_7(beliefMPC_V16, beliefMPC_W17, beliefMPC_Yd16);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_7(beliefMPC_V16, beliefMPC_Lbyrd16, beliefMPC_W17, beliefMPC_Lbyrd17, beliefMPC_re16, beliefMPC_beta16);
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_7(beliefMPC_V17, beliefMPC_W18, beliefMPC_Yd17);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_7(beliefMPC_V17, beliefMPC_Lbyrd17, beliefMPC_W18, beliefMPC_Lbyrd18, beliefMPC_re17, beliefMPC_beta17);
beliefMPC_LA_DENSE_DIAGZERO_MMT2_5_7_5(beliefMPC_V18, beliefMPC_W19, beliefMPC_Yd18);
beliefMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_7_5(beliefMPC_V18, beliefMPC_Lbyrd18, beliefMPC_W19, beliefMPC_Lbyrd19, beliefMPC_re18, beliefMPC_beta18);
...
beliefMPC_LA_DENSE_MATRIXTFORWARDSUB_5_5(beliefMPC_Ld13, beliefMPC_Ysd14, beliefMPC_Lsd14);
beliefMPC_LA_DENSE_MMTSUB_5_5(beliefMPC_Lsd14, beliefMPC_Yd14);
beliefMPC_LA_DENSE_CHOL_5(beliefMPC_Yd14, beliefMPC_Ld14);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd14, beliefMPC_yy13, beliefMPC_beta14, beliefMPC_bmy14);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld14, beliefMPC_bmy14, beliefMPC_yy14);
beliefMPC_LA_DENSE_MATRIXTFORWARDSUB_5_5(beliefMPC_Ld14, beliefMPC_Ysd15, beliefMPC_Lsd15);
beliefMPC_LA_DENSE_MMTSUB_5_5(beliefMPC_Lsd15, beliefMPC_Yd15);
beliefMPC_LA_DENSE_CHOL_5(beliefMPC_Yd15, beliefMPC_Ld15);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd15, beliefMPC_yy14, beliefMPC_beta15, beliefMPC_bmy15);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld15, beliefMPC_bmy15, beliefMPC_yy15);
beliefMPC_LA_DENSE_MATRIXTFORWARDSUB_5_5(beliefMPC_Ld15, beliefMPC_Ysd16, beliefMPC_Lsd16);
beliefMPC_LA_DENSE_MMTSUB_5_5(beliefMPC_Lsd16, beliefMPC_Yd16);
beliefMPC_LA_DENSE_CHOL_5(beliefMPC_Yd16, beliefMPC_Ld16);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd16, beliefMPC_yy15, beliefMPC_beta16, beliefMPC_bmy16);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld16, beliefMPC_bmy16, beliefMPC_yy16);
beliefMPC_LA_DENSE_MATRIXTFORWARDSUB_5_5(beliefMPC_Ld16, beliefMPC_Ysd17, beliefMPC_Lsd17);
beliefMPC_LA_DENSE_MMTSUB_5_5(beliefMPC_Lsd17, beliefMPC_Yd17);
beliefMPC_LA_DENSE_CHOL_5(beliefMPC_Yd17, beliefMPC_Ld17);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd17, beliefMPC_yy16, beliefMPC_beta17, beliefMPC_bmy17);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld17, beliefMPC_bmy17, beliefMPC_yy17);
beliefMPC_LA_DENSE_MATRIXTFORWARDSUB_5_5(beliefMPC_Ld17, beliefMPC_Ysd18, beliefMPC_Lsd18);
beliefMPC_LA_DENSE_MMTSUB_5_5(beliefMPC_Lsd18, beliefMPC_Yd18);
beliefMPC_LA_DENSE_CHOL_5(beliefMPC_Yd18, beliefMPC_Ld18);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd18, beliefMPC_yy17, beliefMPC_beta18, beliefMPC_bmy18);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld18, beliefMPC_bmy18, beliefMPC_yy18);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld18, beliefMPC_yy18, beliefMPC_dvaff18);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd18, beliefMPC_dvaff18, beliefMPC_yy17, beliefMPC_bmy17);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld17, beliefMPC_bmy17, beliefMPC_dvaff17);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd17, beliefMPC_dvaff17, beliefMPC_yy16, beliefMPC_bmy16);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld16, beliefMPC_bmy16, beliefMPC_dvaff16);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd16, beliefMPC_dvaff16, beliefMPC_yy15, beliefMPC_bmy15);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld15, beliefMPC_bmy15, beliefMPC_dvaff15);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd15, beliefMPC_dvaff15, beliefMPC_yy14, beliefMPC_bmy14);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld14, beliefMPC_bmy14, beliefMPC_dvaff14);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd14, beliefMPC_dvaff14, beliefMPC_yy13, beliefMPC_bmy13);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld13, beliefMPC_bmy13, beliefMPC_dvaff13);
...
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C15, beliefMPC_dvaff14, beliefMPC_D02, beliefMPC_dvaff13, beliefMPC_grad_eq14);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C16, beliefMPC_dvaff15, beliefMPC_D02, beliefMPC_dvaff14, beliefMPC_grad_eq15);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C17, beliefMPC_dvaff16, beliefMPC_D02, beliefMPC_dvaff15, beliefMPC_grad_eq16);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C18, beliefMPC_dvaff17, beliefMPC_D02, beliefMPC_dvaff16, beliefMPC_grad_eq17);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C19, beliefMPC_dvaff18, beliefMPC_D02, beliefMPC_dvaff17, beliefMPC_grad_eq18);
beliefMPC_LA_DIAGZERO_MTVM_5_5(beliefMPC_D19, beliefMPC_dvaff18, beliefMPC_grad_eq19);
beliefMPC_LA_VSUB2_138(beliefMPC_rd, beliefMPC_grad_eq, beliefMPC_rd);
...
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi14, beliefMPC_rd14, beliefMPC_dzaff14);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi15, beliefMPC_rd15, beliefMPC_dzaff15);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi16, beliefMPC_rd16, beliefMPC_dzaff16);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi17, beliefMPC_rd17, beliefMPC_dzaff17);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi18, beliefMPC_rd18, beliefMPC_dzaff18);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefMPC_Phi19, beliefMPC_rd19, beliefMPC_dzaff19);
...
beliefMPC_LA_VSUB_INDEXED_7(beliefMPC_dzaff14, beliefMPC_lbIdx14, beliefMPC_rilb14, beliefMPC_dslbaff14);
beliefMPC_LA_VSUB3_7(beliefMPC_llbbyslb14, beliefMPC_dslbaff14, beliefMPC_llb14, beliefMPC_dllbaff14);
beliefMPC_LA_VSUB2_INDEXED_7(beliefMPC_riub14, beliefMPC_dzaff14, beliefMPC_ubIdx14, beliefMPC_dsubaff14);
beliefMPC_LA_VSUB3_7(beliefMPC_lubbysub14, beliefMPC_dsubaff14, beliefMPC_lub14, beliefMPC_dlubaff14);
beliefMPC_LA_VSUB_INDEXED_7(beliefMPC_dzaff15, beliefMPC_lbIdx15, beliefMPC_rilb15, beliefMPC_dslbaff15);
beliefMPC_LA_VSUB3_7(beliefMPC_llbbyslb15, beliefMPC_dslbaff15, beliefMPC_llb15, beliefMPC_dllbaff15);
beliefMPC_LA_VSUB2_INDEXED_7(beliefMPC_riub15, beliefMPC_dzaff15, beliefMPC_ubIdx15, beliefMPC_dsubaff15);
beliefMPC_LA_VSUB3_7(beliefMPC_lubbysub15, beliefMPC_dsubaff15, beliefMPC_lub15, beliefMPC_dlubaff15);
beliefMPC_LA_VSUB_INDEXED_7(beliefMPC_dzaff16, beliefMPC_lbIdx16, beliefMPC_rilb16, beliefMPC_dslbaff16);
beliefMPC_LA_VSUB3_7(beliefMPC_llbbyslb16, beliefMPC_dslbaff16, beliefMPC_llb16, beliefMPC_dllbaff16);
beliefMPC_LA_VSUB2_INDEXED_7(beliefMPC_riub16, beliefMPC_dzaff16, beliefMPC_ubIdx16, beliefMPC_dsubaff16);
beliefMPC_LA_VSUB3_7(beliefMPC_lubbysub16, beliefMPC_dsubaff16, beliefMPC_lub16, beliefMPC_dlubaff16);
beliefMPC_LA_VSUB_INDEXED_7(beliefMPC_dzaff17, beliefMPC_lbIdx17, beliefMPC_rilb17, beliefMPC_dslbaff17);
beliefMPC_LA_VSUB3_7(beliefMPC_llbbyslb17, beliefMPC_dslbaff17, beliefMPC_llb17, beliefMPC_dllbaff17);
beliefMPC_LA_VSUB2_INDEXED_7(beliefMPC_riub17, beliefMPC_dzaff17, beliefMPC_ubIdx17, beliefMPC_dsubaff17);
beliefMPC_LA_VSUB3_7(beliefMPC_lubbysub17, beliefMPC_dsubaff17, beliefMPC_lub17, beliefMPC_dlubaff17);
beliefMPC_LA_VSUB_INDEXED_7(beliefMPC_dzaff18, beliefMPC_lbIdx18, beliefMPC_rilb18, beliefMPC_dslbaff18);
beliefMPC_LA_VSUB3_7(beliefMPC_llbbyslb18, beliefMPC_dslbaff18, beliefMPC_llb18, beliefMPC_dllbaff18);
beliefMPC_LA_VSUB2_INDEXED_7(beliefMPC_riub18, beliefMPC_dzaff18, beliefMPC_ubIdx18, beliefMPC_dsubaff18);
beliefMPC_LA_VSUB3_7(beliefMPC_lubbysub18, beliefMPC_dsubaff18, beliefMPC_lub18, beliefMPC_dlubaff18);
beliefMPC_LA_VSUB_INDEXED_5(beliefMPC_dzaff19, beliefMPC_lbIdx19, beliefMPC_rilb19, beliefMPC_dslbaff19);
beliefMPC_LA_VSUB3_5(beliefMPC_llbbyslb19, beliefMPC_dslbaff19, beliefMPC_llb19, beliefMPC_dllbaff19);
beliefMPC_LA_VSUB2_INDEXED_5(beliefMPC_riub19, beliefMPC_dzaff19, beliefMPC_ubIdx19, beliefMPC_dsubaff19);
beliefMPC_LA_VSUB3_5(beliefMPC_lubbysub19, beliefMPC_dsubaff19, beliefMPC_lub19, beliefMPC_dlubaff19);
...
beliefMPC_LA_VSUB5_276(beliefMPC_ds_aff, beliefMPC_dl_aff, musigma, beliefMPC_ccrhs);
...
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd12, beliefMPC_yy11, beliefMPC_beta12, beliefMPC_bmy12);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld12, beliefMPC_bmy12, beliefMPC_yy12);
beliefMPC_LA_VSUB6_INDEXED_7_7_7(beliefMPC_ccrhsub14, beliefMPC_sub14, beliefMPC_ubIdx14, beliefMPC_ccrhsl14, beliefMPC_slb14, beliefMPC_lbIdx14, beliefMPC_rd14);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi14, beliefMPC_rd14, beliefMPC_Lbyrd14);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_7(beliefMPC_V13, beliefMPC_Lbyrd13, beliefMPC_W14, beliefMPC_Lbyrd14, beliefMPC_beta13);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd13, beliefMPC_yy12, beliefMPC_beta13, beliefMPC_bmy13);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld13, beliefMPC_bmy13, beliefMPC_yy13);
beliefMPC_LA_VSUB6_INDEXED_7_7_7(beliefMPC_ccrhsub15, beliefMPC_sub15, beliefMPC_ubIdx15, beliefMPC_ccrhsl15, beliefMPC_slb15, beliefMPC_lbIdx15, beliefMPC_rd15);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi15, beliefMPC_rd15, beliefMPC_Lbyrd15);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_7(beliefMPC_V14, beliefMPC_Lbyrd14, beliefMPC_W15, beliefMPC_Lbyrd15, beliefMPC_beta14);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd14, beliefMPC_yy13, beliefMPC_beta14, beliefMPC_bmy14);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld14, beliefMPC_bmy14, beliefMPC_yy14);
beliefMPC_LA_VSUB6_INDEXED_7_7_7(beliefMPC_ccrhsub16, beliefMPC_sub16, beliefMPC_ubIdx16, beliefMPC_ccrhsl16, beliefMPC_slb16, beliefMPC_lbIdx16, beliefMPC_rd16);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi16, beliefMPC_rd16, beliefMPC_Lbyrd16);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_7(beliefMPC_V15, beliefMPC_Lbyrd15, beliefMPC_W16, beliefMPC_Lbyrd16, beliefMPC_beta15);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd15, beliefMPC_yy14, beliefMPC_beta15, beliefMPC_bmy15);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld15, beliefMPC_bmy15, beliefMPC_yy15);
beliefMPC_LA_VSUB6_INDEXED_7_7_7(beliefMPC_ccrhsub17, beliefMPC_sub17, beliefMPC_ubIdx17, beliefMPC_ccrhsl17, beliefMPC_slb17, beliefMPC_lbIdx17, beliefMPC_rd17);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi17, beliefMPC_rd17, beliefMPC_Lbyrd17);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_7(beliefMPC_V16, beliefMPC_Lbyrd16, beliefMPC_W17, beliefMPC_Lbyrd17, beliefMPC_beta16);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd16, beliefMPC_yy15, beliefMPC_beta16, beliefMPC_bmy16);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld16, beliefMPC_bmy16, beliefMPC_yy16);
beliefMPC_LA_VSUB6_INDEXED_7_7_7(beliefMPC_ccrhsub18, beliefMPC_sub18, beliefMPC_ubIdx18, beliefMPC_ccrhsl18, beliefMPC_slb18, beliefMPC_lbIdx18, beliefMPC_rd18);
beliefMPC_LA_DIAG_FORWARDSUB_7(beliefMPC_Phi18, beliefMPC_rd18, beliefMPC_Lbyrd18);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_7(beliefMPC_V17, beliefMPC_Lbyrd17, beliefMPC_W18, beliefMPC_Lbyrd18, beliefMPC_beta17);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd17, beliefMPC_yy16, beliefMPC_beta17, beliefMPC_bmy17);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld17, beliefMPC_bmy17, beliefMPC_yy17);
beliefMPC_LA_VSUB6_INDEXED_5_5_5(beliefMPC_ccrhsub19, beliefMPC_sub19, beliefMPC_ubIdx19, beliefMPC_ccrhsl19, beliefMPC_slb19, beliefMPC_lbIdx19, beliefMPC_rd19);
beliefMPC_LA_DIAG_FORWARDSUB_5(beliefMPC_Phi19, beliefMPC_rd19, beliefMPC_Lbyrd19);
beliefMPC_LA_DENSE_DIAGZERO_2MVMADD_5_7_5(beliefMPC_V18, beliefMPC_Lbyrd18, beliefMPC_W19, beliefMPC_Lbyrd19, beliefMPC_beta18);
beliefMPC_LA_DENSE_MVMSUB1_5_5(beliefMPC_Lsd18, beliefMPC_yy17, beliefMPC_beta18, beliefMPC_bmy18);
beliefMPC_LA_DENSE_FORWARDSUB_5(beliefMPC_Ld18, beliefMPC_bmy18, beliefMPC_yy18);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld18, beliefMPC_yy18, beliefMPC_dvcc18);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd18, beliefMPC_dvcc18, beliefMPC_yy17, beliefMPC_bmy17);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld17, beliefMPC_bmy17, beliefMPC_dvcc17);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd17, beliefMPC_dvcc17, beliefMPC_yy16, beliefMPC_bmy16);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld16, beliefMPC_bmy16, beliefMPC_dvcc16);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd16, beliefMPC_dvcc16, beliefMPC_yy15, beliefMPC_bmy15);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld15, beliefMPC_bmy15, beliefMPC_dvcc15);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd15, beliefMPC_dvcc15, beliefMPC_yy14, beliefMPC_bmy14);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld14, beliefMPC_bmy14, beliefMPC_dvcc14);
beliefMPC_LA_DENSE_MTVMSUB_5_5(beliefMPC_Lsd14, beliefMPC_dvcc14, beliefMPC_yy13, beliefMPC_bmy13);
beliefMPC_LA_DENSE_BACKWARDSUB_5(beliefMPC_Ld13, beliefMPC_bmy13, beliefMPC_dvcc13);
...
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C15, beliefMPC_dvcc14, beliefMPC_D02, beliefMPC_dvcc13, beliefMPC_grad_eq14);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C16, beliefMPC_dvcc15, beliefMPC_D02, beliefMPC_dvcc14, beliefMPC_grad_eq15);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C17, beliefMPC_dvcc16, beliefMPC_D02, beliefMPC_dvcc15, beliefMPC_grad_eq16);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C18, beliefMPC_dvcc17, beliefMPC_D02, beliefMPC_dvcc16, beliefMPC_grad_eq17);
beliefMPC_LA_DENSE_DIAGZERO_MTVM2_5_7_5(params->C19, beliefMPC_dvcc18, beliefMPC_D02, beliefMPC_dvcc17, beliefMPC_grad_eq18);
beliefMPC_LA_DIAGZERO_MTVM_5_5(beliefMPC_D19, beliefMPC_dvcc18, beliefMPC_grad_eq19);
beliefMPC_LA_VSUB_138(beliefMPC_rd, beliefMPC_grad_eq, beliefMPC_rd);
...
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi14, beliefMPC_rd14, beliefMPC_dzcc14);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi15, beliefMPC_rd15, beliefMPC_dzcc15);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi16, beliefMPC_rd16, beliefMPC_dzcc16);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi17, beliefMPC_rd17, beliefMPC_dzcc17);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_7(beliefMPC_Phi18, beliefMPC_rd18, beliefMPC_dzcc18);
beliefMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefMPC_Phi19, beliefMPC_rd19, beliefMPC_dzcc19);
...
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_7(beliefMPC_ccrhsl14, beliefMPC_slb14, beliefMPC_llbbyslb14, beliefMPC_dzcc14, beliefMPC_lbIdx14, beliefMPC_dllbcc14);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_7(beliefMPC_ccrhsub14, beliefMPC_sub14, beliefMPC_lubbysub14, beliefMPC_dzcc14, beliefMPC_ubIdx14, beliefMPC_dlubcc14);
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_7(beliefMPC_ccrhsl15, beliefMPC_slb15, beliefMPC_llbbyslb15, beliefMPC_dzcc15, beliefMPC_lbIdx15, beliefMPC_dllbcc15);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_7(beliefMPC_ccrhsub15, beliefMPC_sub15, beliefMPC_lubbysub15, beliefMPC_dzcc15, beliefMPC_ubIdx15, beliefMPC_dlubcc15);
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_7(beliefMPC_ccrhsl16, beliefMPC_slb16, beliefMPC_llbbyslb16, beliefMPC_dzcc16, beliefMPC_lbIdx16, beliefMPC_dllbcc16);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_7(beliefMPC_ccrhsub16, beliefMPC_sub16, beliefMPC_lubbysub16, beliefMPC_dzcc16, beliefMPC_ubIdx16, beliefMPC_dlubcc16);
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_7(beliefMPC_ccrhsl17, beliefMPC_slb17, beliefMPC_llbbyslb17, beliefMPC_dzcc17, beliefMPC_lbIdx17, beliefMPC_dllbcc17);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_7(beliefMPC_ccrhsub17, beliefMPC_sub17, beliefMPC_lubbysub17, beliefMPC_dzcc17, beliefMPC_ubIdx17, beliefMPC_dlubcc17);
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_7(beliefMPC_ccrhsl18, beliefMPC_slb18, beliefMPC_llbbyslb18, beliefMPC_dzcc18, beliefMPC_lbIdx18, beliefMPC_dllbcc18);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_7(beliefMPC_ccrhsub18, beliefMPC_sub18, beliefMPC_lubbysub18, beliefMPC_dzcc18, beliefMPC_ubIdx18, beliefMPC_dlubcc18);
beliefMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_5(beliefMPC_ccrhsl19, beliefMPC_slb19, beliefMPC_llbbyslb19, beliefMPC_dzcc19, beliefMPC_lbIdx19, beliefMPC_dllbcc19);
beliefMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_5(beliefMPC_ccrhsub19, beliefMPC_sub19, beliefMPC_lubbysub19, beliefMPC_dzcc19, beliefMPC_ubIdx19, beliefMPC_dlubcc19);
beliefMPC_LA_VSUB7_276(beliefMPC_l, beliefMPC_ccrhs, beliefMPC_s, beliefMPC_dl_cc, beliefMPC_ds_cc);
beliefMPC_LA_VADD_138(beliefMPC_dz_cc, beliefMPC_dz_aff);
beliefMPC_LA_VADD_100(beliefMPC_dv_cc, beliefMPC_dv_aff);
beliefMPC_LA_VADD_276(beliefMPC_dl_cc, beliefMPC_dl_aff);
beliefMPC_LA_VADD_276(beliefMPC_ds_cc, beliefMPC_ds_aff);
...
output->z15[5] = beliefMPC_z14[5];
output->z15[6] = beliefMPC_z14[6];
output->z16[0] = beliefMPC_z15[0];
output->z16[1] = beliefMPC_z15[1];
output->z16[2] = beliefMPC_z15[2];
output->z16[3] = beliefMPC_z15[3];
output->z16[4] = beliefMPC_z15[4];
output->z16[5] = beliefMPC_z15[5];
output->z16[6] = beliefMPC_z15[6];
output->z17[0] = beliefMPC_z16[0];
output->z17[1] = beliefMPC_z16[1];
output->z17[2] = beliefMPC_z16[2];
output->z17[3] = beliefMPC_z16[3];
output->z17[4] = beliefMPC_z16[4];
output->z17[5] = beliefMPC_z16[5];
output->z17[6] = beliefMPC_z16[6];
output->z18[0] = beliefMPC_z17[0];
output->z18[1] = beliefMPC_z17[1];
output->z18[2] = beliefMPC_z17[2];
output->z18[3] = beliefMPC_z17[3];
output->z18[4] = beliefMPC_z17[4];
output->z18[5] = beliefMPC_z17[5];
output->z18[6] = beliefMPC_z17[6];
output->z19[0] = beliefMPC_z18[0];
output->z19[1] = beliefMPC_z18[1];
output->z19[2] = beliefMPC_z18[2];
output->z19[3] = beliefMPC_z18[3];
output->z19[4] = beliefMPC_z18[4];
output->z19[5] = beliefMPC_z18[5];
output->z19[6] = beliefMPC_z18[6];
output->z20[0] = beliefMPC_z19[0];
output->z20[1] = beliefMPC_z19[1];
output->z20[2] = beliefMPC_z19[2];
output->z20[3] = beliefMPC_z19[3];
output->z20[4] = beliefMPC_z19[4];
