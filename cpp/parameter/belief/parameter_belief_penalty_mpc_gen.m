function parameter_belief_penalty_mpc_gen(timesteps)
...
% TODO: do we want to weight these differently? (i.e. favor params)
% Applied to sqrtSigma, so effectively cost = Q*SS*SS*Q
%Q = hess_structure(alpha_belief, nj, np);
%Qfinal = hess_structure(alpha_final_belief, nj, np);
