...
/*
 * Initializes a vector of length 78 with a value.
 */
void controlMPC_LA_INITIALIZEVECTOR_78(controlMPC_FLOAT* vec, controlMPC_FLOAT value)
{
	int i;
	for( i=0; i<78; i++ )
	{
 ...
 */
void controlMPC_LA_INITIALIZEVECTOR_76(controlMPC_FLOAT* vec, controlMPC_FLOAT value)
{
	int i;
	for( i=0; i<76; i++ )
	{
 ...
 */
void controlMPC_LA_INITIALIZEVECTOR_156(controlMPC_FLOAT* vec, controlMPC_FLOAT value)
{
	int i;
	for( i=0; i<156; i++ )
	{
 ...
 */
void controlMPC_LA_DOTACC_156(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<156; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 78.
 */
void controlMPC_LA_VVADD3_78(controlMPC_FLOAT *u, controlMPC_FLOAT *v, controlMPC_FLOAT *w, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++ ){
		z[i] = u[i] + v[i] + w[i];
...
/*
 * Vector subtraction z = -x - y for vectors of length 78.
 */
void controlMPC_LA_VSUB2_78(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++){
		z[i] = -x[i] - y[i];
...
int controlMPC_LINESEARCH_BACKTRACKING_AFFINE(controlMPC_FLOAT *l, controlMPC_FLOAT *s, controlMPC_FLOAT *dl, controlMPC_FLOAT *ds, controlMPC_FLOAT *a, controlMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (controlMPC_FLOAT)156;
    return lsIt;
}
 ...
 */
void controlMPC_LA_VSUB5_156(controlMPC_FLOAT *u, controlMPC_FLOAT *v, controlMPC_FLOAT a, controlMPC_FLOAT *x)
{
	int i;
	for( i=0; i<156; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 78.
 */
void controlMPC_LA_VSUB_78(controlMPC_FLOAT *x, controlMPC_FLOAT *y, controlMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++){
		z[i] = x[i] - y[i];
 ...
 */
void controlMPC_LA_VSUB7_156(controlMPC_FLOAT *l, controlMPC_FLOAT *r, controlMPC_FLOAT *s, controlMPC_FLOAT *dl, controlMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<156; i++){
...
/*
 * Vector addition x = x + y for vectors of length 78.
 */
void controlMPC_LA_VADD_78(controlMPC_FLOAT *x, controlMPC_FLOAT *y)
{
	int i;
	for( i=0; i<78; i++){
		x[i] += y[i];
 ...
 */
void controlMPC_LA_VADD_76(controlMPC_FLOAT *x, controlMPC_FLOAT *y)
{
	int i;
	for( i=0; i<76; i++){
		x[i] += y[i];
 ...
 */
void controlMPC_LA_VADD_156(controlMPC_FLOAT *x, controlMPC_FLOAT *y)
{
	int i;
	for( i=0; i<156; i++){
		x[i] += y[i];
...
controlMPC_FLOAT controlMPC_z[78];
controlMPC_FLOAT controlMPC_v[76];
controlMPC_FLOAT controlMPC_dz_aff[78];
controlMPC_FLOAT controlMPC_dv_aff[76];
controlMPC_FLOAT controlMPC_grad_cost[78];
controlMPC_FLOAT controlMPC_grad_eq[78];
controlMPC_FLOAT controlMPC_rd[78];
controlMPC_FLOAT controlMPC_l[156];
controlMPC_FLOAT controlMPC_s[156];
controlMPC_FLOAT controlMPC_lbys[156];
controlMPC_FLOAT controlMPC_dl_aff[156];
controlMPC_FLOAT controlMPC_ds_aff[156];
controlMPC_FLOAT controlMPC_dz_cc[78];
controlMPC_FLOAT controlMPC_dv_cc[76];
controlMPC_FLOAT controlMPC_dl_cc[156];
controlMPC_FLOAT controlMPC_ds_cc[156];
controlMPC_FLOAT controlMPC_ccrhs[156];
controlMPC_FLOAT controlMPC_grad_ineq[78];
...
controlMPC_FLOAT* controlMPC_v28 = controlMPC_v + 56;
controlMPC_FLOAT controlMPC_re28[2];
controlMPC_FLOAT controlMPC_beta28[2];
controlMPC_FLOAT controlMPC_betacc28[2];
controlMPC_FLOAT* controlMPC_dvaff28 = controlMPC_dv_aff + 56;
controlMPC_FLOAT* controlMPC_dvcc28 = controlMPC_dv_cc + 56;
controlMPC_FLOAT controlMPC_V28[4];
controlMPC_FLOAT controlMPC_Yd28[3];
controlMPC_FLOAT controlMPC_Ld28[3];
controlMPC_FLOAT controlMPC_yy28[2];
controlMPC_FLOAT controlMPC_bmy28[2];
controlMPC_FLOAT controlMPC_c28[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
...
controlMPC_FLOAT controlMPC_Ysd28[4];
controlMPC_FLOAT controlMPC_Lsd28[4];
controlMPC_FLOAT* controlMPC_z29 = controlMPC_z + 58;
controlMPC_FLOAT* controlMPC_dzaff29 = controlMPC_dz_aff + 58;
controlMPC_FLOAT* controlMPC_dzcc29 = controlMPC_dz_cc + 58;
controlMPC_FLOAT* controlMPC_rd29 = controlMPC_rd + 58;
controlMPC_FLOAT controlMPC_Lbyrd29[2];
controlMPC_FLOAT* controlMPC_grad_cost29 = controlMPC_grad_cost + 58;
controlMPC_FLOAT* controlMPC_grad_eq29 = controlMPC_grad_eq + 58;
controlMPC_FLOAT* controlMPC_grad_ineq29 = controlMPC_grad_ineq + 58;
controlMPC_FLOAT controlMPC_ctv29[2];
controlMPC_FLOAT* controlMPC_v29 = controlMPC_v + 58;
controlMPC_FLOAT controlMPC_re29[2];
controlMPC_FLOAT controlMPC_beta29[2];
controlMPC_FLOAT controlMPC_betacc29[2];
controlMPC_FLOAT* controlMPC_dvaff29 = controlMPC_dv_aff + 58;
controlMPC_FLOAT* controlMPC_dvcc29 = controlMPC_dv_cc + 58;
controlMPC_FLOAT controlMPC_V29[4];
controlMPC_FLOAT controlMPC_Yd29[3];
controlMPC_FLOAT controlMPC_Ld29[3];
controlMPC_FLOAT controlMPC_yy29[2];
controlMPC_FLOAT controlMPC_bmy29[2];
controlMPC_FLOAT controlMPC_c29[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx29[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb29 = controlMPC_l + 116;
controlMPC_FLOAT* controlMPC_slb29 = controlMPC_s + 116;
controlMPC_FLOAT* controlMPC_llbbyslb29 = controlMPC_lbys + 116;
controlMPC_FLOAT controlMPC_rilb29[2];
controlMPC_FLOAT* controlMPC_dllbaff29 = controlMPC_dl_aff + 116;
controlMPC_FLOAT* controlMPC_dslbaff29 = controlMPC_ds_aff + 116;
controlMPC_FLOAT* controlMPC_dllbcc29 = controlMPC_dl_cc + 116;
controlMPC_FLOAT* controlMPC_dslbcc29 = controlMPC_ds_cc + 116;
controlMPC_FLOAT* controlMPC_ccrhsl29 = controlMPC_ccrhs + 116;
int controlMPC_ubIdx29[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub29 = controlMPC_l + 118;
controlMPC_FLOAT* controlMPC_sub29 = controlMPC_s + 118;
controlMPC_FLOAT* controlMPC_lubbysub29 = controlMPC_lbys + 118;
controlMPC_FLOAT controlMPC_riub29[2];
controlMPC_FLOAT* controlMPC_dlubaff29 = controlMPC_dl_aff + 118;
controlMPC_FLOAT* controlMPC_dsubaff29 = controlMPC_ds_aff + 118;
controlMPC_FLOAT* controlMPC_dlubcc29 = controlMPC_dl_cc + 118;
controlMPC_FLOAT* controlMPC_dsubcc29 = controlMPC_ds_cc + 118;
controlMPC_FLOAT* controlMPC_ccrhsub29 = controlMPC_ccrhs + 118;
controlMPC_FLOAT controlMPC_Phi29[2];
controlMPC_FLOAT controlMPC_W29[2];
controlMPC_FLOAT controlMPC_Ysd29[4];
controlMPC_FLOAT controlMPC_Lsd29[4];
controlMPC_FLOAT* controlMPC_z30 = controlMPC_z + 60;
controlMPC_FLOAT* controlMPC_dzaff30 = controlMPC_dz_aff + 60;
controlMPC_FLOAT* controlMPC_dzcc30 = controlMPC_dz_cc + 60;
controlMPC_FLOAT* controlMPC_rd30 = controlMPC_rd + 60;
controlMPC_FLOAT controlMPC_Lbyrd30[2];
controlMPC_FLOAT* controlMPC_grad_cost30 = controlMPC_grad_cost + 60;
controlMPC_FLOAT* controlMPC_grad_eq30 = controlMPC_grad_eq + 60;
controlMPC_FLOAT* controlMPC_grad_ineq30 = controlMPC_grad_ineq + 60;
controlMPC_FLOAT controlMPC_ctv30[2];
controlMPC_FLOAT* controlMPC_v30 = controlMPC_v + 60;
controlMPC_FLOAT controlMPC_re30[2];
controlMPC_FLOAT controlMPC_beta30[2];
controlMPC_FLOAT controlMPC_betacc30[2];
controlMPC_FLOAT* controlMPC_dvaff30 = controlMPC_dv_aff + 60;
controlMPC_FLOAT* controlMPC_dvcc30 = controlMPC_dv_cc + 60;
controlMPC_FLOAT controlMPC_V30[4];
controlMPC_FLOAT controlMPC_Yd30[3];
controlMPC_FLOAT controlMPC_Ld30[3];
controlMPC_FLOAT controlMPC_yy30[2];
controlMPC_FLOAT controlMPC_bmy30[2];
controlMPC_FLOAT controlMPC_c30[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx30[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb30 = controlMPC_l + 120;
controlMPC_FLOAT* controlMPC_slb30 = controlMPC_s + 120;
controlMPC_FLOAT* controlMPC_llbbyslb30 = controlMPC_lbys + 120;
controlMPC_FLOAT controlMPC_rilb30[2];
controlMPC_FLOAT* controlMPC_dllbaff30 = controlMPC_dl_aff + 120;
controlMPC_FLOAT* controlMPC_dslbaff30 = controlMPC_ds_aff + 120;
controlMPC_FLOAT* controlMPC_dllbcc30 = controlMPC_dl_cc + 120;
controlMPC_FLOAT* controlMPC_dslbcc30 = controlMPC_ds_cc + 120;
controlMPC_FLOAT* controlMPC_ccrhsl30 = controlMPC_ccrhs + 120;
int controlMPC_ubIdx30[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub30 = controlMPC_l + 122;
controlMPC_FLOAT* controlMPC_sub30 = controlMPC_s + 122;
controlMPC_FLOAT* controlMPC_lubbysub30 = controlMPC_lbys + 122;
controlMPC_FLOAT controlMPC_riub30[2];
controlMPC_FLOAT* controlMPC_dlubaff30 = controlMPC_dl_aff + 122;
controlMPC_FLOAT* controlMPC_dsubaff30 = controlMPC_ds_aff + 122;
controlMPC_FLOAT* controlMPC_dlubcc30 = controlMPC_dl_cc + 122;
controlMPC_FLOAT* controlMPC_dsubcc30 = controlMPC_ds_cc + 122;
controlMPC_FLOAT* controlMPC_ccrhsub30 = controlMPC_ccrhs + 122;
controlMPC_FLOAT controlMPC_Phi30[2];
controlMPC_FLOAT controlMPC_W30[2];
controlMPC_FLOAT controlMPC_Ysd30[4];
controlMPC_FLOAT controlMPC_Lsd30[4];
controlMPC_FLOAT* controlMPC_z31 = controlMPC_z + 62;
controlMPC_FLOAT* controlMPC_dzaff31 = controlMPC_dz_aff + 62;
controlMPC_FLOAT* controlMPC_dzcc31 = controlMPC_dz_cc + 62;
controlMPC_FLOAT* controlMPC_rd31 = controlMPC_rd + 62;
controlMPC_FLOAT controlMPC_Lbyrd31[2];
controlMPC_FLOAT* controlMPC_grad_cost31 = controlMPC_grad_cost + 62;
controlMPC_FLOAT* controlMPC_grad_eq31 = controlMPC_grad_eq + 62;
controlMPC_FLOAT* controlMPC_grad_ineq31 = controlMPC_grad_ineq + 62;
controlMPC_FLOAT controlMPC_ctv31[2];
controlMPC_FLOAT* controlMPC_v31 = controlMPC_v + 62;
controlMPC_FLOAT controlMPC_re31[2];
controlMPC_FLOAT controlMPC_beta31[2];
controlMPC_FLOAT controlMPC_betacc31[2];
controlMPC_FLOAT* controlMPC_dvaff31 = controlMPC_dv_aff + 62;
controlMPC_FLOAT* controlMPC_dvcc31 = controlMPC_dv_cc + 62;
controlMPC_FLOAT controlMPC_V31[4];
controlMPC_FLOAT controlMPC_Yd31[3];
controlMPC_FLOAT controlMPC_Ld31[3];
controlMPC_FLOAT controlMPC_yy31[2];
controlMPC_FLOAT controlMPC_bmy31[2];
controlMPC_FLOAT controlMPC_c31[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx31[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb31 = controlMPC_l + 124;
controlMPC_FLOAT* controlMPC_slb31 = controlMPC_s + 124;
controlMPC_FLOAT* controlMPC_llbbyslb31 = controlMPC_lbys + 124;
controlMPC_FLOAT controlMPC_rilb31[2];
controlMPC_FLOAT* controlMPC_dllbaff31 = controlMPC_dl_aff + 124;
controlMPC_FLOAT* controlMPC_dslbaff31 = controlMPC_ds_aff + 124;
controlMPC_FLOAT* controlMPC_dllbcc31 = controlMPC_dl_cc + 124;
controlMPC_FLOAT* controlMPC_dslbcc31 = controlMPC_ds_cc + 124;
controlMPC_FLOAT* controlMPC_ccrhsl31 = controlMPC_ccrhs + 124;
int controlMPC_ubIdx31[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub31 = controlMPC_l + 126;
controlMPC_FLOAT* controlMPC_sub31 = controlMPC_s + 126;
controlMPC_FLOAT* controlMPC_lubbysub31 = controlMPC_lbys + 126;
controlMPC_FLOAT controlMPC_riub31[2];
controlMPC_FLOAT* controlMPC_dlubaff31 = controlMPC_dl_aff + 126;
controlMPC_FLOAT* controlMPC_dsubaff31 = controlMPC_ds_aff + 126;
controlMPC_FLOAT* controlMPC_dlubcc31 = controlMPC_dl_cc + 126;
controlMPC_FLOAT* controlMPC_dsubcc31 = controlMPC_ds_cc + 126;
controlMPC_FLOAT* controlMPC_ccrhsub31 = controlMPC_ccrhs + 126;
controlMPC_FLOAT controlMPC_Phi31[2];
controlMPC_FLOAT controlMPC_W31[2];
controlMPC_FLOAT controlMPC_Ysd31[4];
controlMPC_FLOAT controlMPC_Lsd31[4];
controlMPC_FLOAT* controlMPC_z32 = controlMPC_z + 64;
controlMPC_FLOAT* controlMPC_dzaff32 = controlMPC_dz_aff + 64;
controlMPC_FLOAT* controlMPC_dzcc32 = controlMPC_dz_cc + 64;
controlMPC_FLOAT* controlMPC_rd32 = controlMPC_rd + 64;
controlMPC_FLOAT controlMPC_Lbyrd32[2];
controlMPC_FLOAT* controlMPC_grad_cost32 = controlMPC_grad_cost + 64;
controlMPC_FLOAT* controlMPC_grad_eq32 = controlMPC_grad_eq + 64;
controlMPC_FLOAT* controlMPC_grad_ineq32 = controlMPC_grad_ineq + 64;
controlMPC_FLOAT controlMPC_ctv32[2];
controlMPC_FLOAT* controlMPC_v32 = controlMPC_v + 64;
controlMPC_FLOAT controlMPC_re32[2];
controlMPC_FLOAT controlMPC_beta32[2];
controlMPC_FLOAT controlMPC_betacc32[2];
controlMPC_FLOAT* controlMPC_dvaff32 = controlMPC_dv_aff + 64;
controlMPC_FLOAT* controlMPC_dvcc32 = controlMPC_dv_cc + 64;
controlMPC_FLOAT controlMPC_V32[4];
controlMPC_FLOAT controlMPC_Yd32[3];
controlMPC_FLOAT controlMPC_Ld32[3];
controlMPC_FLOAT controlMPC_yy32[2];
controlMPC_FLOAT controlMPC_bmy32[2];
controlMPC_FLOAT controlMPC_c32[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx32[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb32 = controlMPC_l + 128;
controlMPC_FLOAT* controlMPC_slb32 = controlMPC_s + 128;
controlMPC_FLOAT* controlMPC_llbbyslb32 = controlMPC_lbys + 128;
controlMPC_FLOAT controlMPC_rilb32[2];
controlMPC_FLOAT* controlMPC_dllbaff32 = controlMPC_dl_aff + 128;
controlMPC_FLOAT* controlMPC_dslbaff32 = controlMPC_ds_aff + 128;
controlMPC_FLOAT* controlMPC_dllbcc32 = controlMPC_dl_cc + 128;
controlMPC_FLOAT* controlMPC_dslbcc32 = controlMPC_ds_cc + 128;
controlMPC_FLOAT* controlMPC_ccrhsl32 = controlMPC_ccrhs + 128;
int controlMPC_ubIdx32[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub32 = controlMPC_l + 130;
controlMPC_FLOAT* controlMPC_sub32 = controlMPC_s + 130;
controlMPC_FLOAT* controlMPC_lubbysub32 = controlMPC_lbys + 130;
controlMPC_FLOAT controlMPC_riub32[2];
controlMPC_FLOAT* controlMPC_dlubaff32 = controlMPC_dl_aff + 130;
controlMPC_FLOAT* controlMPC_dsubaff32 = controlMPC_ds_aff + 130;
controlMPC_FLOAT* controlMPC_dlubcc32 = controlMPC_dl_cc + 130;
controlMPC_FLOAT* controlMPC_dsubcc32 = controlMPC_ds_cc + 130;
controlMPC_FLOAT* controlMPC_ccrhsub32 = controlMPC_ccrhs + 130;
controlMPC_FLOAT controlMPC_Phi32[2];
controlMPC_FLOAT controlMPC_W32[2];
controlMPC_FLOAT controlMPC_Ysd32[4];
controlMPC_FLOAT controlMPC_Lsd32[4];
controlMPC_FLOAT* controlMPC_z33 = controlMPC_z + 66;
controlMPC_FLOAT* controlMPC_dzaff33 = controlMPC_dz_aff + 66;
controlMPC_FLOAT* controlMPC_dzcc33 = controlMPC_dz_cc + 66;
controlMPC_FLOAT* controlMPC_rd33 = controlMPC_rd + 66;
controlMPC_FLOAT controlMPC_Lbyrd33[2];
controlMPC_FLOAT* controlMPC_grad_cost33 = controlMPC_grad_cost + 66;
controlMPC_FLOAT* controlMPC_grad_eq33 = controlMPC_grad_eq + 66;
controlMPC_FLOAT* controlMPC_grad_ineq33 = controlMPC_grad_ineq + 66;
controlMPC_FLOAT controlMPC_ctv33[2];
controlMPC_FLOAT* controlMPC_v33 = controlMPC_v + 66;
controlMPC_FLOAT controlMPC_re33[2];
controlMPC_FLOAT controlMPC_beta33[2];
controlMPC_FLOAT controlMPC_betacc33[2];
controlMPC_FLOAT* controlMPC_dvaff33 = controlMPC_dv_aff + 66;
controlMPC_FLOAT* controlMPC_dvcc33 = controlMPC_dv_cc + 66;
controlMPC_FLOAT controlMPC_V33[4];
controlMPC_FLOAT controlMPC_Yd33[3];
controlMPC_FLOAT controlMPC_Ld33[3];
controlMPC_FLOAT controlMPC_yy33[2];
controlMPC_FLOAT controlMPC_bmy33[2];
controlMPC_FLOAT controlMPC_c33[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx33[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb33 = controlMPC_l + 132;
controlMPC_FLOAT* controlMPC_slb33 = controlMPC_s + 132;
controlMPC_FLOAT* controlMPC_llbbyslb33 = controlMPC_lbys + 132;
controlMPC_FLOAT controlMPC_rilb33[2];
controlMPC_FLOAT* controlMPC_dllbaff33 = controlMPC_dl_aff + 132;
controlMPC_FLOAT* controlMPC_dslbaff33 = controlMPC_ds_aff + 132;
controlMPC_FLOAT* controlMPC_dllbcc33 = controlMPC_dl_cc + 132;
controlMPC_FLOAT* controlMPC_dslbcc33 = controlMPC_ds_cc + 132;
controlMPC_FLOAT* controlMPC_ccrhsl33 = controlMPC_ccrhs + 132;
int controlMPC_ubIdx33[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub33 = controlMPC_l + 134;
controlMPC_FLOAT* controlMPC_sub33 = controlMPC_s + 134;
controlMPC_FLOAT* controlMPC_lubbysub33 = controlMPC_lbys + 134;
controlMPC_FLOAT controlMPC_riub33[2];
controlMPC_FLOAT* controlMPC_dlubaff33 = controlMPC_dl_aff + 134;
controlMPC_FLOAT* controlMPC_dsubaff33 = controlMPC_ds_aff + 134;
controlMPC_FLOAT* controlMPC_dlubcc33 = controlMPC_dl_cc + 134;
controlMPC_FLOAT* controlMPC_dsubcc33 = controlMPC_ds_cc + 134;
controlMPC_FLOAT* controlMPC_ccrhsub33 = controlMPC_ccrhs + 134;
controlMPC_FLOAT controlMPC_Phi33[2];
controlMPC_FLOAT controlMPC_W33[2];
controlMPC_FLOAT controlMPC_Ysd33[4];
controlMPC_FLOAT controlMPC_Lsd33[4];
controlMPC_FLOAT* controlMPC_z34 = controlMPC_z + 68;
controlMPC_FLOAT* controlMPC_dzaff34 = controlMPC_dz_aff + 68;
controlMPC_FLOAT* controlMPC_dzcc34 = controlMPC_dz_cc + 68;
controlMPC_FLOAT* controlMPC_rd34 = controlMPC_rd + 68;
controlMPC_FLOAT controlMPC_Lbyrd34[2];
controlMPC_FLOAT* controlMPC_grad_cost34 = controlMPC_grad_cost + 68;
controlMPC_FLOAT* controlMPC_grad_eq34 = controlMPC_grad_eq + 68;
controlMPC_FLOAT* controlMPC_grad_ineq34 = controlMPC_grad_ineq + 68;
controlMPC_FLOAT controlMPC_ctv34[2];
controlMPC_FLOAT* controlMPC_v34 = controlMPC_v + 68;
controlMPC_FLOAT controlMPC_re34[2];
controlMPC_FLOAT controlMPC_beta34[2];
controlMPC_FLOAT controlMPC_betacc34[2];
controlMPC_FLOAT* controlMPC_dvaff34 = controlMPC_dv_aff + 68;
controlMPC_FLOAT* controlMPC_dvcc34 = controlMPC_dv_cc + 68;
controlMPC_FLOAT controlMPC_V34[4];
controlMPC_FLOAT controlMPC_Yd34[3];
controlMPC_FLOAT controlMPC_Ld34[3];
controlMPC_FLOAT controlMPC_yy34[2];
controlMPC_FLOAT controlMPC_bmy34[2];
controlMPC_FLOAT controlMPC_c34[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx34[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb34 = controlMPC_l + 136;
controlMPC_FLOAT* controlMPC_slb34 = controlMPC_s + 136;
controlMPC_FLOAT* controlMPC_llbbyslb34 = controlMPC_lbys + 136;
controlMPC_FLOAT controlMPC_rilb34[2];
controlMPC_FLOAT* controlMPC_dllbaff34 = controlMPC_dl_aff + 136;
controlMPC_FLOAT* controlMPC_dslbaff34 = controlMPC_ds_aff + 136;
controlMPC_FLOAT* controlMPC_dllbcc34 = controlMPC_dl_cc + 136;
controlMPC_FLOAT* controlMPC_dslbcc34 = controlMPC_ds_cc + 136;
controlMPC_FLOAT* controlMPC_ccrhsl34 = controlMPC_ccrhs + 136;
int controlMPC_ubIdx34[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub34 = controlMPC_l + 138;
controlMPC_FLOAT* controlMPC_sub34 = controlMPC_s + 138;
controlMPC_FLOAT* controlMPC_lubbysub34 = controlMPC_lbys + 138;
controlMPC_FLOAT controlMPC_riub34[2];
controlMPC_FLOAT* controlMPC_dlubaff34 = controlMPC_dl_aff + 138;
controlMPC_FLOAT* controlMPC_dsubaff34 = controlMPC_ds_aff + 138;
controlMPC_FLOAT* controlMPC_dlubcc34 = controlMPC_dl_cc + 138;
controlMPC_FLOAT* controlMPC_dsubcc34 = controlMPC_ds_cc + 138;
controlMPC_FLOAT* controlMPC_ccrhsub34 = controlMPC_ccrhs + 138;
controlMPC_FLOAT controlMPC_Phi34[2];
controlMPC_FLOAT controlMPC_W34[2];
controlMPC_FLOAT controlMPC_Ysd34[4];
controlMPC_FLOAT controlMPC_Lsd34[4];
controlMPC_FLOAT* controlMPC_z35 = controlMPC_z + 70;
controlMPC_FLOAT* controlMPC_dzaff35 = controlMPC_dz_aff + 70;
controlMPC_FLOAT* controlMPC_dzcc35 = controlMPC_dz_cc + 70;
controlMPC_FLOAT* controlMPC_rd35 = controlMPC_rd + 70;
controlMPC_FLOAT controlMPC_Lbyrd35[2];
controlMPC_FLOAT* controlMPC_grad_cost35 = controlMPC_grad_cost + 70;
controlMPC_FLOAT* controlMPC_grad_eq35 = controlMPC_grad_eq + 70;
controlMPC_FLOAT* controlMPC_grad_ineq35 = controlMPC_grad_ineq + 70;
controlMPC_FLOAT controlMPC_ctv35[2];
controlMPC_FLOAT* controlMPC_v35 = controlMPC_v + 70;
controlMPC_FLOAT controlMPC_re35[2];
controlMPC_FLOAT controlMPC_beta35[2];
controlMPC_FLOAT controlMPC_betacc35[2];
controlMPC_FLOAT* controlMPC_dvaff35 = controlMPC_dv_aff + 70;
controlMPC_FLOAT* controlMPC_dvcc35 = controlMPC_dv_cc + 70;
controlMPC_FLOAT controlMPC_V35[4];
controlMPC_FLOAT controlMPC_Yd35[3];
controlMPC_FLOAT controlMPC_Ld35[3];
controlMPC_FLOAT controlMPC_yy35[2];
controlMPC_FLOAT controlMPC_bmy35[2];
controlMPC_FLOAT controlMPC_c35[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx35[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb35 = controlMPC_l + 140;
controlMPC_FLOAT* controlMPC_slb35 = controlMPC_s + 140;
controlMPC_FLOAT* controlMPC_llbbyslb35 = controlMPC_lbys + 140;
controlMPC_FLOAT controlMPC_rilb35[2];
controlMPC_FLOAT* controlMPC_dllbaff35 = controlMPC_dl_aff + 140;
controlMPC_FLOAT* controlMPC_dslbaff35 = controlMPC_ds_aff + 140;
controlMPC_FLOAT* controlMPC_dllbcc35 = controlMPC_dl_cc + 140;
controlMPC_FLOAT* controlMPC_dslbcc35 = controlMPC_ds_cc + 140;
controlMPC_FLOAT* controlMPC_ccrhsl35 = controlMPC_ccrhs + 140;
int controlMPC_ubIdx35[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub35 = controlMPC_l + 142;
controlMPC_FLOAT* controlMPC_sub35 = controlMPC_s + 142;
controlMPC_FLOAT* controlMPC_lubbysub35 = controlMPC_lbys + 142;
controlMPC_FLOAT controlMPC_riub35[2];
controlMPC_FLOAT* controlMPC_dlubaff35 = controlMPC_dl_aff + 142;
controlMPC_FLOAT* controlMPC_dsubaff35 = controlMPC_ds_aff + 142;
controlMPC_FLOAT* controlMPC_dlubcc35 = controlMPC_dl_cc + 142;
controlMPC_FLOAT* controlMPC_dsubcc35 = controlMPC_ds_cc + 142;
controlMPC_FLOAT* controlMPC_ccrhsub35 = controlMPC_ccrhs + 142;
controlMPC_FLOAT controlMPC_Phi35[2];
controlMPC_FLOAT controlMPC_W35[2];
controlMPC_FLOAT controlMPC_Ysd35[4];
controlMPC_FLOAT controlMPC_Lsd35[4];
controlMPC_FLOAT* controlMPC_z36 = controlMPC_z + 72;
controlMPC_FLOAT* controlMPC_dzaff36 = controlMPC_dz_aff + 72;
controlMPC_FLOAT* controlMPC_dzcc36 = controlMPC_dz_cc + 72;
controlMPC_FLOAT* controlMPC_rd36 = controlMPC_rd + 72;
controlMPC_FLOAT controlMPC_Lbyrd36[2];
controlMPC_FLOAT* controlMPC_grad_cost36 = controlMPC_grad_cost + 72;
controlMPC_FLOAT* controlMPC_grad_eq36 = controlMPC_grad_eq + 72;
controlMPC_FLOAT* controlMPC_grad_ineq36 = controlMPC_grad_ineq + 72;
controlMPC_FLOAT controlMPC_ctv36[2];
controlMPC_FLOAT* controlMPC_v36 = controlMPC_v + 72;
controlMPC_FLOAT controlMPC_re36[2];
controlMPC_FLOAT controlMPC_beta36[2];
controlMPC_FLOAT controlMPC_betacc36[2];
controlMPC_FLOAT* controlMPC_dvaff36 = controlMPC_dv_aff + 72;
controlMPC_FLOAT* controlMPC_dvcc36 = controlMPC_dv_cc + 72;
controlMPC_FLOAT controlMPC_V36[4];
controlMPC_FLOAT controlMPC_Yd36[3];
controlMPC_FLOAT controlMPC_Ld36[3];
controlMPC_FLOAT controlMPC_yy36[2];
controlMPC_FLOAT controlMPC_bmy36[2];
controlMPC_FLOAT controlMPC_c36[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx36[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb36 = controlMPC_l + 144;
controlMPC_FLOAT* controlMPC_slb36 = controlMPC_s + 144;
controlMPC_FLOAT* controlMPC_llbbyslb36 = controlMPC_lbys + 144;
controlMPC_FLOAT controlMPC_rilb36[2];
controlMPC_FLOAT* controlMPC_dllbaff36 = controlMPC_dl_aff + 144;
controlMPC_FLOAT* controlMPC_dslbaff36 = controlMPC_ds_aff + 144;
controlMPC_FLOAT* controlMPC_dllbcc36 = controlMPC_dl_cc + 144;
controlMPC_FLOAT* controlMPC_dslbcc36 = controlMPC_ds_cc + 144;
controlMPC_FLOAT* controlMPC_ccrhsl36 = controlMPC_ccrhs + 144;
int controlMPC_ubIdx36[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub36 = controlMPC_l + 146;
controlMPC_FLOAT* controlMPC_sub36 = controlMPC_s + 146;
controlMPC_FLOAT* controlMPC_lubbysub36 = controlMPC_lbys + 146;
controlMPC_FLOAT controlMPC_riub36[2];
controlMPC_FLOAT* controlMPC_dlubaff36 = controlMPC_dl_aff + 146;
controlMPC_FLOAT* controlMPC_dsubaff36 = controlMPC_ds_aff + 146;
controlMPC_FLOAT* controlMPC_dlubcc36 = controlMPC_dl_cc + 146;
controlMPC_FLOAT* controlMPC_dsubcc36 = controlMPC_ds_cc + 146;
controlMPC_FLOAT* controlMPC_ccrhsub36 = controlMPC_ccrhs + 146;
controlMPC_FLOAT controlMPC_Phi36[2];
controlMPC_FLOAT controlMPC_W36[2];
controlMPC_FLOAT controlMPC_Ysd36[4];
controlMPC_FLOAT controlMPC_Lsd36[4];
controlMPC_FLOAT* controlMPC_z37 = controlMPC_z + 74;
controlMPC_FLOAT* controlMPC_dzaff37 = controlMPC_dz_aff + 74;
controlMPC_FLOAT* controlMPC_dzcc37 = controlMPC_dz_cc + 74;
controlMPC_FLOAT* controlMPC_rd37 = controlMPC_rd + 74;
controlMPC_FLOAT controlMPC_Lbyrd37[2];
controlMPC_FLOAT* controlMPC_grad_cost37 = controlMPC_grad_cost + 74;
controlMPC_FLOAT* controlMPC_grad_eq37 = controlMPC_grad_eq + 74;
controlMPC_FLOAT* controlMPC_grad_ineq37 = controlMPC_grad_ineq + 74;
controlMPC_FLOAT controlMPC_ctv37[2];
controlMPC_FLOAT* controlMPC_v37 = controlMPC_v + 74;
controlMPC_FLOAT controlMPC_re37[2];
controlMPC_FLOAT controlMPC_beta37[2];
controlMPC_FLOAT controlMPC_betacc37[2];
controlMPC_FLOAT* controlMPC_dvaff37 = controlMPC_dv_aff + 74;
controlMPC_FLOAT* controlMPC_dvcc37 = controlMPC_dv_cc + 74;
controlMPC_FLOAT controlMPC_V37[4];
controlMPC_FLOAT controlMPC_Yd37[3];
controlMPC_FLOAT controlMPC_Ld37[3];
controlMPC_FLOAT controlMPC_yy37[2];
controlMPC_FLOAT controlMPC_bmy37[2];
controlMPC_FLOAT controlMPC_c37[2] = {0.0000000000000000E+000, 0.0000000000000000E+000};
int controlMPC_lbIdx37[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb37 = controlMPC_l + 148;
controlMPC_FLOAT* controlMPC_slb37 = controlMPC_s + 148;
controlMPC_FLOAT* controlMPC_llbbyslb37 = controlMPC_lbys + 148;
controlMPC_FLOAT controlMPC_rilb37[2];
controlMPC_FLOAT* controlMPC_dllbaff37 = controlMPC_dl_aff + 148;
controlMPC_FLOAT* controlMPC_dslbaff37 = controlMPC_ds_aff + 148;
controlMPC_FLOAT* controlMPC_dllbcc37 = controlMPC_dl_cc + 148;
controlMPC_FLOAT* controlMPC_dslbcc37 = controlMPC_ds_cc + 148;
controlMPC_FLOAT* controlMPC_ccrhsl37 = controlMPC_ccrhs + 148;
int controlMPC_ubIdx37[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub37 = controlMPC_l + 150;
controlMPC_FLOAT* controlMPC_sub37 = controlMPC_s + 150;
controlMPC_FLOAT* controlMPC_lubbysub37 = controlMPC_lbys + 150;
controlMPC_FLOAT controlMPC_riub37[2];
controlMPC_FLOAT* controlMPC_dlubaff37 = controlMPC_dl_aff + 150;
controlMPC_FLOAT* controlMPC_dsubaff37 = controlMPC_ds_aff + 150;
controlMPC_FLOAT* controlMPC_dlubcc37 = controlMPC_dl_cc + 150;
controlMPC_FLOAT* controlMPC_dsubcc37 = controlMPC_ds_cc + 150;
controlMPC_FLOAT* controlMPC_ccrhsub37 = controlMPC_ccrhs + 150;
controlMPC_FLOAT controlMPC_Phi37[2];
controlMPC_FLOAT controlMPC_W37[2];
controlMPC_FLOAT controlMPC_Ysd37[4];
controlMPC_FLOAT controlMPC_Lsd37[4];
controlMPC_FLOAT* controlMPC_z38 = controlMPC_z + 76;
controlMPC_FLOAT* controlMPC_dzaff38 = controlMPC_dz_aff + 76;
controlMPC_FLOAT* controlMPC_dzcc38 = controlMPC_dz_cc + 76;
controlMPC_FLOAT* controlMPC_rd38 = controlMPC_rd + 76;
controlMPC_FLOAT controlMPC_Lbyrd38[2];
controlMPC_FLOAT* controlMPC_grad_cost38 = controlMPC_grad_cost + 76;
controlMPC_FLOAT* controlMPC_grad_eq38 = controlMPC_grad_eq + 76;
controlMPC_FLOAT* controlMPC_grad_ineq38 = controlMPC_grad_ineq + 76;
controlMPC_FLOAT controlMPC_ctv38[2];
int controlMPC_lbIdx38[2] = {0, 1};
controlMPC_FLOAT* controlMPC_llb38 = controlMPC_l + 152;
controlMPC_FLOAT* controlMPC_slb38 = controlMPC_s + 152;
controlMPC_FLOAT* controlMPC_llbbyslb38 = controlMPC_lbys + 152;
controlMPC_FLOAT controlMPC_rilb38[2];
controlMPC_FLOAT* controlMPC_dllbaff38 = controlMPC_dl_aff + 152;
controlMPC_FLOAT* controlMPC_dslbaff38 = controlMPC_ds_aff + 152;
controlMPC_FLOAT* controlMPC_dllbcc38 = controlMPC_dl_cc + 152;
controlMPC_FLOAT* controlMPC_dslbcc38 = controlMPC_ds_cc + 152;
controlMPC_FLOAT* controlMPC_ccrhsl38 = controlMPC_ccrhs + 152;
int controlMPC_ubIdx38[2] = {0, 1};
controlMPC_FLOAT* controlMPC_lub38 = controlMPC_l + 154;
controlMPC_FLOAT* controlMPC_sub38 = controlMPC_s + 154;
controlMPC_FLOAT* controlMPC_lubbysub38 = controlMPC_lbys + 154;
controlMPC_FLOAT controlMPC_riub38[2];
controlMPC_FLOAT* controlMPC_dlubaff38 = controlMPC_dl_aff + 154;
controlMPC_FLOAT* controlMPC_dsubaff38 = controlMPC_ds_aff + 154;
controlMPC_FLOAT* controlMPC_dlubcc38 = controlMPC_dl_cc + 154;
controlMPC_FLOAT* controlMPC_dsubcc38 = controlMPC_ds_cc + 154;
controlMPC_FLOAT* controlMPC_ccrhsub38 = controlMPC_ccrhs + 154;
controlMPC_FLOAT controlMPC_Phi38[2];
controlMPC_FLOAT controlMPC_W38[2];
...
info->it = 0;
controlMPC_LA_INITIALIZEVECTOR_78(controlMPC_z, 0);
controlMPC_LA_INITIALIZEVECTOR_76(controlMPC_v, 1);
controlMPC_LA_INITIALIZEVECTOR_156(controlMPC_l, 1);
controlMPC_LA_INITIALIZEVECTOR_156(controlMPC_s, 1);
info->mu = 0;
controlMPC_LA_DOTACC_156(controlMPC_l, controlMPC_s, &info->mu);
info->mu /= 156;
while( 1 ){
info->pobj = 0;
...
controlMPC_LA_DIAG_QUADFCN_2(params->H30, params->f30, controlMPC_z29, controlMPC_grad_cost29, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H31, params->f31, controlMPC_z30, controlMPC_grad_cost30, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H32, params->f32, controlMPC_z31, controlMPC_grad_cost31, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H33, params->f33, controlMPC_z32, controlMPC_grad_cost32, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H34, params->f34, controlMPC_z33, controlMPC_grad_cost33, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H35, params->f35, controlMPC_z34, controlMPC_grad_cost34, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H36, params->f36, controlMPC_z35, controlMPC_grad_cost35, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H37, params->f37, controlMPC_z36, controlMPC_grad_cost36, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H38, params->f38, controlMPC_z37, controlMPC_grad_cost37, &info->pobj);
controlMPC_LA_DIAG_QUADFCN_2(params->H39, params->f39, controlMPC_z38, controlMPC_grad_cost38, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z28, controlMPC_D01, controlMPC_z29, controlMPC_c28, controlMPC_v28, controlMPC_re28, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z29, controlMPC_D01, controlMPC_z30, controlMPC_c29, controlMPC_v29, controlMPC_re29, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z30, controlMPC_D01, controlMPC_z31, controlMPC_c30, controlMPC_v30, controlMPC_re30, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z31, controlMPC_D01, controlMPC_z32, controlMPC_c31, controlMPC_v31, controlMPC_re31, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z32, controlMPC_D01, controlMPC_z33, controlMPC_c32, controlMPC_v32, controlMPC_re32, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z33, controlMPC_D01, controlMPC_z34, controlMPC_c33, controlMPC_v33, controlMPC_re33, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z34, controlMPC_D01, controlMPC_z35, controlMPC_c34, controlMPC_v34, controlMPC_re34, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z35, controlMPC_D01, controlMPC_z36, controlMPC_c35, controlMPC_v35, controlMPC_re35, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z36, controlMPC_D01, controlMPC_z37, controlMPC_c36, controlMPC_v36, controlMPC_re36, &info->dgap, &info->res_eq);
controlMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_2_2(controlMPC_C00, controlMPC_z37, controlMPC_D01, controlMPC_z38, controlMPC_c37, controlMPC_v37, controlMPC_re37, &info->dgap, &info->res_eq);
...
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v28, controlMPC_D01, controlMPC_v27, controlMPC_grad_eq28);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v29, controlMPC_D01, controlMPC_v28, controlMPC_grad_eq29);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v30, controlMPC_D01, controlMPC_v29, controlMPC_grad_eq30);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v31, controlMPC_D01, controlMPC_v30, controlMPC_grad_eq31);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v32, controlMPC_D01, controlMPC_v31, controlMPC_grad_eq32);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v33, controlMPC_D01, controlMPC_v32, controlMPC_grad_eq33);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v34, controlMPC_D01, controlMPC_v33, controlMPC_grad_eq34);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v35, controlMPC_D01, controlMPC_v34, controlMPC_grad_eq35);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v36, controlMPC_D01, controlMPC_v35, controlMPC_grad_eq36);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_v37, controlMPC_D01, controlMPC_v36, controlMPC_grad_eq37);
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_v37, controlMPC_grad_eq38);
info->res_ineq = 0;
...
controlMPC_LA_VSUBADD3_2(params->lb30, controlMPC_z29, controlMPC_lbIdx29, controlMPC_llb29, controlMPC_slb29, controlMPC_rilb29, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z29, controlMPC_ubIdx29, params->ub30, controlMPC_lub29, controlMPC_sub29, controlMPC_riub29, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb31, controlMPC_z30, controlMPC_lbIdx30, controlMPC_llb30, controlMPC_slb30, controlMPC_rilb30, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z30, controlMPC_ubIdx30, params->ub31, controlMPC_lub30, controlMPC_sub30, controlMPC_riub30, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb32, controlMPC_z31, controlMPC_lbIdx31, controlMPC_llb31, controlMPC_slb31, controlMPC_rilb31, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z31, controlMPC_ubIdx31, params->ub32, controlMPC_lub31, controlMPC_sub31, controlMPC_riub31, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb33, controlMPC_z32, controlMPC_lbIdx32, controlMPC_llb32, controlMPC_slb32, controlMPC_rilb32, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z32, controlMPC_ubIdx32, params->ub33, controlMPC_lub32, controlMPC_sub32, controlMPC_riub32, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb34, controlMPC_z33, controlMPC_lbIdx33, controlMPC_llb33, controlMPC_slb33, controlMPC_rilb33, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z33, controlMPC_ubIdx33, params->ub34, controlMPC_lub33, controlMPC_sub33, controlMPC_riub33, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb35, controlMPC_z34, controlMPC_lbIdx34, controlMPC_llb34, controlMPC_slb34, controlMPC_rilb34, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z34, controlMPC_ubIdx34, params->ub35, controlMPC_lub34, controlMPC_sub34, controlMPC_riub34, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb36, controlMPC_z35, controlMPC_lbIdx35, controlMPC_llb35, controlMPC_slb35, controlMPC_rilb35, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z35, controlMPC_ubIdx35, params->ub36, controlMPC_lub35, controlMPC_sub35, controlMPC_riub35, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb37, controlMPC_z36, controlMPC_lbIdx36, controlMPC_llb36, controlMPC_slb36, controlMPC_rilb36, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z36, controlMPC_ubIdx36, params->ub37, controlMPC_lub36, controlMPC_sub36, controlMPC_riub36, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb38, controlMPC_z37, controlMPC_lbIdx37, controlMPC_llb37, controlMPC_slb37, controlMPC_rilb37, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z37, controlMPC_ubIdx37, params->ub38, controlMPC_lub37, controlMPC_sub37, controlMPC_riub37, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD3_2(params->lb39, controlMPC_z38, controlMPC_lbIdx38, controlMPC_llb38, controlMPC_slb38, controlMPC_rilb38, &info->dgap, &info->res_ineq);
controlMPC_LA_VSUBADD2_2(controlMPC_z38, controlMPC_ubIdx38, params->ub39, controlMPC_lub38, controlMPC_sub38, controlMPC_riub38, &info->dgap, &info->res_ineq);
...
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub29, controlMPC_sub29, controlMPC_riub29, controlMPC_llb29, controlMPC_slb29, controlMPC_rilb29, controlMPC_lbIdx29, controlMPC_ubIdx29, controlMPC_grad_ineq29, controlMPC_lubbysub29, controlMPC_llbbyslb29);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub30, controlMPC_sub30, controlMPC_riub30, controlMPC_llb30, controlMPC_slb30, controlMPC_rilb30, controlMPC_lbIdx30, controlMPC_ubIdx30, controlMPC_grad_ineq30, controlMPC_lubbysub30, controlMPC_llbbyslb30);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub31, controlMPC_sub31, controlMPC_riub31, controlMPC_llb31, controlMPC_slb31, controlMPC_rilb31, controlMPC_lbIdx31, controlMPC_ubIdx31, controlMPC_grad_ineq31, controlMPC_lubbysub31, controlMPC_llbbyslb31);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub32, controlMPC_sub32, controlMPC_riub32, controlMPC_llb32, controlMPC_slb32, controlMPC_rilb32, controlMPC_lbIdx32, controlMPC_ubIdx32, controlMPC_grad_ineq32, controlMPC_lubbysub32, controlMPC_llbbyslb32);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub33, controlMPC_sub33, controlMPC_riub33, controlMPC_llb33, controlMPC_slb33, controlMPC_rilb33, controlMPC_lbIdx33, controlMPC_ubIdx33, controlMPC_grad_ineq33, controlMPC_lubbysub33, controlMPC_llbbyslb33);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub34, controlMPC_sub34, controlMPC_riub34, controlMPC_llb34, controlMPC_slb34, controlMPC_rilb34, controlMPC_lbIdx34, controlMPC_ubIdx34, controlMPC_grad_ineq34, controlMPC_lubbysub34, controlMPC_llbbyslb34);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub35, controlMPC_sub35, controlMPC_riub35, controlMPC_llb35, controlMPC_slb35, controlMPC_rilb35, controlMPC_lbIdx35, controlMPC_ubIdx35, controlMPC_grad_ineq35, controlMPC_lubbysub35, controlMPC_llbbyslb35);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub36, controlMPC_sub36, controlMPC_riub36, controlMPC_llb36, controlMPC_slb36, controlMPC_rilb36, controlMPC_lbIdx36, controlMPC_ubIdx36, controlMPC_grad_ineq36, controlMPC_lubbysub36, controlMPC_llbbyslb36);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub37, controlMPC_sub37, controlMPC_riub37, controlMPC_llb37, controlMPC_slb37, controlMPC_rilb37, controlMPC_lbIdx37, controlMPC_ubIdx37, controlMPC_grad_ineq37, controlMPC_lubbysub37, controlMPC_llbbyslb37);
controlMPC_LA_INEQ_B_GRAD_2_2_2(controlMPC_lub38, controlMPC_sub38, controlMPC_riub38, controlMPC_llb38, controlMPC_slb38, controlMPC_rilb38, controlMPC_lbIdx38, controlMPC_ubIdx38, controlMPC_grad_ineq38, controlMPC_lubbysub38, controlMPC_llbbyslb38);
...
controlMPC_LA_VVADD3_78(controlMPC_grad_cost, controlMPC_grad_eq, controlMPC_grad_ineq, controlMPC_rd);
...
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi28, controlMPC_C00, controlMPC_V28);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi28, controlMPC_D01, controlMPC_W28);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W28, controlMPC_V28, controlMPC_Ysd28);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi28, controlMPC_rd28, controlMPC_Lbyrd28);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H30, controlMPC_llbbyslb29, controlMPC_lbIdx29, controlMPC_lubbysub29, controlMPC_ubIdx29, controlMPC_Phi29);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi29, controlMPC_C00, controlMPC_V29);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi29, controlMPC_D01, controlMPC_W29);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W29, controlMPC_V29, controlMPC_Ysd29);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi29, controlMPC_rd29, controlMPC_Lbyrd29);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H31, controlMPC_llbbyslb30, controlMPC_lbIdx30, controlMPC_lubbysub30, controlMPC_ubIdx30, controlMPC_Phi30);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi30, controlMPC_C00, controlMPC_V30);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi30, controlMPC_D01, controlMPC_W30);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W30, controlMPC_V30, controlMPC_Ysd30);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi30, controlMPC_rd30, controlMPC_Lbyrd30);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H32, controlMPC_llbbyslb31, controlMPC_lbIdx31, controlMPC_lubbysub31, controlMPC_ubIdx31, controlMPC_Phi31);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi31, controlMPC_C00, controlMPC_V31);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi31, controlMPC_D01, controlMPC_W31);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W31, controlMPC_V31, controlMPC_Ysd31);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi31, controlMPC_rd31, controlMPC_Lbyrd31);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H33, controlMPC_llbbyslb32, controlMPC_lbIdx32, controlMPC_lubbysub32, controlMPC_ubIdx32, controlMPC_Phi32);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi32, controlMPC_C00, controlMPC_V32);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi32, controlMPC_D01, controlMPC_W32);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W32, controlMPC_V32, controlMPC_Ysd32);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi32, controlMPC_rd32, controlMPC_Lbyrd32);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H34, controlMPC_llbbyslb33, controlMPC_lbIdx33, controlMPC_lubbysub33, controlMPC_ubIdx33, controlMPC_Phi33);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi33, controlMPC_C00, controlMPC_V33);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi33, controlMPC_D01, controlMPC_W33);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W33, controlMPC_V33, controlMPC_Ysd33);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi33, controlMPC_rd33, controlMPC_Lbyrd33);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H35, controlMPC_llbbyslb34, controlMPC_lbIdx34, controlMPC_lubbysub34, controlMPC_ubIdx34, controlMPC_Phi34);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi34, controlMPC_C00, controlMPC_V34);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi34, controlMPC_D01, controlMPC_W34);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W34, controlMPC_V34, controlMPC_Ysd34);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi34, controlMPC_rd34, controlMPC_Lbyrd34);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H36, controlMPC_llbbyslb35, controlMPC_lbIdx35, controlMPC_lubbysub35, controlMPC_ubIdx35, controlMPC_Phi35);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi35, controlMPC_C00, controlMPC_V35);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi35, controlMPC_D01, controlMPC_W35);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W35, controlMPC_V35, controlMPC_Ysd35);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi35, controlMPC_rd35, controlMPC_Lbyrd35);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H37, controlMPC_llbbyslb36, controlMPC_lbIdx36, controlMPC_lubbysub36, controlMPC_ubIdx36, controlMPC_Phi36);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi36, controlMPC_C00, controlMPC_V36);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi36, controlMPC_D01, controlMPC_W36);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W36, controlMPC_V36, controlMPC_Ysd36);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi36, controlMPC_rd36, controlMPC_Lbyrd36);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H38, controlMPC_llbbyslb37, controlMPC_lbIdx37, controlMPC_lubbysub37, controlMPC_ubIdx37, controlMPC_Phi37);
controlMPC_LA_DIAG_MATRIXFORWARDSUB_2_2(controlMPC_Phi37, controlMPC_C00, controlMPC_V37);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi37, controlMPC_D01, controlMPC_W37);
controlMPC_LA_DENSE_DIAGZERO_MMTM_2_2_2(controlMPC_W37, controlMPC_V37, controlMPC_Ysd37);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi37, controlMPC_rd37, controlMPC_Lbyrd37);
controlMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H39, controlMPC_llbbyslb38, controlMPC_lbIdx38, controlMPC_lubbysub38, controlMPC_ubIdx38, controlMPC_Phi38);
controlMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(controlMPC_Phi38, controlMPC_D01, controlMPC_W38);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi38, controlMPC_rd38, controlMPC_Lbyrd38);
...
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V28, controlMPC_W29, controlMPC_Yd28);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V28, controlMPC_Lbyrd28, controlMPC_W29, controlMPC_Lbyrd29, controlMPC_re28, controlMPC_beta28);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V29, controlMPC_W30, controlMPC_Yd29);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V29, controlMPC_Lbyrd29, controlMPC_W30, controlMPC_Lbyrd30, controlMPC_re29, controlMPC_beta29);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V30, controlMPC_W31, controlMPC_Yd30);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V30, controlMPC_Lbyrd30, controlMPC_W31, controlMPC_Lbyrd31, controlMPC_re30, controlMPC_beta30);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V31, controlMPC_W32, controlMPC_Yd31);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V31, controlMPC_Lbyrd31, controlMPC_W32, controlMPC_Lbyrd32, controlMPC_re31, controlMPC_beta31);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V32, controlMPC_W33, controlMPC_Yd32);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V32, controlMPC_Lbyrd32, controlMPC_W33, controlMPC_Lbyrd33, controlMPC_re32, controlMPC_beta32);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V33, controlMPC_W34, controlMPC_Yd33);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V33, controlMPC_Lbyrd33, controlMPC_W34, controlMPC_Lbyrd34, controlMPC_re33, controlMPC_beta33);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V34, controlMPC_W35, controlMPC_Yd34);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V34, controlMPC_Lbyrd34, controlMPC_W35, controlMPC_Lbyrd35, controlMPC_re34, controlMPC_beta34);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V35, controlMPC_W36, controlMPC_Yd35);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V35, controlMPC_Lbyrd35, controlMPC_W36, controlMPC_Lbyrd36, controlMPC_re35, controlMPC_beta35);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V36, controlMPC_W37, controlMPC_Yd36);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V36, controlMPC_Lbyrd36, controlMPC_W37, controlMPC_Lbyrd37, controlMPC_re36, controlMPC_beta36);
controlMPC_LA_DENSE_DIAGZERO_MMT2_2_2_2(controlMPC_V37, controlMPC_W38, controlMPC_Yd37);
controlMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_2_2(controlMPC_V37, controlMPC_Lbyrd37, controlMPC_W38, controlMPC_Lbyrd38, controlMPC_re37, controlMPC_beta37);
...
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld27, controlMPC_Ysd28, controlMPC_Lsd28);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd28, controlMPC_Yd28);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd28, controlMPC_Ld28);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd28, controlMPC_yy27, controlMPC_beta28, controlMPC_bmy28);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld28, controlMPC_bmy28, controlMPC_yy28);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld28, controlMPC_Ysd29, controlMPC_Lsd29);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd29, controlMPC_Yd29);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd29, controlMPC_Ld29);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd29, controlMPC_yy28, controlMPC_beta29, controlMPC_bmy29);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld29, controlMPC_bmy29, controlMPC_yy29);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld29, controlMPC_Ysd30, controlMPC_Lsd30);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd30, controlMPC_Yd30);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd30, controlMPC_Ld30);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd30, controlMPC_yy29, controlMPC_beta30, controlMPC_bmy30);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld30, controlMPC_bmy30, controlMPC_yy30);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld30, controlMPC_Ysd31, controlMPC_Lsd31);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd31, controlMPC_Yd31);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd31, controlMPC_Ld31);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd31, controlMPC_yy30, controlMPC_beta31, controlMPC_bmy31);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld31, controlMPC_bmy31, controlMPC_yy31);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld31, controlMPC_Ysd32, controlMPC_Lsd32);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd32, controlMPC_Yd32);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd32, controlMPC_Ld32);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd32, controlMPC_yy31, controlMPC_beta32, controlMPC_bmy32);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld32, controlMPC_bmy32, controlMPC_yy32);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld32, controlMPC_Ysd33, controlMPC_Lsd33);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd33, controlMPC_Yd33);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd33, controlMPC_Ld33);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd33, controlMPC_yy32, controlMPC_beta33, controlMPC_bmy33);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld33, controlMPC_bmy33, controlMPC_yy33);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld33, controlMPC_Ysd34, controlMPC_Lsd34);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd34, controlMPC_Yd34);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd34, controlMPC_Ld34);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd34, controlMPC_yy33, controlMPC_beta34, controlMPC_bmy34);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld34, controlMPC_bmy34, controlMPC_yy34);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld34, controlMPC_Ysd35, controlMPC_Lsd35);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd35, controlMPC_Yd35);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd35, controlMPC_Ld35);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd35, controlMPC_yy34, controlMPC_beta35, controlMPC_bmy35);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld35, controlMPC_bmy35, controlMPC_yy35);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld35, controlMPC_Ysd36, controlMPC_Lsd36);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd36, controlMPC_Yd36);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd36, controlMPC_Ld36);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd36, controlMPC_yy35, controlMPC_beta36, controlMPC_bmy36);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld36, controlMPC_bmy36, controlMPC_yy36);
controlMPC_LA_DENSE_MATRIXTFORWARDSUB_2_2(controlMPC_Ld36, controlMPC_Ysd37, controlMPC_Lsd37);
controlMPC_LA_DENSE_MMTSUB_2_2(controlMPC_Lsd37, controlMPC_Yd37);
controlMPC_LA_DENSE_CHOL_2(controlMPC_Yd37, controlMPC_Ld37);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd37, controlMPC_yy36, controlMPC_beta37, controlMPC_bmy37);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld37, controlMPC_bmy37, controlMPC_yy37);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld37, controlMPC_yy37, controlMPC_dvaff37);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd37, controlMPC_dvaff37, controlMPC_yy36, controlMPC_bmy36);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld36, controlMPC_bmy36, controlMPC_dvaff36);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd36, controlMPC_dvaff36, controlMPC_yy35, controlMPC_bmy35);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld35, controlMPC_bmy35, controlMPC_dvaff35);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd35, controlMPC_dvaff35, controlMPC_yy34, controlMPC_bmy34);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld34, controlMPC_bmy34, controlMPC_dvaff34);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd34, controlMPC_dvaff34, controlMPC_yy33, controlMPC_bmy33);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld33, controlMPC_bmy33, controlMPC_dvaff33);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd33, controlMPC_dvaff33, controlMPC_yy32, controlMPC_bmy32);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld32, controlMPC_bmy32, controlMPC_dvaff32);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd32, controlMPC_dvaff32, controlMPC_yy31, controlMPC_bmy31);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld31, controlMPC_bmy31, controlMPC_dvaff31);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd31, controlMPC_dvaff31, controlMPC_yy30, controlMPC_bmy30);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld30, controlMPC_bmy30, controlMPC_dvaff30);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd30, controlMPC_dvaff30, controlMPC_yy29, controlMPC_bmy29);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld29, controlMPC_bmy29, controlMPC_dvaff29);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd29, controlMPC_dvaff29, controlMPC_yy28, controlMPC_bmy28);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld28, controlMPC_bmy28, controlMPC_dvaff28);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd28, controlMPC_dvaff28, controlMPC_yy27, controlMPC_bmy27);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld27, controlMPC_bmy27, controlMPC_dvaff27);
...
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff28, controlMPC_D01, controlMPC_dvaff27, controlMPC_grad_eq28);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff29, controlMPC_D01, controlMPC_dvaff28, controlMPC_grad_eq29);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff30, controlMPC_D01, controlMPC_dvaff29, controlMPC_grad_eq30);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff31, controlMPC_D01, controlMPC_dvaff30, controlMPC_grad_eq31);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff32, controlMPC_D01, controlMPC_dvaff31, controlMPC_grad_eq32);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff33, controlMPC_D01, controlMPC_dvaff32, controlMPC_grad_eq33);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff34, controlMPC_D01, controlMPC_dvaff33, controlMPC_grad_eq34);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff35, controlMPC_D01, controlMPC_dvaff34, controlMPC_grad_eq35);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff36, controlMPC_D01, controlMPC_dvaff35, controlMPC_grad_eq36);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvaff37, controlMPC_D01, controlMPC_dvaff36, controlMPC_grad_eq37);
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_dvaff37, controlMPC_grad_eq38);
controlMPC_LA_VSUB2_78(controlMPC_rd, controlMPC_grad_eq, controlMPC_rd);
...
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi29, controlMPC_rd29, controlMPC_dzaff29);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi30, controlMPC_rd30, controlMPC_dzaff30);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi31, controlMPC_rd31, controlMPC_dzaff31);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi32, controlMPC_rd32, controlMPC_dzaff32);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi33, controlMPC_rd33, controlMPC_dzaff33);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi34, controlMPC_rd34, controlMPC_dzaff34);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi35, controlMPC_rd35, controlMPC_dzaff35);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi36, controlMPC_rd36, controlMPC_dzaff36);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi37, controlMPC_rd37, controlMPC_dzaff37);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi38, controlMPC_rd38, controlMPC_dzaff38);
...
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff29, controlMPC_lbIdx29, controlMPC_rilb29, controlMPC_dslbaff29);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb29, controlMPC_dslbaff29, controlMPC_llb29, controlMPC_dllbaff29);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub29, controlMPC_dzaff29, controlMPC_ubIdx29, controlMPC_dsubaff29);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub29, controlMPC_dsubaff29, controlMPC_lub29, controlMPC_dlubaff29);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff30, controlMPC_lbIdx30, controlMPC_rilb30, controlMPC_dslbaff30);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb30, controlMPC_dslbaff30, controlMPC_llb30, controlMPC_dllbaff30);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub30, controlMPC_dzaff30, controlMPC_ubIdx30, controlMPC_dsubaff30);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub30, controlMPC_dsubaff30, controlMPC_lub30, controlMPC_dlubaff30);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff31, controlMPC_lbIdx31, controlMPC_rilb31, controlMPC_dslbaff31);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb31, controlMPC_dslbaff31, controlMPC_llb31, controlMPC_dllbaff31);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub31, controlMPC_dzaff31, controlMPC_ubIdx31, controlMPC_dsubaff31);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub31, controlMPC_dsubaff31, controlMPC_lub31, controlMPC_dlubaff31);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff32, controlMPC_lbIdx32, controlMPC_rilb32, controlMPC_dslbaff32);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb32, controlMPC_dslbaff32, controlMPC_llb32, controlMPC_dllbaff32);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub32, controlMPC_dzaff32, controlMPC_ubIdx32, controlMPC_dsubaff32);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub32, controlMPC_dsubaff32, controlMPC_lub32, controlMPC_dlubaff32);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff33, controlMPC_lbIdx33, controlMPC_rilb33, controlMPC_dslbaff33);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb33, controlMPC_dslbaff33, controlMPC_llb33, controlMPC_dllbaff33);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub33, controlMPC_dzaff33, controlMPC_ubIdx33, controlMPC_dsubaff33);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub33, controlMPC_dsubaff33, controlMPC_lub33, controlMPC_dlubaff33);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff34, controlMPC_lbIdx34, controlMPC_rilb34, controlMPC_dslbaff34);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb34, controlMPC_dslbaff34, controlMPC_llb34, controlMPC_dllbaff34);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub34, controlMPC_dzaff34, controlMPC_ubIdx34, controlMPC_dsubaff34);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub34, controlMPC_dsubaff34, controlMPC_lub34, controlMPC_dlubaff34);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff35, controlMPC_lbIdx35, controlMPC_rilb35, controlMPC_dslbaff35);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb35, controlMPC_dslbaff35, controlMPC_llb35, controlMPC_dllbaff35);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub35, controlMPC_dzaff35, controlMPC_ubIdx35, controlMPC_dsubaff35);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub35, controlMPC_dsubaff35, controlMPC_lub35, controlMPC_dlubaff35);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff36, controlMPC_lbIdx36, controlMPC_rilb36, controlMPC_dslbaff36);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb36, controlMPC_dslbaff36, controlMPC_llb36, controlMPC_dllbaff36);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub36, controlMPC_dzaff36, controlMPC_ubIdx36, controlMPC_dsubaff36);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub36, controlMPC_dsubaff36, controlMPC_lub36, controlMPC_dlubaff36);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff37, controlMPC_lbIdx37, controlMPC_rilb37, controlMPC_dslbaff37);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb37, controlMPC_dslbaff37, controlMPC_llb37, controlMPC_dllbaff37);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub37, controlMPC_dzaff37, controlMPC_ubIdx37, controlMPC_dsubaff37);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub37, controlMPC_dsubaff37, controlMPC_lub37, controlMPC_dlubaff37);
controlMPC_LA_VSUB_INDEXED_2(controlMPC_dzaff38, controlMPC_lbIdx38, controlMPC_rilb38, controlMPC_dslbaff38);
controlMPC_LA_VSUB3_2(controlMPC_llbbyslb38, controlMPC_dslbaff38, controlMPC_llb38, controlMPC_dllbaff38);
controlMPC_LA_VSUB2_INDEXED_2(controlMPC_riub38, controlMPC_dzaff38, controlMPC_ubIdx38, controlMPC_dsubaff38);
controlMPC_LA_VSUB3_2(controlMPC_lubbysub38, controlMPC_dsubaff38, controlMPC_lub38, controlMPC_dlubaff38);
...
controlMPC_LA_VSUB5_156(controlMPC_ds_aff, controlMPC_dl_aff, musigma, controlMPC_ccrhs);
...
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd27, controlMPC_yy26, controlMPC_beta27, controlMPC_bmy27);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld27, controlMPC_bmy27, controlMPC_yy27);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub29, controlMPC_sub29, controlMPC_ubIdx29, controlMPC_ccrhsl29, controlMPC_slb29, controlMPC_lbIdx29, controlMPC_rd29);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi29, controlMPC_rd29, controlMPC_Lbyrd29);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V28, controlMPC_Lbyrd28, controlMPC_W29, controlMPC_Lbyrd29, controlMPC_beta28);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd28, controlMPC_yy27, controlMPC_beta28, controlMPC_bmy28);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld28, controlMPC_bmy28, controlMPC_yy28);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub30, controlMPC_sub30, controlMPC_ubIdx30, controlMPC_ccrhsl30, controlMPC_slb30, controlMPC_lbIdx30, controlMPC_rd30);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi30, controlMPC_rd30, controlMPC_Lbyrd30);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V29, controlMPC_Lbyrd29, controlMPC_W30, controlMPC_Lbyrd30, controlMPC_beta29);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd29, controlMPC_yy28, controlMPC_beta29, controlMPC_bmy29);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld29, controlMPC_bmy29, controlMPC_yy29);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub31, controlMPC_sub31, controlMPC_ubIdx31, controlMPC_ccrhsl31, controlMPC_slb31, controlMPC_lbIdx31, controlMPC_rd31);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi31, controlMPC_rd31, controlMPC_Lbyrd31);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V30, controlMPC_Lbyrd30, controlMPC_W31, controlMPC_Lbyrd31, controlMPC_beta30);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd30, controlMPC_yy29, controlMPC_beta30, controlMPC_bmy30);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld30, controlMPC_bmy30, controlMPC_yy30);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub32, controlMPC_sub32, controlMPC_ubIdx32, controlMPC_ccrhsl32, controlMPC_slb32, controlMPC_lbIdx32, controlMPC_rd32);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi32, controlMPC_rd32, controlMPC_Lbyrd32);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V31, controlMPC_Lbyrd31, controlMPC_W32, controlMPC_Lbyrd32, controlMPC_beta31);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd31, controlMPC_yy30, controlMPC_beta31, controlMPC_bmy31);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld31, controlMPC_bmy31, controlMPC_yy31);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub33, controlMPC_sub33, controlMPC_ubIdx33, controlMPC_ccrhsl33, controlMPC_slb33, controlMPC_lbIdx33, controlMPC_rd33);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi33, controlMPC_rd33, controlMPC_Lbyrd33);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V32, controlMPC_Lbyrd32, controlMPC_W33, controlMPC_Lbyrd33, controlMPC_beta32);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd32, controlMPC_yy31, controlMPC_beta32, controlMPC_bmy32);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld32, controlMPC_bmy32, controlMPC_yy32);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub34, controlMPC_sub34, controlMPC_ubIdx34, controlMPC_ccrhsl34, controlMPC_slb34, controlMPC_lbIdx34, controlMPC_rd34);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi34, controlMPC_rd34, controlMPC_Lbyrd34);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V33, controlMPC_Lbyrd33, controlMPC_W34, controlMPC_Lbyrd34, controlMPC_beta33);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd33, controlMPC_yy32, controlMPC_beta33, controlMPC_bmy33);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld33, controlMPC_bmy33, controlMPC_yy33);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub35, controlMPC_sub35, controlMPC_ubIdx35, controlMPC_ccrhsl35, controlMPC_slb35, controlMPC_lbIdx35, controlMPC_rd35);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi35, controlMPC_rd35, controlMPC_Lbyrd35);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V34, controlMPC_Lbyrd34, controlMPC_W35, controlMPC_Lbyrd35, controlMPC_beta34);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd34, controlMPC_yy33, controlMPC_beta34, controlMPC_bmy34);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld34, controlMPC_bmy34, controlMPC_yy34);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub36, controlMPC_sub36, controlMPC_ubIdx36, controlMPC_ccrhsl36, controlMPC_slb36, controlMPC_lbIdx36, controlMPC_rd36);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi36, controlMPC_rd36, controlMPC_Lbyrd36);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V35, controlMPC_Lbyrd35, controlMPC_W36, controlMPC_Lbyrd36, controlMPC_beta35);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd35, controlMPC_yy34, controlMPC_beta35, controlMPC_bmy35);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld35, controlMPC_bmy35, controlMPC_yy35);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub37, controlMPC_sub37, controlMPC_ubIdx37, controlMPC_ccrhsl37, controlMPC_slb37, controlMPC_lbIdx37, controlMPC_rd37);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi37, controlMPC_rd37, controlMPC_Lbyrd37);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V36, controlMPC_Lbyrd36, controlMPC_W37, controlMPC_Lbyrd37, controlMPC_beta36);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd36, controlMPC_yy35, controlMPC_beta36, controlMPC_bmy36);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld36, controlMPC_bmy36, controlMPC_yy36);
controlMPC_LA_VSUB6_INDEXED_2_2_2(controlMPC_ccrhsub38, controlMPC_sub38, controlMPC_ubIdx38, controlMPC_ccrhsl38, controlMPC_slb38, controlMPC_lbIdx38, controlMPC_rd38);
controlMPC_LA_DIAG_FORWARDSUB_2(controlMPC_Phi38, controlMPC_rd38, controlMPC_Lbyrd38);
controlMPC_LA_DENSE_DIAGZERO_2MVMADD_2_2_2(controlMPC_V37, controlMPC_Lbyrd37, controlMPC_W38, controlMPC_Lbyrd38, controlMPC_beta37);
controlMPC_LA_DENSE_MVMSUB1_2_2(controlMPC_Lsd37, controlMPC_yy36, controlMPC_beta37, controlMPC_bmy37);
controlMPC_LA_DENSE_FORWARDSUB_2(controlMPC_Ld37, controlMPC_bmy37, controlMPC_yy37);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld37, controlMPC_yy37, controlMPC_dvcc37);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd37, controlMPC_dvcc37, controlMPC_yy36, controlMPC_bmy36);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld36, controlMPC_bmy36, controlMPC_dvcc36);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd36, controlMPC_dvcc36, controlMPC_yy35, controlMPC_bmy35);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld35, controlMPC_bmy35, controlMPC_dvcc35);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd35, controlMPC_dvcc35, controlMPC_yy34, controlMPC_bmy34);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld34, controlMPC_bmy34, controlMPC_dvcc34);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd34, controlMPC_dvcc34, controlMPC_yy33, controlMPC_bmy33);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld33, controlMPC_bmy33, controlMPC_dvcc33);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd33, controlMPC_dvcc33, controlMPC_yy32, controlMPC_bmy32);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld32, controlMPC_bmy32, controlMPC_dvcc32);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd32, controlMPC_dvcc32, controlMPC_yy31, controlMPC_bmy31);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld31, controlMPC_bmy31, controlMPC_dvcc31);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd31, controlMPC_dvcc31, controlMPC_yy30, controlMPC_bmy30);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld30, controlMPC_bmy30, controlMPC_dvcc30);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd30, controlMPC_dvcc30, controlMPC_yy29, controlMPC_bmy29);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld29, controlMPC_bmy29, controlMPC_dvcc29);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd29, controlMPC_dvcc29, controlMPC_yy28, controlMPC_bmy28);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld28, controlMPC_bmy28, controlMPC_dvcc28);
controlMPC_LA_DENSE_MTVMSUB_2_2(controlMPC_Lsd28, controlMPC_dvcc28, controlMPC_yy27, controlMPC_bmy27);
controlMPC_LA_DENSE_BACKWARDSUB_2(controlMPC_Ld27, controlMPC_bmy27, controlMPC_dvcc27);
...
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc28, controlMPC_D01, controlMPC_dvcc27, controlMPC_grad_eq28);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc29, controlMPC_D01, controlMPC_dvcc28, controlMPC_grad_eq29);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc30, controlMPC_D01, controlMPC_dvcc29, controlMPC_grad_eq30);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc31, controlMPC_D01, controlMPC_dvcc30, controlMPC_grad_eq31);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc32, controlMPC_D01, controlMPC_dvcc31, controlMPC_grad_eq32);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc33, controlMPC_D01, controlMPC_dvcc32, controlMPC_grad_eq33);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc34, controlMPC_D01, controlMPC_dvcc33, controlMPC_grad_eq34);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc35, controlMPC_D01, controlMPC_dvcc34, controlMPC_grad_eq35);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc36, controlMPC_D01, controlMPC_dvcc35, controlMPC_grad_eq36);
controlMPC_LA_DENSE_DIAGZERO_MTVM2_2_2_2(controlMPC_C00, controlMPC_dvcc37, controlMPC_D01, controlMPC_dvcc36, controlMPC_grad_eq37);
controlMPC_LA_DIAGZERO_MTVM_2_2(controlMPC_D01, controlMPC_dvcc37, controlMPC_grad_eq38);
controlMPC_LA_VSUB_78(controlMPC_rd, controlMPC_grad_eq, controlMPC_rd);
...
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi29, controlMPC_rd29, controlMPC_dzcc29);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi30, controlMPC_rd30, controlMPC_dzcc30);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi31, controlMPC_rd31, controlMPC_dzcc31);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi32, controlMPC_rd32, controlMPC_dzcc32);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi33, controlMPC_rd33, controlMPC_dzcc33);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi34, controlMPC_rd34, controlMPC_dzcc34);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi35, controlMPC_rd35, controlMPC_dzcc35);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi36, controlMPC_rd36, controlMPC_dzcc36);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi37, controlMPC_rd37, controlMPC_dzcc37);
controlMPC_LA_DIAG_FORWARDBACKWARDSUB_2(controlMPC_Phi38, controlMPC_rd38, controlMPC_dzcc38);
...
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl29, controlMPC_slb29, controlMPC_llbbyslb29, controlMPC_dzcc29, controlMPC_lbIdx29, controlMPC_dllbcc29);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub29, controlMPC_sub29, controlMPC_lubbysub29, controlMPC_dzcc29, controlMPC_ubIdx29, controlMPC_dlubcc29);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl30, controlMPC_slb30, controlMPC_llbbyslb30, controlMPC_dzcc30, controlMPC_lbIdx30, controlMPC_dllbcc30);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub30, controlMPC_sub30, controlMPC_lubbysub30, controlMPC_dzcc30, controlMPC_ubIdx30, controlMPC_dlubcc30);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl31, controlMPC_slb31, controlMPC_llbbyslb31, controlMPC_dzcc31, controlMPC_lbIdx31, controlMPC_dllbcc31);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub31, controlMPC_sub31, controlMPC_lubbysub31, controlMPC_dzcc31, controlMPC_ubIdx31, controlMPC_dlubcc31);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl32, controlMPC_slb32, controlMPC_llbbyslb32, controlMPC_dzcc32, controlMPC_lbIdx32, controlMPC_dllbcc32);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub32, controlMPC_sub32, controlMPC_lubbysub32, controlMPC_dzcc32, controlMPC_ubIdx32, controlMPC_dlubcc32);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl33, controlMPC_slb33, controlMPC_llbbyslb33, controlMPC_dzcc33, controlMPC_lbIdx33, controlMPC_dllbcc33);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub33, controlMPC_sub33, controlMPC_lubbysub33, controlMPC_dzcc33, controlMPC_ubIdx33, controlMPC_dlubcc33);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl34, controlMPC_slb34, controlMPC_llbbyslb34, controlMPC_dzcc34, controlMPC_lbIdx34, controlMPC_dllbcc34);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub34, controlMPC_sub34, controlMPC_lubbysub34, controlMPC_dzcc34, controlMPC_ubIdx34, controlMPC_dlubcc34);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl35, controlMPC_slb35, controlMPC_llbbyslb35, controlMPC_dzcc35, controlMPC_lbIdx35, controlMPC_dllbcc35);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub35, controlMPC_sub35, controlMPC_lubbysub35, controlMPC_dzcc35, controlMPC_ubIdx35, controlMPC_dlubcc35);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl36, controlMPC_slb36, controlMPC_llbbyslb36, controlMPC_dzcc36, controlMPC_lbIdx36, controlMPC_dllbcc36);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub36, controlMPC_sub36, controlMPC_lubbysub36, controlMPC_dzcc36, controlMPC_ubIdx36, controlMPC_dlubcc36);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl37, controlMPC_slb37, controlMPC_llbbyslb37, controlMPC_dzcc37, controlMPC_lbIdx37, controlMPC_dllbcc37);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub37, controlMPC_sub37, controlMPC_lubbysub37, controlMPC_dzcc37, controlMPC_ubIdx37, controlMPC_dlubcc37);
controlMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(controlMPC_ccrhsl38, controlMPC_slb38, controlMPC_llbbyslb38, controlMPC_dzcc38, controlMPC_lbIdx38, controlMPC_dllbcc38);
controlMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(controlMPC_ccrhsub38, controlMPC_sub38, controlMPC_lubbysub38, controlMPC_dzcc38, controlMPC_ubIdx38, controlMPC_dlubcc38);
controlMPC_LA_VSUB7_156(controlMPC_l, controlMPC_ccrhs, controlMPC_s, controlMPC_dl_cc, controlMPC_ds_cc);
controlMPC_LA_VADD_78(controlMPC_dz_cc, controlMPC_dz_aff);
controlMPC_LA_VADD_76(controlMPC_dv_cc, controlMPC_dv_aff);
controlMPC_LA_VADD_156(controlMPC_dl_cc, controlMPC_dl_aff);
controlMPC_LA_VADD_156(controlMPC_ds_cc, controlMPC_ds_aff);
...
output->z30[0] = controlMPC_z29[0];
output->z30[1] = controlMPC_z29[1];
output->z31[0] = controlMPC_z30[0];
output->z31[1] = controlMPC_z30[1];
output->z32[0] = controlMPC_z31[0];
output->z32[1] = controlMPC_z31[1];
output->z33[0] = controlMPC_z32[0];
output->z33[1] = controlMPC_z32[1];
output->z34[0] = controlMPC_z33[0];
output->z34[1] = controlMPC_z33[1];
output->z35[0] = controlMPC_z34[0];
output->z35[1] = controlMPC_z34[1];
output->z36[0] = controlMPC_z35[0];
output->z36[1] = controlMPC_z35[1];
output->z37[0] = controlMPC_z36[0];
output->z37[1] = controlMPC_z36[1];
output->z38[0] = controlMPC_z37[0];
output->z38[1] = controlMPC_z37[1];
output->z39[0] = controlMPC_z38[0];
output->z39[1] = controlMPC_z38[1];
