...
while( 1 ){
info->pobj = 0;
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f01, lpMPC_z00, lpMPC_grad_cost00, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f02, lpMPC_z01, lpMPC_grad_cost01, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f03, lpMPC_z02, lpMPC_grad_cost02, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f04, lpMPC_z03, lpMPC_grad_cost03, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f05, lpMPC_z04, lpMPC_grad_cost04, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f06, lpMPC_z05, lpMPC_grad_cost05, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f07, lpMPC_z06, lpMPC_grad_cost06, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f08, lpMPC_z07, lpMPC_grad_cost07, &info->pobj);
lpMPC_LA_DIAG_QUADFCN_4(lpMPC_H00, params->f09, lpMPC_z08, lpMPC_grad_cost08, &info->pobj);
...
info->res_eq = 0;
info->dgap = 0;
lpMPC_LA_DIAGZERO_MVMSUB6_2(lpMPC_D00, lpMPC_z00, params->e01, lpMPC_v00, lpMPC_re00, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C01, lpMPC_z00, lpMPC_D01, lpMPC_z01, params->e02, lpMPC_v01, lpMPC_re01, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C02, lpMPC_z01, lpMPC_D01, lpMPC_z02, params->e03, lpMPC_v02, lpMPC_re02, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C03, lpMPC_z02, lpMPC_D01, lpMPC_z03, params->e04, lpMPC_v03, lpMPC_re03, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C04, lpMPC_z03, lpMPC_D01, lpMPC_z04, params->e05, lpMPC_v04, lpMPC_re04, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C05, lpMPC_z04, lpMPC_D01, lpMPC_z05, params->e06, lpMPC_v05, lpMPC_re05, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C06, lpMPC_z05, lpMPC_D01, lpMPC_z06, params->e07, lpMPC_v06, lpMPC_re06, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C07, lpMPC_z06, lpMPC_D01, lpMPC_z07, params->e08, lpMPC_v07, lpMPC_re07, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C08, lpMPC_z07, lpMPC_D01, lpMPC_z08, params->e09, lpMPC_v08, lpMPC_re08, &info->dgap, &info->res_eq);
lpMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_4(params->C09, lpMPC_z08, lpMPC_D01, lpMPC_z09, params->e10, lpMPC_v09, lpMPC_re09, &info->dgap, &info->res_eq);
...
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C01, lpMPC_v01, lpMPC_D00, lpMPC_v00, lpMPC_grad_eq00);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C02, lpMPC_v02, lpMPC_D01, lpMPC_v01, lpMPC_grad_eq01);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C03, lpMPC_v03, lpMPC_D01, lpMPC_v02, lpMPC_grad_eq02);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C04, lpMPC_v04, lpMPC_D01, lpMPC_v03, lpMPC_grad_eq03);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C05, lpMPC_v05, lpMPC_D01, lpMPC_v04, lpMPC_grad_eq04);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C06, lpMPC_v06, lpMPC_D01, lpMPC_v05, lpMPC_grad_eq05);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C07, lpMPC_v07, lpMPC_D01, lpMPC_v06, lpMPC_grad_eq06);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C08, lpMPC_v08, lpMPC_D01, lpMPC_v07, lpMPC_grad_eq07);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C09, lpMPC_v09, lpMPC_D01, lpMPC_v08, lpMPC_grad_eq08);
...
info->res_ineq = 0;
lpMPC_LA_VSUBADD3_4(params->lb01, lpMPC_z00, lpMPC_lbIdx00, lpMPC_llb00, lpMPC_slb00, lpMPC_rilb00, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z00, lpMPC_ubIdx00, params->ub01, lpMPC_lub00, lpMPC_sub00, lpMPC_riub00, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb02, lpMPC_z01, lpMPC_lbIdx01, lpMPC_llb01, lpMPC_slb01, lpMPC_rilb01, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z01, lpMPC_ubIdx01, params->ub02, lpMPC_lub01, lpMPC_sub01, lpMPC_riub01, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb03, lpMPC_z02, lpMPC_lbIdx02, lpMPC_llb02, lpMPC_slb02, lpMPC_rilb02, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z02, lpMPC_ubIdx02, params->ub03, lpMPC_lub02, lpMPC_sub02, lpMPC_riub02, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb04, lpMPC_z03, lpMPC_lbIdx03, lpMPC_llb03, lpMPC_slb03, lpMPC_rilb03, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z03, lpMPC_ubIdx03, params->ub04, lpMPC_lub03, lpMPC_sub03, lpMPC_riub03, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb05, lpMPC_z04, lpMPC_lbIdx04, lpMPC_llb04, lpMPC_slb04, lpMPC_rilb04, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z04, lpMPC_ubIdx04, params->ub05, lpMPC_lub04, lpMPC_sub04, lpMPC_riub04, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb06, lpMPC_z05, lpMPC_lbIdx05, lpMPC_llb05, lpMPC_slb05, lpMPC_rilb05, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z05, lpMPC_ubIdx05, params->ub06, lpMPC_lub05, lpMPC_sub05, lpMPC_riub05, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb07, lpMPC_z06, lpMPC_lbIdx06, lpMPC_llb06, lpMPC_slb06, lpMPC_rilb06, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z06, lpMPC_ubIdx06, params->ub07, lpMPC_lub06, lpMPC_sub06, lpMPC_riub06, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb08, lpMPC_z07, lpMPC_lbIdx07, lpMPC_llb07, lpMPC_slb07, lpMPC_rilb07, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z07, lpMPC_ubIdx07, params->ub08, lpMPC_lub07, lpMPC_sub07, lpMPC_riub07, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD3_4(params->lb09, lpMPC_z08, lpMPC_lbIdx08, lpMPC_llb08, lpMPC_slb08, lpMPC_rilb08, &info->dgap, &info->res_ineq);
lpMPC_LA_VSUBADD2_4(lpMPC_z08, lpMPC_ubIdx08, params->ub09, lpMPC_lub08, lpMPC_sub08, lpMPC_riub08, &info->dgap, &info->res_ineq);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi00, params->C01, lpMPC_V00);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi01, params->C02, lpMPC_V01);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi02, params->C03, lpMPC_V02);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi03, params->C04, lpMPC_V03);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi04, params->C05, lpMPC_V04);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi05, params->C06, lpMPC_V05);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi06, params->C07, lpMPC_V06);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi07, params->C08, lpMPC_V07);
...
lpMPC_LA_DIAG_MATRIXFORWARDSUB_2_4(lpMPC_Phi08, params->C09, lpMPC_V08);
...
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C01, lpMPC_dvaff01, lpMPC_D00, lpMPC_dvaff00, lpMPC_grad_eq00);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C02, lpMPC_dvaff02, lpMPC_D01, lpMPC_dvaff01, lpMPC_grad_eq01);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C03, lpMPC_dvaff03, lpMPC_D01, lpMPC_dvaff02, lpMPC_grad_eq02);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C04, lpMPC_dvaff04, lpMPC_D01, lpMPC_dvaff03, lpMPC_grad_eq03);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C05, lpMPC_dvaff05, lpMPC_D01, lpMPC_dvaff04, lpMPC_grad_eq04);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C06, lpMPC_dvaff06, lpMPC_D01, lpMPC_dvaff05, lpMPC_grad_eq05);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C07, lpMPC_dvaff07, lpMPC_D01, lpMPC_dvaff06, lpMPC_grad_eq06);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C08, lpMPC_dvaff08, lpMPC_D01, lpMPC_dvaff07, lpMPC_grad_eq07);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C09, lpMPC_dvaff09, lpMPC_D01, lpMPC_dvaff08, lpMPC_grad_eq08);
...
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C01, lpMPC_dvcc01, lpMPC_D00, lpMPC_dvcc00, lpMPC_grad_eq00);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C02, lpMPC_dvcc02, lpMPC_D01, lpMPC_dvcc01, lpMPC_grad_eq01);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C03, lpMPC_dvcc03, lpMPC_D01, lpMPC_dvcc02, lpMPC_grad_eq02);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C04, lpMPC_dvcc04, lpMPC_D01, lpMPC_dvcc03, lpMPC_grad_eq03);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C05, lpMPC_dvcc05, lpMPC_D01, lpMPC_dvcc04, lpMPC_grad_eq04);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C06, lpMPC_dvcc06, lpMPC_D01, lpMPC_dvcc05, lpMPC_grad_eq05);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C07, lpMPC_dvcc07, lpMPC_D01, lpMPC_dvcc06, lpMPC_grad_eq06);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C08, lpMPC_dvcc08, lpMPC_D01, lpMPC_dvcc07, lpMPC_grad_eq07);
lpMPC_LA_DENSE_DIAGZERO_MTVM2_2_4_2(params->C09, lpMPC_dvcc09, lpMPC_D01, lpMPC_dvcc08, lpMPC_grad_eq08);
