...
typedef struct plattMPC_params
{
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb1[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub1[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb2[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub2[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb3[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub3[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb4[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub4[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb5[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub5[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb6[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub6[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb7[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub7[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb8[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub8[8];
    ...
    /* vector of size 8 */
    plattMPC_FLOAT lb9[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub9[8];

    /* diagonal matrix of size [8 x 8] (only the diagonal is stored) */
    plattMPC_FLOAT H10[8];

    /* vector of size 8 */
    plattMPC_FLOAT f10[8];

    /* vector of size 8 */
    plattMPC_FLOAT lb10[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub10[8];

    /* diagonal matrix of size [8 x 8] (only the diagonal is stored) */
    plattMPC_FLOAT H11[8];

    /* vector of size 8 */
    plattMPC_FLOAT f11[8];

    /* vector of size 8 */
    plattMPC_FLOAT lb11[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub11[8];

    /* diagonal matrix of size [8 x 8] (only the diagonal is stored) */
    plattMPC_FLOAT H12[8];

    /* vector of size 8 */
    plattMPC_FLOAT f12[8];

    /* vector of size 8 */
    plattMPC_FLOAT lb12[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub12[8];

    /* diagonal matrix of size [8 x 8] (only the diagonal is stored) */
    plattMPC_FLOAT H13[8];

    /* vector of size 8 */
    plattMPC_FLOAT f13[8];

    /* vector of size 8 */
    plattMPC_FLOAT lb13[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub13[8];

    /* diagonal matrix of size [8 x 8] (only the diagonal is stored) */
    plattMPC_FLOAT H14[8];

    /* vector of size 8 */
    plattMPC_FLOAT f14[8];

    /* vector of size 8 */
    plattMPC_FLOAT lb14[8];

    /* vector of size 8 */
    plattMPC_FLOAT ub14[8];

    /* diagonal matrix of size [6 x 6] (only the diagonal is stored) */
    plattMPC_FLOAT H15[6];

    /* vector of size 6 */
    plattMPC_FLOAT f15[6];

    /* vector of size 6 */
    plattMPC_FLOAT lb15[6];

    /* vector of size 6 */
    plattMPC_FLOAT ub15[6];
...
typedef struct plattMPC_output
{
    ...
    /* vector of size 8 */
    plattMPC_FLOAT z10[8];

    /* vector of size 8 */
    plattMPC_FLOAT z11[8];

    /* vector of size 8 */
    plattMPC_FLOAT z12[8];

    /* vector of size 8 */
    plattMPC_FLOAT z13[8];

    /* vector of size 8 */
    plattMPC_FLOAT z14[8];

    /* vector of size 6 */
    plattMPC_FLOAT z15[6];
