...
#include "../include/beliefPenaltyMPC.h"
...
/*
 * Initializes a vector of length 328 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_328(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<328; i++ )
	{
 ...
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_100(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<100; i++ )
	{
...
/*
 * Initializes a vector of length 466 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_466(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<466; i++ )
	{
 ...
 * This function is for vectors of length 466.
 */
void beliefPenaltyMPC_LA_DOTACC_466(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<466; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 328.
 */
void beliefPenaltyMPC_LA_VVADD3_328(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT *w, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<328; i++ ){
		z[i] = u[i] + v[i] + w[i];
...
/*
 * Vector subtraction z = -x - y for vectors of length 328.
 */
void beliefPenaltyMPC_LA_VSUB2_328(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<328; i++){
		z[i] = -x[i] - y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_AFFINE(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (beliefPenaltyMPC_FLOAT)466;
    return lsIt;
}
...
*  and x,u,v are vectors of length 466.
 */
void beliefPenaltyMPC_LA_VSUB5_466(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT a, beliefPenaltyMPC_FLOAT *x)
{
	int i;
	for( i=0; i<466; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 328.
 */
void beliefPenaltyMPC_LA_VSUB_328(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<328; i++){
		z[i] = x[i] - y[i];
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 466.
 */
void beliefPenaltyMPC_LA_VSUB7_466(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *r, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<466; i++){
...
/*
 * Vector addition x = x + y for vectors of length 328.
 */
void beliefPenaltyMPC_LA_VADD_328(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<328; i++){
		x[i] += y[i];
 ...
 */
void beliefPenaltyMPC_LA_VADD_100(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<100; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 466.
 */
void beliefPenaltyMPC_LA_VADD_466(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<466; i++){
		x[i] += y[i];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_z[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_v[100];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_aff[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_aff[100];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_cost[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_eq[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_rd[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_l[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_s[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_lbys[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_aff[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_aff[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_cc[328];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_cc[100];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_cc[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_cc[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ccrhs[466];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_grad_ineq[328];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_H19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 2.0000000000000000E+001, 2.0000000000000000E+001, 2.0000000000000000E+001};
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_f19[5] = {0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000, 0.0000000000000000E+000};
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Lbyrd19[5];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ctv19[5];
int beliefPenaltyMPC_lbIdx19[5] = {0, 1, 2, 3, 4};
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_rilb19[5];
...
int beliefPenaltyMPC_ubIdx19[5] = {0, 1, 2, 3, 4};
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lub19 = beliefPenaltyMPC_l + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_sub19 = beliefPenaltyMPC_s + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_lubbysub19 = beliefPenaltyMPC_lbys + 461;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_riub19[5];
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlubaff19 = beliefPenaltyMPC_dl_aff + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsubaff19 = beliefPenaltyMPC_ds_aff + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dlubcc19 = beliefPenaltyMPC_dl_cc + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dsubcc19 = beliefPenaltyMPC_ds_cc + 461;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_ccrhsub19 = beliefPenaltyMPC_ccrhs + 461;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Phi19[5];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_D19[5] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_W19[5];
...
info->it = 0;
beliefPenaltyMPC_LA_INITIALIZEVECTOR_328(beliefPenaltyMPC_z, 0);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_100(beliefPenaltyMPC_v, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_466(beliefPenaltyMPC_l, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_466(beliefPenaltyMPC_s, 1);
info->mu = 0;
beliefPenaltyMPC_LA_DOTACC_466(beliefPenaltyMPC_l, beliefPenaltyMPC_s, &info->mu);
info->mu /= 466;
while( 1 ){
info->pobj = 0;
...
beliefPenaltyMPC_LA_DIAG_QUADFCN_5(beliefPenaltyMPC_H19, beliefPenaltyMPC_f19, beliefPenaltyMPC_z19, beliefPenaltyMPC_grad_cost19, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MVMSUB3_5_17_5(params->C19, beliefPenaltyMPC_z18, beliefPenaltyMPC_D19, beliefPenaltyMPC_z19, params->e19, beliefPenaltyMPC_v18, beliefPenaltyMPC_re18, &info->dgap, &info->res_eq);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D19, beliefPenaltyMPC_v18, beliefPenaltyMPC_grad_eq19);
info->res_ineq = 0;
...
beliefPenaltyMPC_LA_VSUBADD3_5(params->lb20, beliefPenaltyMPC_z19, beliefPenaltyMPC_lbIdx19, beliefPenaltyMPC_llb19, beliefPenaltyMPC_slb19, beliefPenaltyMPC_rilb19, &info->dgap, &info->res_ineq);
beliefPenaltyMPC_LA_VSUBADD2_5(beliefPenaltyMPC_z19, beliefPenaltyMPC_ubIdx19, params->ub20, beliefPenaltyMPC_lub19, beliefPenaltyMPC_sub19, beliefPenaltyMPC_riub19, &info->dgap, &info->res_ineq);
...
beliefPenaltyMPC_LA_VVADD3_328(beliefPenaltyMPC_grad_cost, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_grad_ineq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_CHOL_ONELOOP_LBUB_5_5_5(beliefPenaltyMPC_H19, beliefPenaltyMPC_llbbyslb19, beliefPenaltyMPC_lbIdx19, beliefPenaltyMPC_lubbysub19, beliefPenaltyMPC_ubIdx19, beliefPenaltyMPC_Phi19);
beliefPenaltyMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_5_5(beliefPenaltyMPC_Phi19, beliefPenaltyMPC_D19, beliefPenaltyMPC_W19);
beliefPenaltyMPC_LA_DIAG_FORWARDSUB_5(beliefPenaltyMPC_Phi19, beliefPenaltyMPC_rd19, beliefPenaltyMPC_Lbyrd19);
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MMT2_5_17_5(beliefPenaltyMPC_V18, beliefPenaltyMPC_W19, beliefPenaltyMPC_Yd18);
beliefPenaltyMPC_LA_DENSE_DIAGZERO_2MVMSUB2_5_17_5(beliefPenaltyMPC_V18, beliefPenaltyMPC_Lbyrd18, beliefPenaltyMPC_W19, beliefPenaltyMPC_Lbyrd19, beliefPenaltyMPC_re18, beliefPenaltyMPC_beta18);
...
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_5(beliefPenaltyMPC_Ld18, beliefPenaltyMPC_yy18, beliefPenaltyMPC_dvaff18);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D19, beliefPenaltyMPC_dvaff18, beliefPenaltyMPC_grad_eq19);
beliefPenaltyMPC_LA_VSUB2_328(beliefPenaltyMPC_rd, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefPenaltyMPC_Phi19, beliefPenaltyMPC_rd19, beliefPenaltyMPC_dzaff19);
...
beliefPenaltyMPC_LA_VSUB_INDEXED_5(beliefPenaltyMPC_dzaff19, beliefPenaltyMPC_lbIdx19, beliefPenaltyMPC_rilb19, beliefPenaltyMPC_dslbaff19);
beliefPenaltyMPC_LA_VSUB3_5(beliefPenaltyMPC_llbbyslb19, beliefPenaltyMPC_dslbaff19, beliefPenaltyMPC_llb19, beliefPenaltyMPC_dllbaff19);
beliefPenaltyMPC_LA_VSUB2_INDEXED_5(beliefPenaltyMPC_riub19, beliefPenaltyMPC_dzaff19, beliefPenaltyMPC_ubIdx19, beliefPenaltyMPC_dsubaff19);
beliefPenaltyMPC_LA_VSUB3_5(beliefPenaltyMPC_lubbysub19, beliefPenaltyMPC_dsubaff19, beliefPenaltyMPC_lub19, beliefPenaltyMPC_dlubaff19);
...
beliefPenaltyMPC_LA_VSUB5_466(beliefPenaltyMPC_ds_aff, beliefPenaltyMPC_dl_aff, musigma, beliefPenaltyMPC_ccrhs);
...
beliefPenaltyMPC_LA_DENSE_MVMSUB1_5_5(beliefPenaltyMPC_Lsd17, beliefPenaltyMPC_yy16, beliefPenaltyMPC_beta17, beliefPenaltyMPC_bmy17);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_5(beliefPenaltyMPC_Ld17, beliefPenaltyMPC_bmy17, beliefPenaltyMPC_yy17);
beliefPenaltyMPC_LA_VSUB6_INDEXED_5_5_5(beliefPenaltyMPC_ccrhsub19, beliefPenaltyMPC_sub19, beliefPenaltyMPC_ubIdx19, beliefPenaltyMPC_ccrhsl19, beliefPenaltyMPC_slb19, beliefPenaltyMPC_lbIdx19, beliefPenaltyMPC_rd19);
beliefPenaltyMPC_LA_DIAG_FORWARDSUB_5(beliefPenaltyMPC_Phi19, beliefPenaltyMPC_rd19, beliefPenaltyMPC_Lbyrd19);
beliefPenaltyMPC_LA_DENSE_DIAGZERO_2MVMADD_5_17_5(beliefPenaltyMPC_V18, beliefPenaltyMPC_Lbyrd18, beliefPenaltyMPC_W19, beliefPenaltyMPC_Lbyrd19, beliefPenaltyMPC_beta18);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_5_5(beliefPenaltyMPC_Lsd18, beliefPenaltyMPC_yy17, beliefPenaltyMPC_beta18, beliefPenaltyMPC_bmy18);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_5(beliefPenaltyMPC_Ld18, beliefPenaltyMPC_bmy18, beliefPenaltyMPC_yy18);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_5(beliefPenaltyMPC_Ld18, beliefPenaltyMPC_yy18, beliefPenaltyMPC_dvcc18);
...
beliefPenaltyMPC_LA_DIAGZERO_MTVM_5_5(beliefPenaltyMPC_D19, beliefPenaltyMPC_dvcc18, beliefPenaltyMPC_grad_eq19);
beliefPenaltyMPC_LA_VSUB_328(beliefPenaltyMPC_rd, beliefPenaltyMPC_grad_eq, beliefPenaltyMPC_rd);
...
beliefPenaltyMPC_LA_DIAG_FORWARDBACKWARDSUB_5(beliefPenaltyMPC_Phi19, beliefPenaltyMPC_rd19, beliefPenaltyMPC_dzcc19);
...
beliefPenaltyMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_5(beliefPenaltyMPC_ccrhsl19, beliefPenaltyMPC_slb19, beliefPenaltyMPC_llbbyslb19, beliefPenaltyMPC_dzcc19, beliefPenaltyMPC_lbIdx19, beliefPenaltyMPC_dllbcc19);
beliefPenaltyMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_5(beliefPenaltyMPC_ccrhsub19, beliefPenaltyMPC_sub19, beliefPenaltyMPC_lubbysub19, beliefPenaltyMPC_dzcc19, beliefPenaltyMPC_ubIdx19, beliefPenaltyMPC_dlubcc19);
beliefPenaltyMPC_LA_VSUB7_466(beliefPenaltyMPC_l, beliefPenaltyMPC_ccrhs, beliefPenaltyMPC_s, beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_ds_cc);
beliefPenaltyMPC_LA_VADD_328(beliefPenaltyMPC_dz_cc, beliefPenaltyMPC_dz_aff);
beliefPenaltyMPC_LA_VADD_100(beliefPenaltyMPC_dv_cc, beliefPenaltyMPC_dv_aff);
beliefPenaltyMPC_LA_VADD_466(beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_dl_aff);
beliefPenaltyMPC_LA_VADD_466(beliefPenaltyMPC_ds_cc, beliefPenaltyMPC_ds_aff);
