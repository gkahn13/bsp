...
/*
 * Initializes a vector of length 212 with a value.
 */
void trajMPC_LA_INITIALIZEVECTOR_212(trajMPC_FLOAT* vec, trajMPC_FLOAT value)
{
	int i;
	for( i=0; i<212; i++ )
	{
 ...
 */
void trajMPC_LA_INITIALIZEVECTOR_60(trajMPC_FLOAT* vec, trajMPC_FLOAT value)
{
	int i;
	for( i=0; i<60; i++ )
	{
...
/*
 * Initializes a vector of length 310 with a value.
 */
void trajMPC_LA_INITIALIZEVECTOR_310(trajMPC_FLOAT* vec, trajMPC_FLOAT value)
{
	int i;
	for( i=0; i<310; i++ )
	{
 ...
 * This function is for vectors of length 310.
 */
void trajMPC_LA_DOTACC_310(trajMPC_FLOAT *x, trajMPC_FLOAT *y, trajMPC_FLOAT *z)
{
	int i;
	for( i=0; i<310; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 212.
 */
void trajMPC_LA_VVADD3_212(trajMPC_FLOAT *u, trajMPC_FLOAT *v, trajMPC_FLOAT *w, trajMPC_FLOAT *z)
{
	int i;
	for( i=0; i<212; i++ ){
		z[i] = u[i] + v[i] + w[i];
...
/*
 * Vector subtraction z = -x - y for vectors of length 212.
 */
void trajMPC_LA_VSUB2_212(trajMPC_FLOAT *x, trajMPC_FLOAT *y, trajMPC_FLOAT *z)
{
	int i;
	for( i=0; i<212; i++){
		z[i] = -x[i] - y[i];
...
*  and x,u,v are vectors of length 310.
 */
void trajMPC_LA_VSUB5_310(trajMPC_FLOAT *u, trajMPC_FLOAT *v, trajMPC_FLOAT a, trajMPC_FLOAT *x)
{
	int i;
	for( i=0; i<310; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 212.
 */
void trajMPC_LA_VSUB_212(trajMPC_FLOAT *x, trajMPC_FLOAT *y, trajMPC_FLOAT *z)
{
	int i;
	for( i=0; i<212; i++){
		z[i] = x[i] - y[i];
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 310.
 */
void trajMPC_LA_VSUB7_310(trajMPC_FLOAT *l, trajMPC_FLOAT *r, trajMPC_FLOAT *s, trajMPC_FLOAT *dl, trajMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<310; i++){
...
/*
 * Vector addition x = x + y for vectors of length 212.
 */
void trajMPC_LA_VADD_212(trajMPC_FLOAT *x, trajMPC_FLOAT *y)
{
	int i;
	for( i=0; i<212; i++){
		x[i] += y[i];
 ...
 */
void trajMPC_LA_VADD_60(trajMPC_FLOAT *x, trajMPC_FLOAT *y)
{
	int i;
	for( i=0; i<60; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 310.
 */
void trajMPC_LA_VADD_310(trajMPC_FLOAT *x, trajMPC_FLOAT *y)
{
	int i;
	for( i=0; i<310; i++){
		x[i] += y[i];
...
trajMPC_FLOAT trajMPC_z[212];
trajMPC_FLOAT trajMPC_v[60];
trajMPC_FLOAT trajMPC_dz_aff[212];
trajMPC_FLOAT trajMPC_dv_aff[60];
trajMPC_FLOAT trajMPC_grad_cost[212];
trajMPC_FLOAT trajMPC_grad_eq[212];
trajMPC_FLOAT trajMPC_rd[212];
trajMPC_FLOAT trajMPC_l[310];
trajMPC_FLOAT trajMPC_s[310];
trajMPC_FLOAT trajMPC_lbys[310];
trajMPC_FLOAT trajMPC_dl_aff[310];
trajMPC_FLOAT trajMPC_ds_aff[310];
trajMPC_FLOAT trajMPC_dz_cc[212];
trajMPC_FLOAT trajMPC_dv_cc[60];
trajMPC_FLOAT trajMPC_dl_cc[310];
trajMPC_FLOAT trajMPC_ds_cc[310];
trajMPC_FLOAT trajMPC_ccrhs[310];
trajMPC_FLOAT trajMPC_grad_ineq[212];
...
trajMPC_FLOAT trajMPC_H19[3] = {2.0000000000000000E+001, 2.0000000000000000E+001, 0.0000000000000000E+000};
...
trajMPC_FLOAT trajMPC_Lbyrd19[3];
...
trajMPC_FLOAT trajMPC_rilb19[3];
...
int trajMPC_ubIdx19[3] = {0, 1, 2};
trajMPC_FLOAT* trajMPC_lub19 = trajMPC_l + 307;
trajMPC_FLOAT* trajMPC_sub19 = trajMPC_s + 307;
trajMPC_FLOAT* trajMPC_lubbysub19 = trajMPC_lbys + 307;
trajMPC_FLOAT trajMPC_riub19[3];
trajMPC_FLOAT* trajMPC_dlubaff19 = trajMPC_dl_aff + 307;
trajMPC_FLOAT* trajMPC_dsubaff19 = trajMPC_ds_aff + 307;
trajMPC_FLOAT* trajMPC_dlubcc19 = trajMPC_dl_cc + 307;
trajMPC_FLOAT* trajMPC_dsubcc19 = trajMPC_ds_cc + 307;
trajMPC_FLOAT* trajMPC_ccrhsub19 = trajMPC_ccrhs + 307;
trajMPC_FLOAT trajMPC_Phi19[3];
trajMPC_FLOAT trajMPC_D19[3] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000, 
-1.0000000000000000E+000};
trajMPC_FLOAT trajMPC_W19[3];
...
info->it = 0;
trajMPC_LA_INITIALIZEVECTOR_212(trajMPC_z, 0);
trajMPC_LA_INITIALIZEVECTOR_60(trajMPC_v, 1);
trajMPC_LA_INITIALIZEVECTOR_310(trajMPC_l, 1);
trajMPC_LA_INITIALIZEVECTOR_310(trajMPC_s, 1);
info->mu = 0;
trajMPC_LA_DOTACC_310(trajMPC_l, trajMPC_s, &info->mu);
info->mu /= 310;
while( 1 ){
info->pobj = 0;
...
trajMPC_LA_DIAG_QUADFCN_3(trajMPC_H19, params->f20, trajMPC_z19, trajMPC_grad_cost19, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
trajMPC_LA_DENSE_DIAGZERO_MVMSUB3_3_11_3(params->C19, trajMPC_z18, trajMPC_D19, trajMPC_z19, params->e20, trajMPC_v19, trajMPC_re19, &info->dgap, &info->res_eq);
...
trajMPC_LA_DIAGZERO_MTVM_3_3(trajMPC_D19, trajMPC_v19, trajMPC_grad_eq19);
info->res_ineq = 0;
...
trajMPC_LA_VSUBADD3_3(params->lb20, trajMPC_z19, trajMPC_lbIdx19, trajMPC_llb19, trajMPC_slb19, trajMPC_rilb19, &info->dgap, &info->res_ineq);
trajMPC_LA_VSUBADD2_3(trajMPC_z19, trajMPC_ubIdx19, params->ub20, trajMPC_lub19, trajMPC_sub19, trajMPC_riub19, &info->dgap, &info->res_ineq);
...
trajMPC_LA_INEQ_B_GRAD_3_3_3(trajMPC_lub19, trajMPC_sub19, trajMPC_riub19, trajMPC_llb19, trajMPC_slb19, trajMPC_rilb19, trajMPC_lbIdx19, trajMPC_ubIdx19, trajMPC_grad_ineq19, trajMPC_lubbysub19, trajMPC_llbbyslb19);
...
trajMPC_LA_VVADD3_212(trajMPC_grad_cost, trajMPC_grad_eq, trajMPC_grad_ineq, trajMPC_rd);
...
trajMPC_LA_DIAG_CHOL_ONELOOP_LBUB_3_3_3(trajMPC_H19, trajMPC_llbbyslb19, trajMPC_lbIdx19, trajMPC_lubbysub19, trajMPC_ubIdx19, trajMPC_Phi19);
trajMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_3_3(trajMPC_Phi19, trajMPC_D19, trajMPC_W19);
trajMPC_LA_DIAG_FORWARDSUB_3(trajMPC_Phi19, trajMPC_rd19, trajMPC_Lbyrd19);
...
trajMPC_LA_DENSE_DIAGZERO_MMT2_3_11_3(trajMPC_V18, trajMPC_W19, trajMPC_Yd19);
trajMPC_LA_DENSE_DIAGZERO_2MVMSUB2_3_11_3(trajMPC_V18, trajMPC_Lbyrd18, trajMPC_W19, trajMPC_Lbyrd19, trajMPC_re19, trajMPC_beta19);
...
trajMPC_LA_DENSE_BACKWARDSUB_3(trajMPC_Ld19, trajMPC_yy19, trajMPC_dvaff19);
...
trajMPC_LA_DIAGZERO_MTVM_3_3(trajMPC_D19, trajMPC_dvaff19, trajMPC_grad_eq19);
trajMPC_LA_VSUB2_212(trajMPC_rd, trajMPC_grad_eq, trajMPC_rd);
...
trajMPC_LA_DIAG_FORWARDBACKWARDSUB_3(trajMPC_Phi19, trajMPC_rd19, trajMPC_dzaff19);
...
trajMPC_LA_VSUB_INDEXED_3(trajMPC_dzaff19, trajMPC_lbIdx19, trajMPC_rilb19, trajMPC_dslbaff19);
trajMPC_LA_VSUB3_3(trajMPC_llbbyslb19, trajMPC_dslbaff19, trajMPC_llb19, trajMPC_dllbaff19);
trajMPC_LA_VSUB2_INDEXED_3(trajMPC_riub19, trajMPC_dzaff19, trajMPC_ubIdx19, trajMPC_dsubaff19);
trajMPC_LA_VSUB3_3(trajMPC_lubbysub19, trajMPC_dsubaff19, trajMPC_lub19, trajMPC_dlubaff19);
...
trajMPC_LA_VSUB5_310(trajMPC_ds_aff, trajMPC_dl_aff, musigma, trajMPC_ccrhs);
...
trajMPC_LA_DENSE_MVMSUB1_3_3(trajMPC_Lsd18, trajMPC_yy17, trajMPC_beta18, trajMPC_bmy18);
trajMPC_LA_DENSE_FORWARDSUB_3(trajMPC_Ld18, trajMPC_bmy18, trajMPC_yy18);
trajMPC_LA_VSUB6_INDEXED_3_3_3(trajMPC_ccrhsub19, trajMPC_sub19, trajMPC_ubIdx19, trajMPC_ccrhsl19, trajMPC_slb19, trajMPC_lbIdx19, trajMPC_rd19);
trajMPC_LA_DIAG_FORWARDSUB_3(trajMPC_Phi19, trajMPC_rd19, trajMPC_Lbyrd19);
trajMPC_LA_DENSE_DIAGZERO_2MVMADD_3_11_3(trajMPC_V18, trajMPC_Lbyrd18, trajMPC_W19, trajMPC_Lbyrd19, trajMPC_beta19);
trajMPC_LA_DENSE_MVMSUB1_3_3(trajMPC_Lsd19, trajMPC_yy18, trajMPC_beta19, trajMPC_bmy19);
trajMPC_LA_DENSE_FORWARDSUB_3(trajMPC_Ld19, trajMPC_bmy19, trajMPC_yy19);
trajMPC_LA_DENSE_BACKWARDSUB_3(trajMPC_Ld19, trajMPC_yy19, trajMPC_dvcc19);
...
trajMPC_LA_DIAGZERO_MTVM_3_3(trajMPC_D19, trajMPC_dvcc19, trajMPC_grad_eq19);
trajMPC_LA_VSUB_212(trajMPC_rd, trajMPC_grad_eq, trajMPC_rd);
...
trajMPC_LA_DIAG_FORWARDBACKWARDSUB_3(trajMPC_Phi19, trajMPC_rd19, trajMPC_dzcc19);
...
trajMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_3(trajMPC_ccrhsl19, trajMPC_slb19, trajMPC_llbbyslb19, trajMPC_dzcc19, trajMPC_lbIdx19, trajMPC_dllbcc19);
trajMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_3(trajMPC_ccrhsub19, trajMPC_sub19, trajMPC_lubbysub19, trajMPC_dzcc19, trajMPC_ubIdx19, trajMPC_dlubcc19);
trajMPC_LA_VSUB7_310(trajMPC_l, trajMPC_ccrhs, trajMPC_s, trajMPC_dl_cc, trajMPC_ds_cc);
trajMPC_LA_VADD_212(trajMPC_dz_cc, trajMPC_dz_aff);
trajMPC_LA_VADD_60(trajMPC_dv_cc, trajMPC_dv_aff);
trajMPC_LA_VADD_310(trajMPC_dl_cc, trajMPC_dl_aff);
trajMPC_LA_VADD_310(trajMPC_ds_cc, trajMPC_ds_aff);
