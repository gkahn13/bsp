...
typedef struct stateMPC_params
{
    ...
    /* diagonal matrix of size [29 x 29] (only the diagonal is stored) */
    stateMPC_FLOAT H15[29];

    /* vector of size 29 */
    stateMPC_FLOAT f15[29];

    /* vector of size 29 */
    stateMPC_FLOAT lb15[29];

    /* vector of size 11 */
    stateMPC_FLOAT ub15[11];

    /* matrix of size [9 x 29] (column major format) */
    stateMPC_FLOAT C15[261];

    /* vector of size 9 */
    stateMPC_FLOAT e15[9];

    /* diagonal matrix of size [29 x 29] (only the diagonal is stored) */
    stateMPC_FLOAT H16[29];

    /* vector of size 29 */
    stateMPC_FLOAT f16[29];

    /* vector of size 29 */
    stateMPC_FLOAT lb16[29];

    /* vector of size 11 */
    stateMPC_FLOAT ub16[11];

    /* matrix of size [9 x 29] (column major format) */
    stateMPC_FLOAT C16[261];

    /* vector of size 9 */
    stateMPC_FLOAT e16[9];

    /* diagonal matrix of size [29 x 29] (only the diagonal is stored) */
    stateMPC_FLOAT H17[29];

    /* vector of size 29 */
    stateMPC_FLOAT f17[29];

    /* vector of size 29 */
    stateMPC_FLOAT lb17[29];

    /* vector of size 11 */
    stateMPC_FLOAT ub17[11];

    /* matrix of size [9 x 29] (column major format) */
    stateMPC_FLOAT C17[261];

    /* vector of size 9 */
    stateMPC_FLOAT e17[9];

    /* diagonal matrix of size [29 x 29] (only the diagonal is stored) */
    stateMPC_FLOAT H18[29];

    /* vector of size 29 */
    stateMPC_FLOAT f18[29];

    /* vector of size 29 */
    stateMPC_FLOAT lb18[29];

    /* vector of size 11 */
    stateMPC_FLOAT ub18[11];

    /* matrix of size [9 x 29] (column major format) */
    stateMPC_FLOAT C18[261];

    /* vector of size 9 */
    stateMPC_FLOAT e18[9];

    /* diagonal matrix of size [29 x 29] (only the diagonal is stored) */
    stateMPC_FLOAT H19[29];

    /* vector of size 29 */
    stateMPC_FLOAT f19[29];

    /* vector of size 29 */
    stateMPC_FLOAT lb19[29];

    /* vector of size 11 */
    stateMPC_FLOAT ub19[11];

    /* matrix of size [9 x 29] (column major format) */
    stateMPC_FLOAT C19[261];

    /* vector of size 9 */
    stateMPC_FLOAT e19[9];

    /* diagonal matrix of size [9 x 9] (only the diagonal is stored) */
    stateMPC_FLOAT H20[9];

    /* vector of size 9 */
    stateMPC_FLOAT f20[9];

    /* vector of size 9 */
    stateMPC_FLOAT lb20[9];

    /* vector of size 9 */
    stateMPC_FLOAT ub20[9];

    /* vector of size 9 */
    stateMPC_FLOAT e20[9];
...
typedef struct stateMPC_output
{
    ...
    /* vector of size 11 */
    stateMPC_FLOAT z15[11];

    /* vector of size 11 */
    stateMPC_FLOAT z16[11];

    /* vector of size 11 */
    stateMPC_FLOAT z17[11];

    /* vector of size 11 */
    stateMPC_FLOAT z18[11];

    /* vector of size 11 */
    stateMPC_FLOAT z19[11];
