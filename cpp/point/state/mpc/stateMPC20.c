 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_78(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<78; i++ )
	{
 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_40(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<40; i++ )
	{
 ...
 */
void stateMPC_LA_INITIALIZEVECTOR_156(stateMPC_FLOAT* vec, stateMPC_FLOAT value)
{
	int i;
	for( i=0; i<156; i++ )
	{
 ...
 */
void stateMPC_LA_DOTACC_156(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<156; i++ ){
		*z += x[i]*y[i];
 ...
 * of length 78.
 */
void stateMPC_LA_VVADD3_78(stateMPC_FLOAT *u, stateMPC_FLOAT *v, stateMPC_FLOAT *w, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++ ){
		z[i] = u[i] + v[i] + w[i];
 ...
 */
void stateMPC_LA_VSUB2_78(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++){
		z[i] = -x[i] - y[i];
...
int stateMPC_LINESEARCH_BACKTRACKING_AFFINE(stateMPC_FLOAT *l, stateMPC_FLOAT *s, stateMPC_FLOAT *dl, stateMPC_FLOAT *ds, stateMPC_FLOAT *a, stateMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (stateMPC_FLOAT)156;
    return lsIt;
}
 ...
 */
void stateMPC_LA_VSUB5_156(stateMPC_FLOAT *u, stateMPC_FLOAT *v, stateMPC_FLOAT a, stateMPC_FLOAT *x)
{
	int i;
	for( i=0; i<156; i++){
		x[i] = u[i]*v[i] - a;
 ...
 * Vector subtraction z = x - y for vectors of length 78.
 */
void stateMPC_LA_VSUB_78(stateMPC_FLOAT *x, stateMPC_FLOAT *y, stateMPC_FLOAT *z)
{
	int i;
	for( i=0; i<78; i++){
		z[i] = x[i] - y[i];
 ...
 */
void stateMPC_LA_VSUB7_156(stateMPC_FLOAT *l, stateMPC_FLOAT *r, stateMPC_FLOAT *s, stateMPC_FLOAT *dl, stateMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<156; i++){
 ...
 */
void stateMPC_LA_VADD_78(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<78; i++){
		x[i] += y[i];
 ...
 */
void stateMPC_LA_VADD_40(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<40; i++){
		x[i] += y[i];
 ...
 */
void stateMPC_LA_VADD_156(stateMPC_FLOAT *x, stateMPC_FLOAT *y)
{
	int i;
	for( i=0; i<156; i++){
		x[i] += y[i];
...
stateMPC_FLOAT stateMPC_z[78];
stateMPC_FLOAT stateMPC_v[40];
stateMPC_FLOAT stateMPC_dz_aff[78];
stateMPC_FLOAT stateMPC_dv_aff[40];
stateMPC_FLOAT stateMPC_grad_cost[78];
stateMPC_FLOAT stateMPC_grad_eq[78];
stateMPC_FLOAT stateMPC_rd[78];
stateMPC_FLOAT stateMPC_l[156];
stateMPC_FLOAT stateMPC_s[156];
stateMPC_FLOAT stateMPC_lbys[156];
stateMPC_FLOAT stateMPC_dl_aff[156];
stateMPC_FLOAT stateMPC_ds_aff[156];
stateMPC_FLOAT stateMPC_dz_cc[78];
stateMPC_FLOAT stateMPC_dv_cc[40];
stateMPC_FLOAT stateMPC_dl_cc[156];
stateMPC_FLOAT stateMPC_ds_cc[156];
stateMPC_FLOAT stateMPC_ccrhs[156];
stateMPC_FLOAT stateMPC_grad_ineq[78];
...
stateMPC_FLOAT stateMPC_Lbyrd19[2];
...
stateMPC_FLOAT stateMPC_ctv19[2];
...
stateMPC_FLOAT stateMPC_rilb19[2];
...
int stateMPC_ubIdx19[2] = {0, 1};
stateMPC_FLOAT* stateMPC_lub19 = stateMPC_l + 154;
stateMPC_FLOAT* stateMPC_sub19 = stateMPC_s + 154;
stateMPC_FLOAT* stateMPC_lubbysub19 = stateMPC_lbys + 154;
stateMPC_FLOAT stateMPC_riub19[2];
stateMPC_FLOAT* stateMPC_dlubaff19 = stateMPC_dl_aff + 154;
stateMPC_FLOAT* stateMPC_dsubaff19 = stateMPC_ds_aff + 154;
stateMPC_FLOAT* stateMPC_dlubcc19 = stateMPC_dl_cc + 154;
stateMPC_FLOAT* stateMPC_dsubcc19 = stateMPC_ds_cc + 154;
stateMPC_FLOAT* stateMPC_ccrhsub19 = stateMPC_ccrhs + 154;
stateMPC_FLOAT stateMPC_Phi19[2];
stateMPC_FLOAT stateMPC_D19[2] = {-1.0000000000000000E+000, 
-1.0000000000000000E+000};
stateMPC_FLOAT stateMPC_W19[2];
...
info->it = 0;
stateMPC_LA_INITIALIZEVECTOR_78(stateMPC_z, 0);
stateMPC_LA_INITIALIZEVECTOR_40(stateMPC_v, 1);
stateMPC_LA_INITIALIZEVECTOR_156(stateMPC_l, 1);
stateMPC_LA_INITIALIZEVECTOR_156(stateMPC_s, 1);
info->mu = 0;
stateMPC_LA_DOTACC_156(stateMPC_l, stateMPC_s, &info->mu);
info->mu /= 156;
while( 1 ){
info->pobj = 0;
...
stateMPC_LA_DIAG_QUADFCN_2(params->H20, params->f20, stateMPC_z19, stateMPC_grad_cost19, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
stateMPC_LA_DENSE_DIAGZERO_MVMSUB3_2_4_2(params->C19, stateMPC_z18, stateMPC_D19, stateMPC_z19, params->e20, stateMPC_v19, stateMPC_re19, &info->dgap, &info->res_eq);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D19, stateMPC_v19, stateMPC_grad_eq19);
info->res_ineq = 0;
...
stateMPC_LA_VSUBADD3_2(params->lb20, stateMPC_z19, stateMPC_lbIdx19, stateMPC_llb19, stateMPC_slb19, stateMPC_rilb19, &info->dgap, &info->res_ineq);
stateMPC_LA_VSUBADD2_2(stateMPC_z19, stateMPC_ubIdx19, params->ub20, stateMPC_lub19, stateMPC_sub19, stateMPC_riub19, &info->dgap, &info->res_ineq);
...
stateMPC_LA_INEQ_B_GRAD_2_2_2(stateMPC_lub19, stateMPC_sub19, stateMPC_riub19, stateMPC_llb19, stateMPC_slb19, stateMPC_rilb19, stateMPC_lbIdx19, stateMPC_ubIdx19, stateMPC_grad_ineq19, stateMPC_lubbysub19, stateMPC_llbbyslb19);
...
stateMPC_LA_VVADD3_78(stateMPC_grad_cost, stateMPC_grad_eq, stateMPC_grad_ineq, stateMPC_rd);
...
stateMPC_LA_DIAG_CHOL_ONELOOP_LBUB_2_2_2(params->H20, stateMPC_llbbyslb19, stateMPC_lbIdx19, stateMPC_lubbysub19, stateMPC_ubIdx19, stateMPC_Phi19);
stateMPC_LA_DIAG_DIAGZERO_MATRIXTFORWARDSUB_2_2(stateMPC_Phi19, stateMPC_D19, stateMPC_W19);
stateMPC_LA_DIAG_FORWARDSUB_2(stateMPC_Phi19, stateMPC_rd19, stateMPC_Lbyrd19);
...
stateMPC_LA_DENSE_DIAGZERO_MMT2_2_4_2(stateMPC_V18, stateMPC_W19, stateMPC_Yd19);
stateMPC_LA_DENSE_DIAGZERO_2MVMSUB2_2_4_2(stateMPC_V18, stateMPC_Lbyrd18, stateMPC_W19, stateMPC_Lbyrd19, stateMPC_re19, stateMPC_beta19);
...
stateMPC_LA_DENSE_BACKWARDSUB_2(stateMPC_Ld19, stateMPC_yy19, stateMPC_dvaff19);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D19, stateMPC_dvaff19, stateMPC_grad_eq19);
stateMPC_LA_VSUB2_78(stateMPC_rd, stateMPC_grad_eq, stateMPC_rd);
...
stateMPC_LA_DIAG_FORWARDBACKWARDSUB_2(stateMPC_Phi19, stateMPC_rd19, stateMPC_dzaff19);
...
stateMPC_LA_VSUB_INDEXED_2(stateMPC_dzaff19, stateMPC_lbIdx19, stateMPC_rilb19, stateMPC_dslbaff19);
stateMPC_LA_VSUB3_2(stateMPC_llbbyslb19, stateMPC_dslbaff19, stateMPC_llb19, stateMPC_dllbaff19);
stateMPC_LA_VSUB2_INDEXED_2(stateMPC_riub19, stateMPC_dzaff19, stateMPC_ubIdx19, stateMPC_dsubaff19);
stateMPC_LA_VSUB3_2(stateMPC_lubbysub19, stateMPC_dsubaff19, stateMPC_lub19, stateMPC_dlubaff19);
...
stateMPC_LA_VSUB5_156(stateMPC_ds_aff, stateMPC_dl_aff, musigma, stateMPC_ccrhs);
...
stateMPC_LA_DENSE_MVMSUB1_2_2(stateMPC_Lsd18, stateMPC_yy17, stateMPC_beta18, stateMPC_bmy18);
stateMPC_LA_DENSE_FORWARDSUB_2(stateMPC_Ld18, stateMPC_bmy18, stateMPC_yy18);
stateMPC_LA_VSUB6_INDEXED_2_2_2(stateMPC_ccrhsub19, stateMPC_sub19, stateMPC_ubIdx19, stateMPC_ccrhsl19, stateMPC_slb19, stateMPC_lbIdx19, stateMPC_rd19);
stateMPC_LA_DIAG_FORWARDSUB_2(stateMPC_Phi19, stateMPC_rd19, stateMPC_Lbyrd19);
stateMPC_LA_DENSE_DIAGZERO_2MVMADD_2_4_2(stateMPC_V18, stateMPC_Lbyrd18, stateMPC_W19, stateMPC_Lbyrd19, stateMPC_beta19);
stateMPC_LA_DENSE_MVMSUB1_2_2(stateMPC_Lsd19, stateMPC_yy18, stateMPC_beta19, stateMPC_bmy19);
stateMPC_LA_DENSE_FORWARDSUB_2(stateMPC_Ld19, stateMPC_bmy19, stateMPC_yy19);
stateMPC_LA_DENSE_BACKWARDSUB_2(stateMPC_Ld19, stateMPC_yy19, stateMPC_dvcc19);
...
stateMPC_LA_DIAGZERO_MTVM_2_2(stateMPC_D19, stateMPC_dvcc19, stateMPC_grad_eq19);
stateMPC_LA_VSUB_78(stateMPC_rd, stateMPC_grad_eq, stateMPC_rd);
...
stateMPC_LA_DIAG_FORWARDBACKWARDSUB_2(stateMPC_Phi19, stateMPC_rd19, stateMPC_dzcc19);
...
stateMPC_LA_VEC_DIVSUB_MULTSUB_INDEXED_2(stateMPC_ccrhsl19, stateMPC_slb19, stateMPC_llbbyslb19, stateMPC_dzcc19, stateMPC_lbIdx19, stateMPC_dllbcc19);
stateMPC_LA_VEC_DIVSUB_MULTADD_INDEXED_2(stateMPC_ccrhsub19, stateMPC_sub19, stateMPC_lubbysub19, stateMPC_dzcc19, stateMPC_ubIdx19, stateMPC_dlubcc19);
stateMPC_LA_VSUB7_156(stateMPC_l, stateMPC_ccrhs, stateMPC_s, stateMPC_dl_cc, stateMPC_ds_cc);
stateMPC_LA_VADD_78(stateMPC_dz_cc, stateMPC_dz_aff);
stateMPC_LA_VADD_40(stateMPC_dv_cc, stateMPC_dv_aff);
stateMPC_LA_VADD_156(stateMPC_dl_cc, stateMPC_dl_aff);
stateMPC_LA_VADD_156(stateMPC_ds_cc, stateMPC_ds_aff);
