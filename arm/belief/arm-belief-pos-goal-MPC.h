...
#ifndef __ARM_GOAL_POS_GOAL_MPC_H__
#define __ARM_GOAL_POS_GOAL_MPC_H__
...
typedef struct beliefPenaltyMPC_params
{
    ...
    beliefPenaltyMPC_FLOAT Q15[1089];
    ...
    /* matrix of size [6 x 33] (column major format) */
    beliefPenaltyMPC_FLOAT A15[198];

    /* vector of size 6 */
    beliefPenaltyMPC_FLOAT b15[6];
