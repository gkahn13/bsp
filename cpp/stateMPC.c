...
void stateMPC_tic(stateMPC_timer* t)
{
...
stateMPC_FLOAT stateMPC_toc(stateMPC_timer* t)
{
	QueryPerformanceCounter(&t->toc);
	return ((t->toc.QuadPart - t->tic.QuadPart) / (stateMPC_FLOAT)t->freq.QuadPart);
}
...
stateMPC_FLOAT stateMPC_toc(stateMPC_timer* t)
{
    ...
    return (stateMPC_FLOAT)duration / 1000000000;
}
...
stateMPC_FLOAT stateMPC_toc(stateMPC_timer* t)
{
	...
	return (stateMPC_FLOAT)(t->toc - t->tic - overhead) / 1000000000;
}
...
double stateMPC_toc(stateMPC_timer* t)
{
	...
	return (stateMPC_FLOAT)temp.tv_sec + (stateMPC_FLOAT)temp.tv_nsec / 1000000000;
}
