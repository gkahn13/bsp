...
/*
 * Initializes a vector of length 411 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_411(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<411; i++ )
	{
...
/*
 * Initializes a vector of length 1740 with a value.
 */
void beliefPenaltyMPC_LA_INITIALIZEVECTOR_1740(beliefPenaltyMPC_FLOAT* vec, beliefPenaltyMPC_FLOAT value)
{
	int i;
	for( i=0; i<1740; i++ )
	{
 ...
 * This function is for vectors of length 1740.
 */
void beliefPenaltyMPC_LA_DOTACC_1740(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y, beliefPenaltyMPC_FLOAT *z)
{
	int i;
	for( i=0; i<1740; i++ ){
		*z += x[i]*y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_AFFINE(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu_aff)
{
    ...
    *a = mya;
    *mu_aff = mymu / (beliefPenaltyMPC_FLOAT)1740;
    return lsIt;
}
...
*  and x,u,v are vectors of length 1740.
 */
void beliefPenaltyMPC_LA_VSUB5_1740(beliefPenaltyMPC_FLOAT *u, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT a, beliefPenaltyMPC_FLOAT *x)
{
	int i;
	for( i=0; i<1740; i++){
		x[i] = u[i]*v[i] - a;
...
/*
 * Computes ds = -l.\(r + s.*dl) for vectors of length 1740.
 */
void beliefPenaltyMPC_LA_VSUB7_1740(beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *r, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds)
{
	int i;
	for( i=0; i<1740; i++){
...
/*
 * Vector addition x = x + y for vectors of length 411.
 */
void beliefPenaltyMPC_LA_VADD_411(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<411; i++){
		x[i] += y[i];
...
/*
 * Vector addition x = x + y for vectors of length 1740.
 */
void beliefPenaltyMPC_LA_VADD_1740(beliefPenaltyMPC_FLOAT *x, beliefPenaltyMPC_FLOAT *y)
{
	int i;
	for( i=0; i<1740; i++){
		x[i] += y[i];
...
int beliefPenaltyMPC_LINESEARCH_BACKTRACKING_COMBINED(beliefPenaltyMPC_FLOAT *z, beliefPenaltyMPC_FLOAT *v, beliefPenaltyMPC_FLOAT *l, beliefPenaltyMPC_FLOAT *s, beliefPenaltyMPC_FLOAT *dz, beliefPenaltyMPC_FLOAT *dv, beliefPenaltyMPC_FLOAT *dl, beliefPenaltyMPC_FLOAT *ds, beliefPenaltyMPC_FLOAT *a, beliefPenaltyMPC_FLOAT *mu)
{
    ...
    *a = a_gamma;
    *mu /= (beliefPenaltyMPC_FLOAT)1740;
    return lsIt;
}
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_v[411];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_aff[1251];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_aff[411];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_l[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_s[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_lbys[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_aff[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_aff[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dz_cc[1251];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dv_cc[411];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_dl_cc[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ds_cc[1740];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_ccrhs[1740];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_re13[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_beta13[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_betacc13[30];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_V13[2610];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Yd13[465];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Ld13[465];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_yy13[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_bmy13[30];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_W13[2610];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Ysd13[810];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Lsd13[810];
...
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_v14 = beliefPenaltyMPC_v + 381;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_re14[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_beta14[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_betacc14[30];
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dvaff14 = beliefPenaltyMPC_dv_aff + 381;
beliefPenaltyMPC_FLOAT* beliefPenaltyMPC_dvcc14 = beliefPenaltyMPC_dv_cc + 381;
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_V14[990];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Yd14[465];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Ld14[465];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_yy14[30];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_bmy14[30];
...
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_W14[990];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Ysd14[900];
beliefPenaltyMPC_FLOAT beliefPenaltyMPC_Lsd14[900];
...
beliefPenaltyMPC_LA_INITIALIZEVECTOR_411(beliefPenaltyMPC_v, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_1740(beliefPenaltyMPC_l, 1);
beliefPenaltyMPC_LA_INITIALIZEVECTOR_1740(beliefPenaltyMPC_s, 1);
info->mu = 0;
beliefPenaltyMPC_LA_DOTACC_1740(beliefPenaltyMPC_l, beliefPenaltyMPC_s, &info->mu);
info->mu /= 1740;
while( 1 ){
info->pobj = 0;
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H1, params->f1, beliefPenaltyMPC_z00, beliefPenaltyMPC_grad_cost00, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H2, params->f2, beliefPenaltyMPC_z01, beliefPenaltyMPC_grad_cost01, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H3, params->f3, beliefPenaltyMPC_z02, beliefPenaltyMPC_grad_cost02, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H4, params->f4, beliefPenaltyMPC_z03, beliefPenaltyMPC_grad_cost03, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H5, params->f5, beliefPenaltyMPC_z04, beliefPenaltyMPC_grad_cost04, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H6, params->f6, beliefPenaltyMPC_z05, beliefPenaltyMPC_grad_cost05, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H7, params->f7, beliefPenaltyMPC_z06, beliefPenaltyMPC_grad_cost06, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H8, params->f8, beliefPenaltyMPC_z07, beliefPenaltyMPC_grad_cost07, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H9, params->f9, beliefPenaltyMPC_z08, beliefPenaltyMPC_grad_cost08, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H10, params->f10, beliefPenaltyMPC_z09, beliefPenaltyMPC_grad_cost09, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H11, params->f11, beliefPenaltyMPC_z10, beliefPenaltyMPC_grad_cost10, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H12, params->f12, beliefPenaltyMPC_z11, beliefPenaltyMPC_grad_cost11, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H13, params->f13, beliefPenaltyMPC_z12, beliefPenaltyMPC_grad_cost12, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_87(params->H14, params->f14, beliefPenaltyMPC_z13, beliefPenaltyMPC_grad_cost13, &info->pobj);
beliefPenaltyMPC_LA_DENSE_QUADFCN_33(params->H15, params->f15, beliefPenaltyMPC_z14, beliefPenaltyMPC_grad_cost14, &info->pobj);
info->res_eq = 0;
info->dgap = 0;
...
beliefPenaltyMPC_LA_DENSE_MVMSUB3_30_87_33(params->C14, beliefPenaltyMPC_z13, params->D15, beliefPenaltyMPC_z14, params->e15, beliefPenaltyMPC_v14, beliefPenaltyMPC_re14, &info->dgap, &info->res_eq);
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MTVM2_30_87_30(params->C14, beliefPenaltyMPC_v14, beliefPenaltyMPC_D01, beliefPenaltyMPC_v13, beliefPenaltyMPC_grad_eq13);
beliefPenaltyMPC_LA_DENSE_MTVM_30_33(params->D15, beliefPenaltyMPC_v14, beliefPenaltyMPC_grad_eq14);
info->res_ineq = 0;
...
beliefPenaltyMPC_LA_INEQ_DENSE_HESS_87_87_33(params->H1, beliefPenaltyMPC_llbbyslb00, beliefPenaltyMPC_lbIdx00, beliefPenaltyMPC_lubbysub00, beliefPenaltyMPC_ubIdx00, beliefPenaltyMPC_Phi00);
...
beliefPenaltyMPC_LA_INEQ_DENSE_HESS_87_87_33(params->

beliefPenaltyMPC_LA_DENSE_FORWARDSUB_87(beliefPenaltyMPC_Phi13, beliefPenaltyMPC_rd13, beliefPenaltyMPC_Lbyrd13);
beliefPenaltyMPC_LA_INEQ_DENSE_HESS_33_33_27(params->H15, beliefPenaltyMPC_llbbyslb14, beliefPenaltyMPC_lbIdx14, beliefPenaltyMPC_lubbysub14, beliefPenaltyMPC_ubIdx14, beliefPenaltyMPC_Phi14);
beliefPenaltyMPC_LA_DENSE_CHOL2_33(beliefPenaltyMPC_Phi14);
beliefPenaltyMPC_LA_DENSE_MATRIXFORWARDSUB_30_33(beliefPenaltyMPC_Phi14, params->D15, beliefPenaltyMPC_W14);
...
beliefPenaltyMPC_LA_DENSE_MMT2_30_87_33(beliefPenaltyMPC_V13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Yd14);
beliefPenaltyMPC_LA_DENSE_MVMSUB2_30_87_33(beliefPenaltyMPC_V13, beliefPenaltyMPC_Lbyrd13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Lbyrd14, beliefPenaltyMPC_re14, beliefPenaltyMPC_beta14);
...
beliefPenaltyMPC_LA_DENSE_MATRIXTFORWARDSUB_30_27(beliefPenaltyMPC_Ld12, beliefPenaltyMPC_Ysd13, beliefPenaltyMPC_Lsd13);
beliefPenaltyMPC_LA_DENSE_MMTSUB_30_27(beliefPenaltyMPC_Lsd13, beliefPenaltyMPC_Yd13);
beliefPenaltyMPC_LA_DENSE_CHOL_30(beliefPenaltyMPC_Yd13, beliefPenaltyMPC_Ld13);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_30_27(beliefPenaltyMPC_Lsd13, beliefPenaltyMPC_yy12, beliefPenaltyMPC_beta13, beliefPenaltyMPC_bmy13);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_30(beliefPenaltyMPC_Ld13, beliefPenaltyMPC_bmy13, beliefPenaltyMPC_yy13);
beliefPenaltyMPC_LA_DENSE_MATRIXTFORWARDSUB_30_30(beliefPenaltyMPC_Ld13, beliefPenaltyMPC_Ysd14, beliefPenaltyMPC_Lsd14);
beliefPenaltyMPC_LA_DENSE_MMTSUB_30_30(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_Yd14);
beliefPenaltyMPC_LA_DENSE_CHOL_30(beliefPenaltyMPC_Yd14, beliefPenaltyMPC_Ld14);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_30_30(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_yy13, beliefPenaltyMPC_beta14, beliefPenaltyMPC_bmy14);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_30(beliefPenaltyMPC_Ld14, beliefPenaltyMPC_bmy14, beliefPenaltyMPC_yy14);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_30(beliefPenaltyMPC_Ld14, beliefPenaltyMPC_yy14, beliefPenaltyMPC_dvaff14);
beliefPenaltyMPC_LA_DENSE_MTVMSUB_30_30(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_dvaff14, beliefPenaltyMPC_yy13, beliefPenaltyMPC_bmy13);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_30(beliefPenaltyMPC_Ld13, beliefPenaltyMPC_bmy13, beliefPenaltyMPC_dvaff13);
beliefPenaltyMPC_LA_DENSE_MTVMSUB_30_27(beliefPenaltyMPC_Lsd13, beliefPenaltyMPC_dvaff13, beliefPenaltyMPC_yy12, beliefPenaltyMPC_bmy12);
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MTVM2_30_87_30(params->C14, beliefPenaltyMPC_dvaff14, beliefPenaltyMPC_D01, beliefPenaltyMPC_dvaff13, beliefPenaltyMPC_grad_eq13);
beliefPenaltyMPC_LA_DENSE_MTVM_30_33(params->D15, beliefPenaltyMPC_dvaff14, beliefPenaltyMPC_grad_eq14);
...
beliefPenaltyMPC_LA_VSUB5_1740(beliefPenaltyMPC_ds_aff, beliefPenaltyMPC_dl_aff, musigma, beliefPenaltyMPC_ccrhs);
...
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_33(beliefPenaltyMPC_Phi14, beliefPenaltyMPC_rd14, beliefPenaltyMPC_Lbyrd14);
beliefPenaltyMPC_LA_DENSE_2MVMADD_30_87_33(beliefPenaltyMPC_V13, beliefPenaltyMPC_Lbyrd13, beliefPenaltyMPC_W14, beliefPenaltyMPC_Lbyrd14, beliefPenaltyMPC_beta14);
beliefPenaltyMPC_LA_DENSE_MVMSUB1_30_30(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_yy13, beliefPenaltyMPC_beta14, beliefPenaltyMPC_bmy14);
beliefPenaltyMPC_LA_DENSE_FORWARDSUB_30(beliefPenaltyMPC_Ld14, beliefPenaltyMPC_bmy14, beliefPenaltyMPC_yy14);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_30(beliefPenaltyMPC_Ld14, beliefPenaltyMPC_yy14, beliefPenaltyMPC_dvcc14);
beliefPenaltyMPC_LA_DENSE_MTVMSUB_30_30(beliefPenaltyMPC_Lsd14, beliefPenaltyMPC_dvcc14, beliefPenaltyMPC_yy13, beliefPenaltyMPC_bmy13);
beliefPenaltyMPC_LA_DENSE_BACKWARDSUB_30(beliefPenaltyMPC_Ld13, beliefPenaltyMPC_bmy13, beliefPenaltyMPC_dvcc13);
beliefPenaltyMPC_LA_DENSE_MTVMSUB_30_27(beliefPenaltyMPC_Lsd13, beliefPenaltyMPC_dvcc13, beliefPenaltyMPC_yy12, beliefPenaltyMPC_bmy12);
...
beliefPenaltyMPC_LA_DENSE_DIAGZERO_MTVM2_30_87_30(params->C14, beliefPenaltyMPC_dvcc14, beliefPenaltyMPC_D01, beliefPenaltyMPC_dvcc13, beliefPenaltyMPC_grad_eq13);
beliefPenaltyMPC_LA_DENSE_MTVM_30_33(params->D15, beliefPenaltyMPC_dvcc14, beliefPenaltyMPC_grad_eq14);
...
beliefPenaltyMPC_LA_VSUB7_1740(beliefPenaltyMPC_l, beliefPenaltyMPC_ccrhs, beliefPenaltyMPC_s, beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_ds_cc);
beliefPenaltyMPC_LA_VADD_1251(beliefPenaltyMPC_dz_cc, beliefPenaltyMPC_dz_aff);
beliefPenaltyMPC_LA_VADD_411(beliefPenaltyMPC_dv_cc, beliefPenaltyMPC_dv_aff);
beliefPenaltyMPC_LA_VADD_1740(beliefPenaltyMPC_dl_cc, beliefPenaltyMPC_dl_aff);
beliefPenaltyMPC_LA_VADD_1740(beliefPenaltyMPC_ds_cc, beliefPenaltyMPC_ds_aff);
