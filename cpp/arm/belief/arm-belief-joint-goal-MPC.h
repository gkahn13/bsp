...
#ifndef __ARM_BELIEF_JOINT_GOAL_MPC_H__
#define __ARM_BELIEF_JOINT_GOAL_MPC_H__
...
#define beliefPenaltyMPC_SET_MAXIT         (40)	
...
typedef struct beliefPenaltyMPC_params
{
    ...
    beliefPenaltyMPC_FLOAT Q1[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q2[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q3[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q4[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q5[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q6[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q7[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q8[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q9[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q10[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q11[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q12[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q13[7569];
    ...
    /* matrix of size [87 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT Q14[7569];
    ...
    /* matrix of size [27 x 87] (column major format) */
    beliefPenaltyMPC_FLOAT C14[2349];

    /* vector of size 27 */
    beliefPenaltyMPC_FLOAT e14[27];

    /* matrix of size [27 x 27] (column major format) */
    beliefPenaltyMPC_FLOAT Q15[729];

    /* vector of size 27 */
    beliefPenaltyMPC_FLOAT f15[27];

    /* vector of size 27 */
    beliefPenaltyMPC_FLOAT lb15[27];

    /* vector of size 27 */
    beliefPenaltyMPC_FLOAT ub15[27];

    /* vector of size 27 */
    beliefPenaltyMPC_FLOAT e15[27];

    /* vector of size 12 */
    beliefPenaltyMPC_FLOAT b15[12];
