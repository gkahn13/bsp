#ifndef __ARM_STATE_CASADI_H__
#define __ARM_STATE_CASADI_H__
...
void evaluateCostGrad(const double* x0,const double* x1,const double* x2,const double* x3,const double* x4,double* r0);
