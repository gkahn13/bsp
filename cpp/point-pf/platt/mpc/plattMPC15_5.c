...
info->mu /= 356;
PRINTTEXT("This is plattMPC, a solver generated by FORCES (forces.ethz.ch).\n");
...
PRINTTEXT("OPTIMAL (within RESEQ=%2.1e, RESINEQ=%2.1e, (R)DGAP=(%2.1e)%2.1e, MU=%2.1e).\n",plattMPC_SET_ACC_RESEQ, plattMPC_SET_ACC_RESINEQ,plattMPC_SET_ACC_KKTCOMPL,plattMPC_SET_ACC_RDGAP,plattMPC_SET_ACC_KKTCOMPL);
